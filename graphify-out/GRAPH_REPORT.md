...
## Corpus Check
- 718 files · ~1,466,463 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5517 nodes · 13837 edges · 306 communities (269 shown, 37 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1777 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `40aeff20`
...
Cohesion: 0.06
Nodes (86): canonicalExportJSON(), canonicalizeValue(), fail(), isRecord(), parseAdsEvent(), parseAim(), parseAnnotationEvent(), parseArray() (+78 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (56): createRig(), makeDrillConfig(), createDrillRunner(), makeConfig(), reversalConfig(), run(), setup(), setupArmed() (+48 more)
...
Cohesion: 0.06
Nodes (55): drillSourceFor(), researcherControlsDrills(), resolveAvailableDrill(), createSceneManager(), createSceneManagerWithStatus(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides() (+47 more)
...
Cohesion: 0.05
Nodes (27): FakeSettingsDocument, wireSettingsToRecorder(), buildExportPayload(), capacityForDrill(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), makeVaryingHitboxPayload() (+19 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (40): createDataRecorder(), runCadenceTimeoutExport(), runCadenceTimeoutExport(), createSimLoop(), cameraLookingDownZ(), driveRenderAndSim(), fireAt(), fixedClock() (+32 more)
...
Cohesion: 0.06
Nodes (30): makeMeta(), normalizeReplayRecording(), toSceneDescriptor(), fixtureRecording(), fixtureRecording(), buildLargePayload(), buildSmallPayload(), timeFor() (+22 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (29): aimFor(), makeV3Payload(), pointFor(), widePayload(), payloadWithEyeZ(), recordTicks(), bearingDeg(), buildTicks() (+21 more)
...
Cohesion: 0.07
Nodes (20): buildEarlyReplayFixture(), openFullReplayFromResult(), openHistoricalRunDetail(), openHistory(), waitForHarness(), waitReplayReady(), buildFixture(), fixtureStartedAt() (+12 more)
...
Cohesion: 0.08
Nodes (51): assess_sufficiency(), bootstrap_f1_interval(), confusion_matrix(), evaluate_layers(), fit_layers(), _group_false_positive_rate(), LayerRule, promotion_checks() (+43 more)
...
Cohesion: 0.08
Nodes (15): createPresentationCoordinator(), defaultLoader(), disposeScene(), loadScene(), SceneManager, createReplayPresentationSession(), resolveWeapon(), ReplaySceneAdapter (+7 more)
...
Cohesion: 0.07
Nodes (21): nextAnimationFrame(), percentile(), probeWarmupP95Ms(), readDevicePixelRatio(), readFullscreenElement(), readScreenDim(), requireNonNegativeInteger(), requireNonNegativeNumber() (+13 more)

### Community 23 - "Community 23"
Cohesion: 0.07
Nodes (22): compileSessionProgram(), deriveProgramFamilyOrder(), requireRestSeconds(), resolveBoundary(), SessionProgramCompileError, summarizeProgram(), actualWeaponIdFor(), curatedConfigFor() (+14 more)

### Community 24 - "Community 24"
Cohesion: 0.09
Nodes (19): consume(), drainAll(), drainToArray(), snapshot(), createBulletArena(), createImpactRing(), createInputRing(), createShotRayRing() (+11 more)
...
Cohesion: 0.09
Nodes (24): aimForward(), angularDistanceDeg(), angularEccentricityDeg(), clamp(), eyeOriginForTick(), isFiniteNumber(), radToDeg(), resolveEyeOrigin() (+16 more)
...
Cohesion: 0.14
Nodes (9): resolveDrillTimeLimitMs(), resolveHitFeedback(), diffFields(), flatten(), diffFields(), flatten(), buildDeclaredWeaponByDrillId(), requireWeapon() (+1 more)
...
Cohesion: 0.1
Nodes (18): resolveFamilyDrillId(), resolveWarmupDrillId(), findSessionPlanPreset(), buildFrozenSessionPlan(), createSessionRunner(), requireFamilyOrder(), resolveFamilyDrillId(), resolveWarmupDrillId() (+10 more)

### Community 42 - "Community 42"
Cohesion: 0.1
Nodes (17): createTrackingPilotSession(), FakeDocument, flush(), makeSession(), startManifest(), buildTrackingPilotManifest(), parseTrackingPilotManifest(), requireNonEmptyString() (+9 more)
...
Cohesion: 0.1
Nodes (29): check_construct_presence(), ConstructReport, ConstructRule, Session-level construct presence gate.  Complements the existing format-only g, A drill family's core construct declaration (frozen; changes require a version b, Session-level presence verdict. ``present is None`` iff the family is unregister, Resolve *drill_id* to a registered construct family.      Strips a leading ``s, Determine whether *export* contains the core construct its drill family declares (+21 more)
...
Cohesion: 0.11
Nodes (15): historyRunSummaryFromPayload(), createHistoryScreen(), makeButton(), createParticipantBrowser(), makeButton(), createHistoryNavigator(), defaultWindow(), decodeSegment() (+7 more)
...
Cohesion: 0.13
Nodes (24): assert(), getHealth(), getParticipants(), gitCommit(), main(), postRun(), runScenario(), buildLargeReplayPayload() (+16 more)
...
Cohesion: 0.12
Nodes (27): key_state_signed(), key_velocity_xcorr(), Signed strafe key state per tick: ``D`` -> ``+1``, ``A`` -> ``-1``, both or neit, Signed Pearson r at every lag in ``[-max_lag_ticks, +max_lag_ticks]``, plus the, _key_events(), _peek(), T2 DoD 3, proven from the source rather than by sampling inputs.      Two fact, Alternating A/D holds at a fixed period: a strafe pattern with real autocorrelat (+19 more)
...
Cohesion: 0.12
Nodes (26): createAttemptFinalizationGate(), describeAttemptHold(), describeDiscardReason(), invalidAttemptBasename(), planFinalization(), snapshot(), ticksFrom(), downloadCSV() (+18 more)
...
Cohesion: 0.14
Nodes (10): createRunAttemptController(), createInputSampler(), createPausableTimeMapper(), createFinalizationRig(), emptyMatrix(), createPauseRig(), pausedRig(), run() (+2 more)
...
Cohesion: 0.22
Nodes (8): requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor(), halfHorizontalFovRad(), ndcForEyeAngles(), spiderEyePolarPos()
...
Cohesion: 0.14
Nodes (6): armAndTakeRealLock(), PROBE(), sample(), armDrill(), pulsePointerLock(), readDrillArmState()
...
Cohesion: 0.27
Nodes (12): baseTargets(), buildTrackingCorePrPilotV1Cell(), corePrPilotV1DrillId(), cubeHitbox(), scoredTiming(), sphereHitbox(), trackingPilotAngularSizeToDiameterU(), trackingPilotAngularSizeToEdgeU() (+4 more)
...
Cohesion: 0.23
Nodes (8): serializeJSON(), degToRad(), makeRoundTripPayload(), tickTime(), yawDegAt(), aimAtPoint(), makeLeadPayload(), parseSpiderShot()
...
Cohesion: 0.47
Nodes (6): enumerateLandings(), requireSpiderWideArenaGeometry(), spiderWideArenaClearance(), spiderWideArenaExtremes(), spiderWideTargetRadiusU(), spiderWideEyePos()
...
- **Why does `bool()` connect `Community 81` to `Community 70`, `Community 106`, `Community 11`, `Community 43`, `Community 76`, `Community 13`, `Community 56`, `Community 25`, `Community 90`, `Community 156`, `Community 57`?**
  _High betweenness centrality (0.301) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 106` to `Community 11`, `Community 13`, `Community 17`, `Community 145`, `Community 147`, `Community 146`, `Community 25`, `Community 155`, `Community 156`, `Community 157`, `Community 31`, `Community 36`, `Community 57`, `Community 65`, `Community 70`, `Community 204`, `Community 205`, `Community 81`, `Community 88`, `Community 112`, `Community 117`, `Community 119`, `Community 122`, `Community 123`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 43` to `Community 81`?**
