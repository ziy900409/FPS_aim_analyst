...
## Corpus Check
- 208 files · ~298,023 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1410 nodes · 3273 edges · 92 communities (68 shown, 24 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 322 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6a5b5a4c`
...
Cohesion: 0.06
Nodes (53): check_dt(), DtReport, Fixed-tick interval quality reporting., Uniformity report; each gap index identifies the right-hand tick row., Compare adjacent tick times with ``1000 / sim_hz`` using a 1e-6 ms tolerance., Pure submovement segmentation algorithms., Export, _list() (+45 more)
...
Cohesion: 0.11
Nodes (20): _Candidate, _merge_overlapping(), _prepare_signal(), Submovement segmentation for 128 Hz angular-speed traces., List-compatible result carrying flags when no segment can hold them., Segment an angular-speed trace into one primary flick and later adjustments., Segment an angular-speed trace into one primary flick and later adjustments., Pre-registered segmentation parameters; changes require a new version. (+12 more)
...
Cohesion: 0.18
Nodes (11): createDataRecorder(), capacityForDrill(), cameraLookingDownZ(), fireAt(), makeTarget(), meanSpreadRadius(), run(), runtime() (+3 more)
...
Cohesion: 0.19
Nodes (11): createSimLoop(), createCamera(), createTarget(), fireOne(), runAtFrames(), canonicalFire(), runFire(), baseClock() (+3 more)
...
Cohesion: 0.5
Nodes (3): One inclusive submovement interval., One inclusive submovement interval., Segment

## Knowledge Gaps
- **127 isolated node(s):** `Offline research modules.`, `Schema v2 ingestion and fixture generation.`, `Fixed-tick interval quality reporting.`, `Uniformity report; each gap index identifies the right-hand tick row.`, `Compare adjacent tick times with ``1000 / sim_hz`` using a 1e-6 ms tolerance.` (+122 more)
...
- **Why does `CameraController` connect `Community 40` to `Community 53`, `Community 13`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `createSimLoop()` connect `Community 23` to `Community 0`, `Community 3`, `Community 4`, `Community 38`, `Community 39`, `Community 13`, `Community 15`, `Community 48`, `Community 17`, `Community 18`, `Community 51`, `Community 52`, `Community 53`, `Community 55`, `Community 30`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `createDataRecorder()` connect `Community 17` to `Community 0`, `Community 1`, `Community 39`, `Community 13`, `Community 48`, `Community 52`, `Community 53`, `Community 55`, `Community 23`, `Community 30`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
