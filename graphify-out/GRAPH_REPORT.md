...
## Corpus Check
- 375 files · ~637,219 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2993 nodes · 6918 edges · 179 communities (151 shown, 28 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 995 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `df4da8a2`
...
## Communities (179 total, 28 thin omitted)
...
Cohesion: 0.08
Nodes (34): createDrillRunner(), makeConfig(), reversalConfig(), run(), setup(), aimAt(), fireFrom(), pushTarget() (+26 more)
...
Cohesion: 0.06
Nodes (42): Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., _render_flags(), render_html(), _render_limitations(), report_filename() (+34 more)
...
Cohesion: 0.09
Nodes (28): createSimLoop(), applyAimFixture(), canonicalMovingTargetFrames(), createCamera(), runMovingTarget(), createCamera(), createTarget(), fireOne() (+20 more)
...
Cohesion: 0.1
Nodes (36): createPointerLock(), average(), beginNextProtocolCondition(), buildCurrentExportPayload(), completeActiveProtocolCondition(), diagnosisForPayload(), diagnosisInputsForPayload(), exportBasename() (+28 more)
...
Cohesion: 0.13
Nodes (31): load_export(), Read and validate one schema v2 JSON export., Read and validate one schema v2 JSON export., Read and validate one schema v2 JSON export., _keys_for_tick(), make_synthetic_export(), _profile(), Deterministic schema v2 synthetic export generation.  No clock or random sourc (+23 more)
...
Cohesion: 0.13
Nodes (15): createDataRecorder(), capacityForDrill(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), payloadWithStopTransitions(), brInputs(), createCamera() (+7 more)
...
Cohesion: 0.13
Nodes (18): cameraLookingDownZ(), driveRenderAndSim(), fireAt(), fixedClock(), makeTarget(), meanSpreadRadius(), run(), runAtPumpCadence() (+10 more)
...
Cohesion: 0.14
Nodes (27): aggregateCurve(), aggregatePhase(), aggregateSync(), computePhaseMetrics(), counterHoldMsForPeek(), curveRow(), curveRows(), delta() (+19 more)
...
Cohesion: 0.28
Nodes (21): err(), requireAssessmentMode(), requireFiniteNumber(), requireHitboxDimension(), requireNonEmptyString(), requireNonNegativeDegreeRange(), requireNonNegativeNumber(), requireNonNegativeRange() (+13 more)
...
Cohesion: 0.12
Nodes (16): generate(), Write exactly one self-contained HTML report and return its path., Write exactly one self-contained HTML report and return its path., Write exactly one self-contained HTML report and return its path., Write exactly one self-contained HTML report and return its path., Write exactly one self-contained HTML report and return its path., generate_all(), main() (+8 more)
...
Cohesion: 0.17
Nodes (10): computeCurveMetrics(), computePromotedMetrics(), deriveTrackingMetrics(), deriveTrackingSamples(), expectCurveAggregateParity(), expectNormalizedCurveParity(), loadCurve(), loadJson() (+2 more)
...
- **Why does `counter()` connect `Community 0` to `Community 8`, `Community 55`?**
  _High betweenness centrality (0.340) - this node is a cross-community bridge._
- **Why does `_fixture_report()` connect `Community 8` to `Community 0`, `Community 4`, `Community 21`?**
  _High betweenness centrality (0.204) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 4` to `Community 0`, `Community 66`, `Community 3`, `Community 8`, `Community 9`, `Community 11`, `Community 44`, `Community 110`, `Community 111`, `Community 81`, `Community 61`, `Community 19`, `Community 85`, `Community 57`, `Community 58`, `Community 60`, `Community 29`, `Community 95`?**
