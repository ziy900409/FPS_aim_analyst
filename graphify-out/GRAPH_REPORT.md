...
## Corpus Check
- 100 files · ~158,936 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 793 nodes · 1720 edges · 52 communities (37 shown, 15 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 127 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `351e7364`
...
Cohesion: 0.07
Nodes (52): ADR-2 雙迴圈解耦, ADR-3 128 Hz tick, ADR-4 performance.now() 計時源, ADR-5 Pointer Lock + 原始輸入 + coalesced, D1 UI = 純 TS + DOM overlay, WP-0 — 環境設置 (scaffold/createRenderer seam), WP-3 — 高頻輸入採集 (getCoalescedEvents 入緩衝), WP-4 — 目標 / 準心 (+44 more)
...
Cohesion: 0.08
Nodes (42): ADR-1 backend metadata, ADR-4 時間源 (performance.now()), counterstrafe_ad_v1 drill config, SharedState, SimLoop (src/loop/SimLoop.ts), WP-0 createRenderer backend seam, WP-1 sensitivity, WP-2 sim tick (+34 more)
...
Cohesion: 0.18
Nodes (13): createSimLoop(), applyAimFixture(), canonicalSprayFrames(), collectImpacts(), createCamera(), round(), runSpray(), pushEvent() (+5 more)
...
- **Why does `createSharedState()` connect `Community 9` to `Community 1`, `Community 6`, `Community 10`, `Community 12`, `Community 13`, `Community 15`, `Community 24`, `Community 26`, `Community 27`, `Community 29`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `createSimLoop()` connect `Community 13` to `Community 0`, `Community 1`, `Community 9`, `Community 12`, `Community 15`, `Community 16`, `Community 26`, `Community 29`?**
