...
## Corpus Check
- 683 files · ~1,360,415 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5257 nodes · 13059 edges · 282 communities (243 shown, 39 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1693 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1ea4d7b4`
...
Cohesion: 0.05
Nodes (73): round(), simulatePurePunchPattern(), toPatternShot(), punchToThreeRad(), buttonCss(), createNumberInput(), drawGrid(), drawPattern() (+65 more)
...
Cohesion: 0.06
Nodes (58): createDataRecorder(), createDrillRunner(), makeConfig(), reversalConfig(), run(), setup(), setupArmed(), trackingGuardConfig() (+50 more)
...
Cohesion: 0.07
Nodes (42): resolveTargetHitbox(), targetHitboxToConfig(), loadDrill(), angularSizeToHitboxWidthU(), buildPeekClickTransferPilotConfig(), pilotDrillId(), aimAt(), fireFrom() (+34 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (32): makeMeta(), normalizeReplayRecording(), toSceneDescriptor(), fixtureRecording(), fixtureRecording(), buildLargePayload(), buildSmallPayload(), timeFor() (+24 more)
...
Cohesion: 0.08
Nodes (35): enumerateLandings(), sceneWithRoom(), wideConfig(), resolveEyeWorldBase(), err(), requireColorNumber(), requireFiniteNumber(), requireNonEmptyString() (+27 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (37): spawnBullet(), stepBullet(), clipAxis(), sweptHitTest(), collect64HzSamples(), advanceProjectiles(), applyInput(), ballisticRaycast() (+29 more)
...
Cohesion: 0.07
Nodes (54): _axis_grid(), _better(), bootstrap_f1_interval(), confusion_matrix(), ConfusionMatrix, decide(), _duration_grid(), evaluate_layers() (+46 more)
...
Cohesion: 0.07
Nodes (29): brInputs(), createCamera(), advanceUntilTracer(), createCamera(), createTarget(), fireOne(), runAtFrames(), collectImpacts() (+21 more)
...
Cohesion: 0.07
Nodes (15): createSceneLoadCoordinator(), defaultLoader(), disposeScene(), loadScene(), createSceneManager(), createSceneManagerWithStatus(), SceneManager, TargetView (+7 more)
...
Cohesion: 0.07
Nodes (24): buildExportPayload(), serializeJSON(), createHistoryLibraryController(), historyRunSummaryFromPayload(), degToRad(), makeRoundTripPayload(), tickTime(), yawDegAt() (+16 more)

### Community 26 - "Community 26"
Cohesion: 0.1
Nodes (18): buildEarlyReplayFixture(), buildFixture(), fixtureStartedAt(), buildFixture(), buildFixture(), buildIdentitySegment(), buildRunFilename(), buildRunId() (+10 more)

### Community 27 - "Community 27"
Cohesion: 0.12
Nodes (5): assessmentProtocolVersionForDrill(), resolveDrillTimeLimitMs(), payload(), tick(), buildDeclaredWeaponByDrillId()

### Community 28 - "Community 28"
Cohesion: 0.09
Nodes (17): consume(), createInputSampler(), resetRecoilState(), drainAll(), drainToArray(), snapshot(), createBulletArena(), createImpactRing() (+9 more)
...
Cohesion: 0.11
Nodes (38): DetectSample, One presentation's detection derivation. Mirrors TS ``DetectionPresentationDeriv, PeekWindow, One ``[visible, next visible)`` presentation window in measurement time., One ``[visible, next visible)`` presentation window in measurement time., _can_smooth(), _finalize(), _peak_omega() (+30 more)

### Community 33 - "Community 33"
Cohesion: 0.1
Nodes (37): _keys_for_tick(), make_synthetic_export(), _profile(), Deterministic schema v2 synthetic export generation.  No clock or random sourc, Create a schema-faithful deterministic v2 payload without writing it to disk., Create a schema-faithful deterministic v2 payload without writing it to disk., SyntheticSpec, main() (+29 more)
...
Cohesion: 0.11
Nodes (40): EyeOrigin, _meta_eye_origin(), omega_deg_s(), Return angular speed for each tick, with ``nan`` at index zero.      Prefers t, Return angular speed for each tick, with ``nan`` at index zero.      The pitch, Resolved ray/ballistic origin (world domain) for one export.      Mirrors the, Resolve the eye world base and sim->world scale for ``epsilon_deg``/``on_target`, resolve_eye_origin() (+32 more)
...
Cohesion: 0.12
Nodes (34): _list(), load_export(), _mapping(), _non_empty_string(), _number(), _optional_number(), Load the JSON form of the schema v2 export documented in docs/operational/schema, A schema v2 validation error with a machine-readable JSON field path. (+26 more)
...
Cohesion: 0.08
Nodes (34): _ad_key_events(), _aligned(), _bootstrap_ci(), _checked_flags(), _correlogram(), _gate_verdict(), GateVerdict, _half_agreement() (+26 more)
...
Cohesion: 0.12
Nodes (19): resolveFamilyDrillId(), resolveWarmupDrillId(), findSessionPlanPreset(), compileSessionProgram(), requireRestSeconds(), resolveBoundary(), buildFrozenSessionPlan(), createSessionRunner() (+11 more)

### Community 49 - "Community 49"
Cohesion: 0.1
Nodes (12): capacityForDrill(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), meanSpreadRadius(), runtime(), tickAdvancer(), aimAtCenterTarget() (+4 more)
...
Cohesion: 0.13
Nodes (27): key_event_crosscheck(), key_state_signed(), key_velocity_xcorr(), Signed strafe key state per tick: ``D`` -> ``+1``, ``A`` -> ``-1``, both or neit, Signed Pearson r at every lag in ``[-max_lag_ticks, +max_lag_ticks]``, plus the, Cross-check the tick-derived key state against the additive ``key`` event stream, _key_events(), T2 DoD 3, proven from the source rather than by sampling inputs.      Two fact (+19 more)
...
Cohesion: 0.11
Nodes (10): createHistoryClient(), HistoryClientError, isErrorBody(), isRecord(), isSuccessBody(), createHistoryPersistence(), classifyReplaySupport(), classifyStatus() (+2 more)

### Community 59 - "Community 59"
Cohesion: 0.13
Nodes (17): createDrillOverview(), makeButton(), createHistoricalRunDetail(), makeButton(), setup(), createHistoryScreen(), makeButton(), createHistoryNavigator() (+9 more)

### Community 60 - "Community 60"
Cohesion: 0.15
Nodes (20): resolveHitFeedback(), drillSourceFor(), researcherControlsDrills(), resolveAvailableDrill(), baseTargets(), buildTrackingCorePrPilotV1Cell(), corePrPilotV1DrillId(), cubeHitbox() (+12 more)
...
Cohesion: 0.15
Nodes (20): aimAtPoint(), makeLeadPayload(), aimAtCenter(), aimAtOffTarget(), aimAtPoint(), aimForTick(), longrangeAimForTick(), longrangeMissPoint() (+12 more)
...
Cohesion: 0.15
Nodes (23): build_peek_windows(), _events_in_window(), _false(), _finite_number(), _first_compatible_fire(), _hit_times_by_shot(), _key(), _keys() (+15 more)
...
Cohesion: 0.22
Nodes (15): GoldenError, _intervals(), _list(), load_lift_golden(), _mapping(), _number(), parse_lift_golden(), Read the committed Stage 1 segmentation golden produced by the TS side.  ``seg (+7 more)
...
Cohesion: 0.27
Nodes (9): deriveProgramFamilyOrder(), actualWeaponIdFor(), curatedConfigFor(), metaForRun(), payloadFor(), pilotMetaForRun(), pilotSceneIdFor(), weaponMetaForRun() (+1 more)
...
Cohesion: 0.67
Nodes (3): generate_all(), main(), Regenerate the committed WP-29/v1 WP-30 coach-report examples.  The three fixt
...
- **Why does `bool()` connect `Community 71` to `Community 3`, `Community 7`, `Community 44`, `Community 45`, `Community 77`, `Community 145`, `Community 53`, `Community 54`, `Community 55`, `Community 57`?**
  _High betweenness centrality (0.276) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 71` to `Community 3`, `Community 7`, `Community 136`, `Community 137`, `Community 135`, `Community 139`, `Community 145`, `Community 146`, `Community 23`, `Community 32`, `Community 34`, `Community 40`, `Community 53`, `Community 182`, `Community 55`, `Community 183`, `Community 65`, `Community 85`, `Community 100`, `Community 105`, `Community 106`, `Community 112`, `Community 113`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 44` to `Community 71`?**
