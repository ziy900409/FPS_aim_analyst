...
## Corpus Check
- 685 files · ~1,361,303 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5261 nodes · 13074 edges · 305 communities (267 shown, 38 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1693 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `25712e72`
...
Cohesion: 0.06
Nodes (41): createDataRecorder(), capacityForDrill(), createSimLoop(), brInputs(), createCamera(), runBrVariant(), canonicalRun(), runFrames() (+33 more)
...
Cohesion: 0.08
Nodes (39): resolveTargetHitbox(), loadDrill(), angularSizeToHitboxWidthU(), buildPeekClickTransferPilotConfig(), pilotDrillId(), aimAt(), fireFrom(), pushTarget() (+31 more)
...
Cohesion: 0.07
Nodes (47): downloadCSV(), downloadJSON(), downloadTextFile(), createPointerLock(), createRenderLoop(), lerp(), activateDrill(), activeWeaponConfig() (+39 more)
...
Cohesion: 0.07
Nodes (47): measureAtEye(), createRan1(), randomFloat(), createTargetManager(), centerRelativeAngularSeparationDeg(), copyPos(), fixedClock(), inspectV8Population() (+39 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (24): consume(), createInputSampler(), ImpactView, drainAll(), drainToArray(), snapshot(), createBulletArena(), createImpactRing() (+16 more)
...
Cohesion: 0.08
Nodes (51): assess_sufficiency(), bootstrap_f1_interval(), confusion_matrix(), decide(), evaluate_layers(), fit_layers(), _group_false_positive_rate(), LayerRule (+43 more)
...
Cohesion: 0.09
Nodes (43): DetectSample, One presentation's detection derivation. Mirrors TS ``DetectionPresentationDeriv, PeekWindow, One ``[visible, next visible)`` presentation window in measurement time., One ``[visible, next visible)`` presentation window in measurement time., _can_smooth(), _finalize(), _is_locally_uniform() (+35 more)
...
Cohesion: 0.09
Nodes (23): keysFromMask(), aimFor(), makeV3Payload(), pointFor(), widePayload(), payloadWithEyeZ(), recordTicks(), bearingDeg() (+15 more)
...
Cohesion: 0.13
Nodes (6): resolveDrillTimeLimitMs(), resolveSpiderShotWideV1(), payload(), tick(), buildDeclaredWeaponByDrillId(), wideConfig()

### Community 27 - "Community 27"
Cohesion: 0.09
Nodes (25): cameraLookingDownZ(), driveRenderAndSim(), fireAt(), fixedClock(), makeTarget(), meanSpreadRadius(), run(), runAtPumpCadence() (+17 more)
...
Cohesion: 0.1
Nodes (18): buildExportPayload(), serializeJSON(), targetHitboxToConfig(), degToRad(), makeRoundTripPayload(), tickTime(), yawDegAt(), aimAtPoint() (+10 more)

### Community 37 - "Community 37"
Cohesion: 0.09
Nodes (25): createDrillRunner(), makeConfig(), reversalConfig(), run(), setup(), setupArmed(), trackingGuardConfig(), runTimeoutOnly() (+17 more)
...
Cohesion: 0.09
Nodes (14): compileSessionProgram(), requireRestSeconds(), resolveBoundary(), SessionProgramCompileError, summarizeProgram(), describeBoundary(), createRestOverlay(), FakeDocument (+6 more)
...
Cohesion: 0.13
Nodes (23): resolveHitFeedback(), drillSourceFor(), researcherControlsDrills(), resolveAvailableDrill(), diffFields(), flatten(), baseTargets(), buildTrackingCorePrPilotV1Cell() (+15 more)
...
Cohesion: 0.14
Nodes (25): _keys_for_tick(), make_synthetic_export(), _profile(), Deterministic schema v2 synthetic export generation.  No clock or random sourc, Create a schema-faithful deterministic v2 payload without writing it to disk., Create a schema-faithful deterministic v2 payload without writing it to disk., SyntheticSpec, main() (+17 more)

### Community 53 - "Community 53"
Cohesion: 0.14
Nodes (17): resolveFamilyDrillId(), resolveWarmupDrillId(), findSessionPlanPreset(), buildFrozenSessionPlan(), createSessionRunner(), requireFamilyOrder(), resolveFamilyDrillId(), resolveWarmupDrillId() (+9 more)
...
Cohesion: 0.1
Nodes (9): angularSeparationDeg(), centerRelativeDirection(), minimumActiveSeparationDeg(), satisfiesActiveSeparation(), shuffleInPlace(), isDrivenMotion(), motionOffset(), offsetAt() (+1 more)
...
- **Why does `bool()` connect `Community 77` to `Community 98`, `Community 4`, `Community 73`, `Community 10`, `Community 16`, `Community 49`, `Community 61`, `Community 86`, `Community 56`, `Community 156`, `Community 157`, `Community 31`?**
  _High betweenness centrality (0.281) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 98` to `Community 131`, `Community 4`, `Community 10`, `Community 143`, `Community 16`, `Community 17`, `Community 146`, `Community 144`, `Community 155`, `Community 156`, `Community 29`, `Community 42`, `Community 49`, `Community 56`, `Community 57`, `Community 202`, `Community 203`, `Community 77`, `Community 84`, `Community 108`, `Community 112`, `Community 113`, `Community 124`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 31` to `Community 77`?**
