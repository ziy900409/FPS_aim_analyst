...
## Corpus Check
- 714 files · ~1,445,473 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5483 nodes · 13738 edges · 310 communities (267 shown, 43 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1763 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6055428f`
...
- `report()` --calls--> `buildSpiderShotV3CoachReport()`  [INFERRED]
  tests/regression/spider-shot-v3-coach-runner.test.ts → scripts/spiderShotV3CoachRunner.ts
...
## Communities (310 total, 43 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (50): spawnBullet(), stepBullet(), clipAxis(), sweptHitTest(), collect64HzSamples(), advanceProjectiles(), applyInput(), ballisticRaycast() (+42 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (53): setup(), setupArmed(), fixedClock(), v8SpawnTrace(), fixedClock(), v9SpawnTrace(), runCadenceTimeoutExport(), runTimeoutOnly() (+45 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (65): activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), attemptPlanForExport(), average(), beginNextProtocolCondition(), beginPause(), buildSimLoop() (+57 more)
...
Cohesion: 0.07
Nodes (32): createDrillRunner(), makeConfig(), reversalConfig(), run(), trackingGuardConfig(), runCadenceTimeoutExport(), runTimeoutOnly(), createSimLoop() (+24 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (33): consume(), advanceUntilTracer(), createCamera(), createTarget(), fireOne(), runAtFrames(), collectImpacts(), collectTracers() (+25 more)

### Community 10 - "Community 10"
Cohesion: 0.08
Nodes (57): assess_sufficiency(), bootstrap_f1_interval(), confusion_matrix(), decide(), evaluate_layers(), fit_layers(), _group_false_positive_rate(), LayerRule (+49 more)
...
Cohesion: 0.08
Nodes (51): assert_block_matches_golden(), boundary_windows(), derive_gap_boundary_kinematics(), FeatureError, _list(), load_sample_block(), _mapping(), _mean_speed() (+43 more)

### Community 13 - "Community 13"
Cohesion: 0.08
Nodes (26): targetHitboxToConfig(), resolveSpiderShotWideV1(), requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor(), enumerateLandings() (+18 more)

### Community 14 - "Community 14"
Cohesion: 0.1
Nodes (14): resolveDrillTimeLimitMs(), resolveHitFeedback(), buildEndConditionByDrillId(), diffFields(), flatten(), diffFields(), flatten(), createDrillMetricRegistry() (+6 more)
...
Cohesion: 0.1
Nodes (46): epsilon_deg(), EyeOrigin, _finite_scalar(), _finite_vec3(), _meta_eye_origin(), omega_deg_s(), Return angular speed for each tick, with ``nan`` at index zero.      Prefers t, Return unsigned aim-to-target-center angular error for each tick.      The ray (+38 more)

### Community 20 - "Community 20"
Cohesion: 0.09
Nodes (20): createAttemptFinalizationGate(), describeDiscardReason(), invalidAttemptBasename(), planFinalization(), snapshot(), ticksFrom(), evaluateRecordingIntegrity(), pauseFenceClosed() (+12 more)

### Community 21 - "Community 21"
Cohesion: 0.09
Nodes (29): resolveFamilyDrillId(), resolveWarmupDrillId(), findSessionPlanPreset(), compileSessionProgram(), deriveProgramFamilyOrder(), requireRestSeconds(), requireWeapon(), resolveBoundary() (+21 more)
...
Cohesion: 0.09
Nodes (35): activeValidityFlags(), analyseRun(), arrivalConditions(), assessSequence(), buildGates(), buildRepTrend(), buildSpiderShotV3CoachReport(), buildTails() (+27 more)
...
Cohesion: 0.09
Nodes (11): reparse(), createHistoryClient(), HistoryClientError, isErrorBody(), isRecord(), isSuccessBody(), createHistoryLibraryController(), historyRunSummaryFromPayload() (+3 more)
...
Cohesion: 0.07
Nodes (19): describeBoundary(), createRestOverlay(), FakeDocument, FakeElement, createSessionPlanSetup(), describeStep(), groupSchedulableDrills(), makeButton() (+11 more)
...
Cohesion: 0.09
Nodes (22): createHistoryAnalysisService(), createSemaphore(), realRegistry(), closeHistoryApiState(), contentLengthExceeds(), createHistoryApiMiddleware(), createHistoryApiState(), dispatch() (+14 more)
...
Cohesion: 0.13
Nodes (17): widePayload(), payloadWithEyeZ(), recordTicks(), makeMeta(), makePayload(), makeTick(), normalizeReplayRecording(), toSceneDescriptor() (+9 more)

### Community 40 - "Community 40"
Cohesion: 0.07
Nodes (37): counter(), build_report(), _counts(), _drill_summary(), _epsilon_or_none(), _finite(), _fitts_block(), _flag_counts() (+29 more)
...
Cohesion: 0.1
Nodes (22): renderTrackingPilotReportHtml(), anglesToWorld(), buildPayload(), perfectFollowerPayload(), collectFiles(), load(), main(), stimulusCheck() (+14 more)
...
Cohesion: 0.11
Nodes (9): PROBE(), SceneManager, buildLargePayload(), ReplaySceneAdapter, sample(), resolveEyeWorldBase(), nearlyEqual(), requireRoomEnvelope() (+1 more)
...
Cohesion: 0.13
Nodes (29): annotation(), gap(), latencyCohort(), liftPayload(), liftRun(), move(), traceBlock(), collectFiles() (+21 more)
...
Cohesion: 0.13
Nodes (27): createRan1(), randomFloat(), shuffleInPlace(), expectedPos(), boundedSpeedScale(), buildSinusoidComponents(), clamp(), createBandLimited2dV1() (+19 more)

### Community 51 - "Community 51"
Cohesion: 0.09
Nodes (29): detect_parity_payload(), _detect_presentation(), detect_samples(), DetectParams, _epsilon_with_fixed_target(), _eye_origin_to_json(), _first_sustained_decrease(), _first_tick_index_at_or_after() (+21 more)
...
Cohesion: 0.1
Nodes (29): _ad_key_events(), _aligned(), _bootstrap_ci(), _checked_flags(), _correlogram(), _gate_verdict(), GateVerdict, _half_agreement() (+21 more)
...
Cohesion: 0.14
Nodes (22): ceilingBinShare(), describePhaseDeltas(), describePhaseShape(), describeSteps(), escapeHtml(), fmt(), inline(), metricRow() (+14 more)
...
Cohesion: 0.16
Nodes (20): parseEvents(), parseExportPayload(), parseTicks(), parseSpiderShot(), collectFiles(), load(), loadManifest(), main() (+12 more)
...
Cohesion: 0.12
Nodes (15): applyAimFixture(), canonicalSprayFrames(), collectImpacts(), createCamera(), round(), runSpray(), spiderEyePolarPos(), angularSeparationDeg() (+7 more)
...
Cohesion: 0.22
Nodes (22): x(), chartC1(), chartC2(), chartC3(), chartC4(), chartC5(), chartC6(), chartC7() (+14 more)

### Community 73 - "Community 73"
Cohesion: 0.15
Nodes (20): _aim_forward(), _column(), _finite_column(), _geometry(), _hitbox(), OmegaResult, on_target(), _positive_scalar() (+12 more)
...
Cohesion: 0.16
Nodes (23): appendCurveBand(), appendCurveLine(), appendGuideLine(), appendPath(), countFlags(), createPromotedSummary(), createQualityFlagSummary(), finiteCurveValues() (+15 more)
...
Cohesion: 0.14
Nodes (7): createRenderLoop(), lerp(), TargetView, both(), moving(), only(), target()
...
Cohesion: 0.18
Nodes (11): createHistoryRepository(), HistoryContainmentError, HistoryRepositoryError, isProcessAlive(), MissingParticipantError, PayloadTooLargeError, PracticeNotArchivableError, listAllFiles() (+3 more)
...
Cohesion: 0.13
Nodes (11): classifyResidualSpeed(), createResultScreen(), makeResultActionButton(), diagnosisMetricIds(), FakeDocument, flatten(), metricIds(), mountWithActions() (+3 more)

### Community 100 - "Community 100"
Cohesion: 0.16
Nodes (20): ADR-5 Pointer Lock + 原始輸入 + coalesced, D1 UI = 純 TS + DOM overlay, WP-4 — 目標 / 準心, WP-6 — drill config (房間/距離正式值), WP-7 — DataRecorder ring buffer / metadata, NotSupportedError fallback (僅 Chromium 降級路徑), pitch 夾角 (clamp ±~89° 避免翻轉), PointerLockHandle (request/locked/onChange/onMove) (+12 more)
...
Cohesion: 0.21
Nodes (12): _advanced_diagnostics(), _empty_stats(), _phase_entries(), Run the three WP-31 P2 diagnostics and shape each into a verdict, not a bare num, SPARC has no ``blocked-by-data`` branch -- it always reaches the research block,, _rec_detect_consistency(), _row_stats(), _sparc_block() (+4 more)
...
Cohesion: 0.24
Nodes (6): distanceForAngularHeight(), makeVariant(), speedForAngularRate(), variantId(), SessionProgramCompileError, summarizeProgram()
...
Cohesion: 0.25
Nodes (8): createControls(), makeButton(), makeSelect(), makeToggle(), runControl(), FakeDocument, runResultAction(), action()
...
Cohesion: 0.32
Nodes (4): aimFor(), makeV3Payload(), pointFor(), report()
...
Cohesion: 0.47
Nodes (3): recordTicks(), checkTrackingStimulusFidelity(), recoverSightline()

### Community 229 - "Community 229"
Cohesion: 0.47
Nodes (3): createPauseOverlay(), FakeDocument, mount()
...
- **Why does `bool()` connect `Community 88` to `Community 34`, `Community 5`, `Community 40`, `Community 74`, `Community 109`, `Community 60`, `Community 81`, `Community 25`, `Community 59`, `Community 156`, `Community 95`?**
  _High betweenness centrality (0.303) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 109` to `Community 5`, `Community 17`, `Community 148`, `Community 149`, `Community 150`, `Community 151`, `Community 27`, `Community 156`, `Community 157`, `Community 40`, `Community 51`, `Community 60`, `Community 73`, `Community 74`, `Community 204`, `Community 205`, `Community 88`, `Community 92`, `Community 115`, `Community 117`, `Community 118`, `Community 125`, `Community 127`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 34` to `Community 88`?**
