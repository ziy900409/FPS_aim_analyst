...
## Corpus Check
- 678 files · ~1,346,108 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5229 nodes · 12990 edges · 302 communities (266 shown, 36 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1689 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `466b9107`
...
## Communities (302 total, 36 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (41): createSimLoop(), brInputs(), createCamera(), runBrVariant(), advanceUntilTracer(), createCamera(), createTarget(), fireOne() (+33 more)
...
Cohesion: 0.07
Nodes (36): widePayload(), payloadWithEyeZ(), recordTicks(), recordTicks(), makeMeta(), makePayload(), makeTick(), normalizeReplayRecording() (+28 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (57): downloadCSV(), downloadJSON(), downloadTextFile(), createPointerLock(), createRenderLoop(), lerp(), activateDrill(), activeWeaponConfig() (+49 more)
...
Cohesion: 0.08
Nodes (47): round(), simulatePurePunchPattern(), toPatternShot(), punchToThreeRad(), buttonCss(), createNumberInput(), drawGrid(), drawPattern() (+39 more)

### Community 8 - "Community 8"
Cohesion: 0.09
Nodes (32): resolveTargetHitbox(), targetHitboxToConfig(), loadDrill(), aimAt(), fireFrom(), pushTarget(), buildRoundTripPayload(), wideConfig() (+24 more)
...
Cohesion: 0.09
Nodes (27): buildEarlyReplayFixture(), buildFixture(), fixtureStartedAt(), buildFixture(), buildFixture(), buildIdentitySegment(), buildRunFilename(), buildRunId() (+19 more)
...
Cohesion: 0.05
Nodes (22): SessionProgramCompileError, summarizeProgram(), describeBoundary(), createRestOverlay(), FakeDocument, FakeElement, createSessionPlanSetup(), describeStep() (+14 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (31): spawnBullet(), stepBullet(), clipAxis(), sweptHitTest(), collect64HzSamples(), advanceProjectiles(), applyInput(), ballisticRaycast() (+23 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (20): consume(), createInputSampler(), resetRecoilState(), ImpactView, createMovementController(), run(), runBatches(), drainAll() (+12 more)
...
Cohesion: 0.12
Nodes (8): resolveDrillTimeLimitMs(), distanceForAngularHeight(), makeVariant(), speedForAngularRate(), variantId(), buildDeclaredWeaponByDrillId(), buildCuratedRegistry(), isWeaponId()
...
Cohesion: 0.08
Nodes (33): _axis_grid(), _better(), bootstrap_f1_interval(), confusion_matrix(), _direction_change_variance(), _duration_grid(), evaluate_layers(), fit_boundary() (+25 more)
...
Cohesion: 0.11
Nodes (20): resolveFamilyDrillId(), resolveWarmupDrillId(), findSessionPlanPreset(), compileSessionProgram(), requireRestSeconds(), requireWeapon(), resolveBoundary(), buildFrozenSessionPlan() (+12 more)
...
Cohesion: 0.12
Nodes (33): _can_smooth(), _finalize(), _peak_omega(), phase_decompose(), phase_table(), PhaseParams, PhaseSample, REC/MR/V phase decomposition (WP-30 / T2, FR-D11).  ``phase-v1`` answers "whic (+25 more)
...
Cohesion: 0.12
Nodes (36): assess_sufficiency(), decide(), fit_layers(), hover_analogue(), The reference stage 2 rule, read as evidence *for* a lift rather than as a trim., The reference stage 3 rule: does the boundary look like a hovering, jittering ha, Attach the layer inputs to T2's candidate table, for one boundary-window length., The four rules, in order. Layers 3 and 4 fit nothing -- they only add the refere (+28 more)

### Community 35 - "Community 35"
Cohesion: 0.12
Nodes (33): ConfusionMatrix, F1Interval, GateCheck, LayerResult, Whether the reference stage 2 rule *can* fire at a given sample spacing, and by, One (theta, window, layer, split) cell of the ablation. Every field the DoD name, A percentile bootstrap interval for F1, with the seed that produced it., One row of the "rule text -> actual value -> verdict" table the DoD requires. (+25 more)

### Community 36 - "Community 36"
Cohesion: 0.11
Nodes (18): resolveSpiderShotWideV1(), reparse(), requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor(), enterResearcherDrillControls() (+10 more)
...
Cohesion: 0.12
Nodes (23): createDataRecorder(), capacityForDrill(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), cameraLookingDownZ(), driveRenderAndSim(), fireAt() (+15 more)
...
Cohesion: 0.12
Nodes (27): ceilingBinShare(), chartC5(), describePhaseDeltas(), describePhaseShape(), describeSteps(), describeTails(), escapeHtml(), fmt() (+19 more)
...
Cohesion: 0.13
Nodes (27): _keys_for_tick(), make_synthetic_export(), _profile(), Deterministic schema v2 synthetic export generation.  No clock or random sourc, Create a schema-faithful deterministic v2 payload without writing it to disk., Create a schema-faithful deterministic v2 payload without writing it to disk., SyntheticSpec, main() (+19 more)

### Community 46 - "Community 46"
Cohesion: 0.11
Nodes (17): buildExportPayload(), serializeJSON(), degToRad(), makeRoundTripPayload(), tickTime(), yawDegAt(), aimAtPoint(), makeLeadPayload() (+9 more)
...
Cohesion: 0.15
Nodes (28): _list(), load_export(), _mapping(), _non_empty_string(), _number(), _optional_number(), Load the JSON form of the schema v2 export documented in docs/operational/schema, A schema v2 validation error with a machine-readable JSON field path. (+20 more)

### Community 50 - "Community 50"
Cohesion: 0.14
Nodes (25): expectedPos(), boundedSpeedScale(), buildSinusoidComponents(), clamp(), createBandLimited2dV1(), createReversal2dV1(), createTrackingTrajectory(), evaluateAxis() (+17 more)
...
Cohesion: 0.1
Nodes (21): _hover_window_samples(), The hover window: the samples entering the gap, spanning the source's hover wind, counts_value(), parameter(), WP-61 T3 layers 3 and 4: the reference pipeline's parameters, with their provena, Look one parameter up by its source name., The value in this project's space. The only accessor downstream code may use., One reference-pipeline constant and the four things FR-61.10 requires be recorde (+13 more)
...
Cohesion: 0.14
Nodes (19): drillSourceFor(), researcherControlsDrills(), resolveAvailableDrill(), baseTargets(), buildTrackingCorePrPilotV1Cell(), corePrPilotV1DrillId(), cubeHitbox(), scoredTiming() (+11 more)
...
Cohesion: 0.11
Nodes (12): applyAimFixture(), canonicalMovingTargetFrames(), createCamera(), runMovingTarget(), angularSeparationDeg(), centerRelativeDirection(), minimumActiveSeparationDeg(), satisfiesActiveSeparation() (+4 more)
...
Cohesion: 0.15
Nodes (20): assert(), getHealth(), getParticipants(), gitCommit(), main(), postRun(), runScenario(), buildLargeReplayPayload() (+12 more)
...
Cohesion: 0.15
Nodes (19): GateThresholds, key_state_signed(), Signed strafe key state per tick: ``D`` -> ``+1``, ``A`` -> ``-1``, both or neit, ``gate-v1``, frozen by WP-31 T0 on 2026-08-10 (D-31.4) before any real xcorr val, _key_events(), T2 DoD 3, proven from the source rather than by sampling inputs.      Two fact, test_a_known_lag_is_recovered_within_one_tick_with_the_documented_sign(), test_an_event_beyond_the_tolerance_does_not_match() (+11 more)
...
Cohesion: 0.14
Nodes (14): buildConditionEvidence(), buildTrackingPilotEvidence(), anglesToWorld(), buildPayload(), perfectFollowerPayload(), computeTrackingFrozenCrosshairRatio(), frozenEpsilonDeg(), median() (+6 more)

### Community 72 - "Community 72"
Cohesion: 0.18
Nodes (20): deriveDetectionMetrics(), deriveRepositioningSuspicion(), longer(), longestStall(), nonNegativeFinite(), positiveFinite(), collectFiles(), load() (+12 more)

### Community 73 - "Community 73"
Cohesion: 0.11
Nodes (11): createMetricsDashboard(), computeCurveMetrics(), computePhaseMetrics(), computePromotedMetrics(), sortedTicks(), expectCurveAggregateParity(), expectNormalizedCurveParity(), loadCurve() (+3 more)
...
Cohesion: 0.13
Nodes (21): _has_flags(), _events_in_window(), _false(), _finite_number(), _first_compatible_fire(), _hit_times_by_shot(), _key(), _keys() (+13 more)
...
Cohesion: 0.26
Nodes (17): x(), chartC1(), chartC2(), chartC3(), chartC4(), chartC6(), chartC7(), figure() (+9 more)
...
Cohesion: 0.12
Nodes (19): _aligned(), _checked_flags(), key_velocity_xcorr(), _median_dt_ms(), One window's cross-correlation.      ``correlogram`` entries are ``(lag_ms, r,, Signed Pearson r at every lag in ``[-max_lag_ticks, +max_lag_ticks]``, plus the, Drop ``omega_deg_s``'s contractual leading ``nan`` from **both** channels togeth, One table row's result plus the inputs :func:`reliability_gate` needs to re-corr (+11 more)
...
Cohesion: 0.15
Nodes (17): ADR-2 雙迴圈解耦, ADR-3 128 Hz tick, ADR-4 performance.now() 計時源, WP-3 — 高頻輸入採集 (getCoalescedEvents 入緩衝), WP-4 — 目標 / 準心, WP-5 — movement / 急停物理, WP-1 Progress Log, WP-1 — FPS 控制 + Pointer Lock (exec-plan) (+9 more)
...
Cohesion: 0.23
Nodes (6): raycastFromCenter(), raycastWithRay(), cameraLookingDownZ(), makeTarget(), movingSetup(), sphereTarget()

### Community 150 - "Community 150"
Cohesion: 0.26
Nodes (9): dot(), sgSmooth(), validateCoefficients(), validateMatrix(), validateRow(), expectNullableParity(), expectRelativeParity(), loadJson() (+1 more)
...
- **Why does `bool()` connect `Community 78` to `Community 5`, `Community 102`, `Community 72`, `Community 11`, `Community 77`, `Community 79`, `Community 47`, `Community 214`, `Community 56`, `Community 155`, `Community 60`, `Community 30`?**
  _High betweenness centrality (0.289) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 102` to `Community 5`, `Community 11`, `Community 142`, `Community 144`, `Community 17`, `Community 146`, `Community 145`, `Community 18`, `Community 155`, `Community 156`, `Community 29`, `Community 175`, `Community 47`, `Community 53`, `Community 56`, `Community 202`, `Community 203`, `Community 78`, `Community 85`, `Community 109`, `Community 118`, `Community 119`, `Community 125`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 30` to `Community 78`?**
