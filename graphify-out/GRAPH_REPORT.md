...
## Corpus Check
- 79 files · ~114,438 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 651 nodes · 1292 edges · 46 communities (30 shown, 16 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 74 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8978f373`
...
Cohesion: 0.09
Nodes (38): buttonCss(), createNumberInput(), drawGrid(), drawPattern(), maxSpreadRadiusDeg(), mountPatternViewer(), niceStep(), patternBounds() (+30 more)
...
Cohesion: 0.32
Nodes (4): createRenderLoop(), lerp(), createExportPanel(), makeButton()
...
- **Why does `規格書 v1.1 + WBS` connect `Community 13` to `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 19`, `Community 26`?**
