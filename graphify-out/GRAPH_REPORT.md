# Graph Report - FPS_aim_analyst  (2026-09-18)

## Corpus Check
- 738 files · ~1,515,698 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5716 nodes · 14177 edges · 332 communities (283 shown, 49 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1827 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e5b2aa9a`
...
2. `createDataRecorder()` - 90 edges
3. `createTargetManager()` - 87 edges
4. `createSimLoop()` - 78 edges
5. `load_export()` - 77 edges
6. `loadDrill()` - 68 edges
7. `build_peek_windows()` - 57 edges
8. `createDrillRunner()` - 49 edges
9. `collectMeta()` - 46 edges
...
Cohesion: 0.05
Nodes (41): createDataRecorder(), FakeSettingsDocument, wireSettingsToRecorder(), capacityForDrill(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), payloadWithStopTransitions() (+33 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (53): setup(), setupArmed(), runCadenceTimeoutExport(), runTimeoutOnly(), targetPathAfterCountdown(), drainSpawns(), timeoutHarness(), wideConfig() (+45 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (67): createRenderLoop(), lerp(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), attemptPlanForExport(), average(), beginNextProtocolCondition() (+59 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (42): spawnBullet(), stepBullet(), clipAxis(), sweptHitTest(), collect64HzSamples(), advanceProjectiles(), applyInput(), ballisticRaycast() (+34 more)
...
Cohesion: 0.06
Nodes (32): canonicalExportJSON(), fixedClock(), v8SpawnTrace(), fixedClock(), v9SpawnTrace(), createSimLoop(), requireNonNegativeFinite(), sampleSpread() (+24 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (52): _axis_grid(), _better(), bootstrap_f1_interval(), confusion_matrix(), ConfusionMatrix, decide(), _duration_grid(), evaluate_layers() (+44 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (29): resolveTargetHitbox(), loadDrill(), aimAt(), fireFrom(), pushTarget(), activeSides(), assertFiniteEnvelope(), clipAxis() (+21 more)

### Community 8 - "Community 8"
Cohesion: 0.13
Nodes (61): canonicalizeValue(), fail(), isRecord(), parseAdsEvent(), parseAim(), parseAnnotationEvent(), parseArray(), parseAssessmentMeta() (+53 more)
...
Cohesion: 0.06
Nodes (24): consume(), ImpactView, createMovementController(), run(), runBatches(), drainAll(), drainToArray(), snapshot() (+16 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (30): resolveWarmupDrillId(), compileSessionProgram(), deriveProgramFamilyOrder(), requireRestSeconds(), requireWeapon(), resolveBoundary(), SessionProgramCompileError, summarizeProgram() (+22 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (24): createRig(), makeDrillConfig(), createDrillRunner(), makeConfig(), reversalConfig(), run(), trackingGuardConfig(), runCadenceTimeoutExport() (+16 more)
...
Cohesion: 0.08
Nodes (28): assessmentProtocolVersionForDrill(), angularSizeToHitboxWidthU(), buildPeekClickTransferPilotConfig(), pilotDrillId(), buildPeekClickTransferPilotV2Config(), buildPeekClickTransferPilotV2MaskedConfig(), buildPeekClickTransferPilotV2RandomizedConfig(), peekClickTransferPilotV2CandidateLabel() (+20 more)
...
Cohesion: 0.09
Nodes (45): buildEndConditionByDrillId(), eyeOriginForTick(), angularRadiusDeg(), angularRadiusSource(), attributeShot(), cadenceWaitWithin(), candidatesAtKill(), candidatesForShot() (+37 more)
...
Cohesion: 0.07
Nodes (37): Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., _render_flags(), render_html(), _render_limitations(), Contract tests for the one-command coach report v1 (WP-30 T-exit).  Covers the (+29 more)

### Community 20 - "Community 20"
Cohesion: 0.11
Nodes (11): resolveDrillTimeLimitMs(), resolveHitFeedback(), resolveSpiderShotWideV1(), diffFields(), flatten(), diffFields(), flatten(), createDrillMetricRegistry() (+3 more)
...
Cohesion: 0.07
Nodes (23): applyResolutionMode(), readDevicePixelRatio(), readViewport(), requirePositiveInteger(), resolutionModeLabel(), FakeRenderer, assignOptionalNumber(), assignOptionalText() (+15 more)
...
Cohesion: 0.1
Nodes (29): buildTrackingPilotEvidence(), renderTrackingPilotReportHtml(), anglesToWorld(), buildPayload(), perfectFollowerPayload(), collectFiles(), load(), main() (+21 more)

### Community 28 - "Community 28"
Cohesion: 0.1
Nodes (23): keysFromMask(), aimFor(), makeWidePayload(), pointFor(), widePayload(), payloadWithEyeZ(), recordTicks(), bearingDeg() (+15 more)
...
Cohesion: 0.1
Nodes (40): appendCurveBand(), appendCurveLine(), appendGuideLine(), appendPath(), classifyResidualSpeed(), countFlags(), createDiagnosisSummary(), createPromotedSummary() (+32 more)

### Community 32 - "Community 32"
Cohesion: 0.11
Nodes (35): _can_smooth(), _finalize(), _is_locally_uniform(), _peak_omega(), phase_decompose(), phase_table(), PhaseParams, PhaseSample (+27 more)
...
Cohesion: 0.12
Nodes (28): measureAtEye(), createRan1(), randomFloat(), expectedPos(), boundedSpeedScale(), buildSinusoidComponents(), clamp(), createBandLimited2dV1() (+20 more)

### Community 37 - "Community 37"
Cohesion: 0.09
Nodes (10): realRegistry(), createHistoryClient(), HistoryClientError, isErrorBody(), isRecord(), isSuccessBody(), createHistoryLibraryController(), createHistoryPersistence() (+2 more)

### Community 38 - "Community 38"
Cohesion: 0.14
Nodes (26): round(), simulatePurePunchPattern(), toPatternShot(), createRecoilState(), hybridDecay(), recoilOnFire(), recoilTick(), resetRecoilState() (+18 more)
...
Cohesion: 0.11
Nodes (17): createAttemptFinalizationGate(), describeAttemptHold(), describeDiscardReason(), invalidAttemptBasename(), planFinalization(), snapshot(), ticksFrom(), evaluateRecordingIntegrity() (+9 more)
...
Cohesion: 0.1
Nodes (31): key_state_signed(), key_velocity_xcorr(), _pearson(), Signed strafe key state per tick: ``D`` -> ``+1``, ``A`` -> ``-1``, both or neit, Signed Pearson r at every lag in ``[-max_lag_ticks, +max_lag_ticks]``, plus the, Signed Pearson r, or ``nan`` for too-few samples / a zero-variance input (PA ``_, _key_events(), T2 DoD 3, proven from the source rather than by sampling inputs.      Two fact (+23 more)

### Community 46 - "Community 46"
Cohesion: 0.09
Nodes (32): _ad_key_events(), _aligned(), _bootstrap_ci(), _checked_flags(), _correlogram(), _gate_verdict(), GateVerdict, _half_agreement() (+24 more)

### Community 47 - "Community 47"
Cohesion: 0.1
Nodes (22): integratedDelta(), omegaDegPerSec(), radToDeg(), requireFiniteNumber(), deriveDetectionMetrics(), deriveRepositioningSuspicion(), longer(), longestStall() (+14 more)
...
Cohesion: 0.11
Nodes (17): buildExportPayload(), serializeJSON(), degToRad(), makeRoundTripPayload(), tickTime(), yawDegAt(), aimAtPoint(), aimAtTick() (+9 more)
...
Cohesion: 0.11
Nodes (16): aimForward(), angularDistanceDeg(), angularEccentricityDeg(), clamp(), isFiniteNumber(), radToDeg(), resolveEyeOrigin(), deriveStopTransitions() (+8 more)

### Community 56 - "Community 56"
Cohesion: 0.16
Nodes (27): deriveTrackingMetrics(), deriveTrackingSamples(), adaptPayloadForScoredWindow(), applySmoothing(), applySmoothingToSeries(), clamp(), computeSignedBias(), computeSignedOmegaSeries() (+19 more)
...
Cohesion: 0.13
Nodes (27): annotation(), gap(), latencyCohort(), liftPayload(), liftRun(), move(), traceBlock(), collectFiles() (+19 more)

### Community 59 - "Community 59"
Cohesion: 0.11
Nodes (14): deriveBrakingSamples(), baseMeta(), payload(), deriveCounterstrafeMetrics(), sidedStat(), buildHitboxAtTick(), deriveHoldClickMetrics(), buildPeekWindows() (+6 more)

### Community 60 - "Community 60"
Cohesion: 0.11
Nodes (16): makeMeta(), buildLargePayload(), buildSmallPayload(), timeFor(), buildLargePayload(), fixtureRecording(), renderAt(), ReplayEffectView (+8 more)

### Community 61 - "Community 61"
Cohesion: 0.12
Nodes (14): createPresentationCoordinator(), normalizeReplayRecording(), toSceneDescriptor(), fixtureRecording(), fixtureRecording(), clamp(), createReplayPlayer(), normalize() (+6 more)
...
Cohesion: 0.11
Nodes (29): check_construct_presence(), ConstructReport, ConstructRule, is_known_construct_flag(), Session-level construct presence gate.  Complements the existing format-only gat, Return whether *flag* is an exact or templated vocabulary member., A drill family's core construct declaration (frozen; changes require a version b, Session-level presence verdict. ``present is None`` iff the family is unregister (+21 more)

### Community 65 - "Community 65"
Cohesion: 0.14
Nodes (17): deriveUnlockedIntervals(), overlapsAny(), segmentByTimeGap(), assessAnnotationChannel(), extractAnnotationIntervals(), buildLiftSegmentationGolden(), lastSampleMs(), segmentationAt() (+9 more)
...
Cohesion: 0.16
Nodes (26): _bool(), build_report_model(), _cell_summaries(), _configuration_summaries(), _contrast_summaries(), _coverage_row(), _float(), _int() (+18 more)

### Community 69 - "Community 69"
Cohesion: 0.11
Nodes (25): _compute_failed_flag(), _has_flags(), is_known_quality_flag(), per_segment_apply(), Per-segment computation with a closed, machine-readable quality vocabulary.  E, Summarize finite, unflagged values while counting excluded flagged rows., Summarize finite, unflagged values while counting excluded flagged rows., Return whether *flag* is an exact or templated vocabulary member. (+17 more)
...
Cohesion: 0.14
Nodes (21): qualityGateStatusForPayload(), buildCompatibilityKey(), buildSensitivityFovKey(), checkCompatibility(), checkQualityGate(), deriveSessionId(), requireBoolean(), requireNonNegativeFiniteNumber() (+13 more)
...
Cohesion: 0.14
Nodes (19): firstTickAtOrAfter(), lastTickBefore(), normalizeRad(), preAimForPresentation(), targetFromTick(), targetFromVisible(), deriveVisibilityTimeline(), firstCrossingTimes() (+11 more)
...
Cohesion: 0.1
Nodes (16): _ads_holds(), assess_quality(), extract_presentations(), first_shot_delta(), MechanismColumn, Presentation, Track P extraction for the S01 mouse x grip pilot (`spider-shot-wide-v1`).  Im, S03 quality ledger row. ``blockers`` empty means the run may enter the main comp (+8 more)

### Community 80 - "Community 80"
Cohesion: 0.16
Nodes (7): createSceneLoadCoordinator(), SceneManager, ReplaySceneAdapter, resolveEyeWorldBase(), nearlyEqual(), requireRoomEnvelope(), requireSpiderShotDeliveryGeometry()
...
Cohesion: 0.12
Nodes (22): detect_parity_payload(), _detect_presentation(), DetectParams, DetectSample, _epsilon_with_fixed_target(), _eye_origin_to_json(), _first_sustained_decrease(), _first_tick_index_at_or_after() (+14 more)
...
Cohesion: 0.11
Nodes (11): createHistoricalRunDetail(), makeButton(), FakeDocument, FakeElement, findByTag(), flatten(), readyValue(), setup() (+3 more)
...
Cohesion: 0.15
Nodes (14): cmPerTurn(), countsPerTurn(), deriveMouseThrow(), isFinitePositive(), aimYaw(), annotationRate(), baseMeta(), buildCohort() (+6 more)
...
Cohesion: 0.15
Nodes (10): createInputSampler(), createPausableTimeMapper(), createFinalizationRig(), emptyMatrix(), createPauseRig(), pausedRig(), run(), createRig() (+2 more)
...
Cohesion: 0.14
Nodes (22): ADR-2 三迴圈經 SharedState 溝通, ADR-3 精準度來源 = sub-tick 輸入時間戳, ADR-4 performance.now() / event.timeStamp 同源, ADR-5 coalesced events, getCoalescedEvents 次幀採樣 (高頻滑鼠不丟樣本), 確定性左右交替輪替 (counter-strafe peek 節奏), 依時序排序消費 + 排空 (決定性契約), sub-tick 輸入時間戳 (精準度真正來源) (+14 more)
...
Cohesion: 0.14
Nodes (7): createDrillOverview(), makeButton(), historyRunSummaryFromPayload(), createHistoryScreen(), makeButton(), createParticipantBrowser(), makeButton()

### Community 99 - "Community 99"
Cohesion: 0.18
Nodes (18): buildHitShotSeqs(), buildSpiderShotV2ConditionCell(), buildSpiderShotV3ConditionCell(), formatGeometryNumber(), median(), projectPeekClickTransferV1(), projectSpiderShotV2(), projectSpiderShotV3() (+10 more)
...
Cohesion: 0.21
Nodes (17): Gap, GoldenError, _intervals(), _list(), load_lift_golden(), _mapping(), _number(), parse_lift_golden() (+9 more)
...
Cohesion: 0.17
Nodes (19): ADR-5 Pointer Lock + 原始輸入 + coalesced, D1 UI = 純 TS + DOM overlay, WP-4 — 目標 / 準心, WP-6 — drill config (房間/距離正式值), WP-7 — DataRecorder ring buffer / metadata, NotSupportedError fallback (僅 Chromium 降級路徑), pitch 夾角 (clamp ±~89° 避免翻轉), PointerLockHandle (request/locked/onChange/onMove) (+11 more)

### Community 109 - "Community 109"
Cohesion: 0.19
Nodes (14): compute_sparc(), Spectral arc length of ``velocity_series`` sampled at ``fs`` Hz (bit-for-bit PA/, _load(), test_all_zero_series_returns_zero_via_the_max_v_floor(), test_below_min_samples_returns_zero_not_nan(), test_constant_series_returns_zero(), test_domain_golden_covers_both_padding_buckets_and_the_edge_cases(), test_domain_golden_matches_the_port_on_every_case() (+6 more)
...
Cohesion: 0.25
Nodes (15): parseEvents(), parseExportPayload(), parseTicks(), collectFiles(), load(), loadManifest(), main(), isInstructionClass() (+7 more)
...
Cohesion: 0.3
Nodes (15): average(), buildResultPresentation(), createResultSummary(), diagnosisForPayload(), diagnosisInputsForPayload(), formatNumber(), formatPercent(), formatStatMean() (+7 more)
...
Cohesion: 0.17
Nodes (15): _mech(), Guards for the Track P extraction.  Two of these are behavioural tripwires rat, Sensitivity remains auditable on each run but never withholds a player contrast., `t3` exists in every run; keying on it alone would silently overwrite 50 rows wi, `overshoot_deg` is blank when the crosshair never left the target -- that is "no, C-D2: rendering and I/O belong in ``notebooks/``, never here., Determinism: the same export must always yield the same table., _run() (+7 more)

### Community 123 - "Community 123"
Cohesion: 0.16
Nodes (9): check_dt(), DtReport, Fixed-tick interval quality reporting., Uniformity report; each gap index identifies the right-hand tick row., Compare adjacent tick times with ``1000 / sim_hz`` using a 1e-6 ms tolerance., Pure Track P algorithms., _load(), test_check_dt_reports_dropped_tick_by_right_hand_row_index() (+1 more)
...
Cohesion: 0.17
Nodes (10): expectStatusRestoredAfterRestart(), openApp(), openStandaloneDrill(), protocolStatusLine(), readProtocolStatusLine(), readState(), restartFromPause(), snapshotFrozenGameplay() (+2 more)
...
Cohesion: 0.14
Nodes (3): keyMaskFromKeys(), keyMaskFromState(), TickArena

### Community 130 - "Community 130"
Cohesion: 0.19
Nodes (12): buttonCss(), createNumberInput(), drawGrid(), drawPattern(), maxSpreadRadiusDeg(), mountPatternViewer(), niceStep(), patternBounds() (+4 more)
...
Cohesion: 0.2
Nodes (15): coalesced events (getCoalescedEvents), backend (render backend webgpu/webgl2), 原始輸入 (unadjustedMovement), 技術棧 (Three.js WebGPU + TS + Vite), ADR-1 WebGPURenderer + WebGL2 fallback, ADR-5 Pointer Lock + 原始輸入 + coalesced events, 附錄 C 匯出資料 schema, WP-0 task-checklist.md (+7 more)
...
Cohesion: 0.14
Nodes (11): kaplan_meier(), KaplanMeier, Step function S(t) for time-to-hit, plus the follow-up limit it is valid within., Smallest t with S(t) <= 1-q, or None when the curve never gets that low., Restricted mean time-to-hit over [0, tau] -- the area under S(t)., Standard Kaplan-Meier estimator over ``(time, event_observed)`` pairs., Four observations, one censored mid-way -- the censored row must stay in the ris, When the curve never falls to 1-q, the quantile is unknown -- not the largest se (+3 more)
...
Cohesion: 0.22
Nodes (14): DrillConfig 元件, F5 接縫 (seam-in, drills-out), sim tick rate (128 Hz), GD-1 F5 是否屬階段 A (規格 v1.1 與 seam-in 不一致), DECISIONS.md 全域決策與矛盾帳本, 移動 + counter-strafe 能力混淆 (研究設計問題), 附錄 E 驗收清單 (階段 A), ADR-3 sim tick rate = 128 Hz (+6 more)
...
Cohesion: 0.2
Nodes (11): common_prefix_length(), index_mechanism(), mechanism_coverage(), mechanism_key(), Longest presentation prefix every run shares, with identical stimuli throughout., The only pair unique across the cohort —— `target_id` repeats in every run., Key the extractor's CSV rows for joining onto presentations., Share of rows carrying a value, per column. Columns whose blank is a real answer (+3 more)

### Community 171 - "Community 171"
Cohesion: 0.23
Nodes (12): The active-window contract for one run, with every boundary traceable to its sou, Apply the S05 active-window contract.      ``active_start`` is the first visib, resolve_timing(), RunTiming, _payload(), First-shot rate must not be computed over "trials where the player shot"., The recording tail must be trimmed by the time limit, not by where activity stop, A target that ran its full 2500 ms deadline and one cut off by the task clock ar (+4 more)
...
Cohesion: 0.24
Nodes (12): t_visible (可見時間戳 / 反應時間起點), Crosshair (src/ui/Crosshair.ts), D1 UI = 純 TS + DOM overlay, WP-1 場景 (相機 / Pointer Lock), WP-4 Progress Log, WP-4 T0 Entry gate, WP-4 T1 目標 entity (mesh + hitbox), WP-4 T2 可見性 + t_visible (sim tick 內蓋戳) (+4 more)
...
Cohesion: 0.29
Nodes (6): expectOk(), metaWith(), minimalMeta(), minimalPayload(), payloadWithEvents(), payloadWithTargets()

### Community 187 - "Community 187"
Cohesion: 0.24
Nodes (5): nextTickTimeAfter(), synthPosition(), tickAt(), unitFraction(), v8Fixture()
...
Cohesion: 0.2
Nodes (11): SharedState (src/state/SharedState.ts), SimLoop (src/loop/SimLoop.ts, 128 Hz), TargetManager (src/sim/TargetManager.ts), TargetState (id/side/pos/visible/alive/hitboxes), TargetView (src/render/TargetView.ts), consume (src/input/consume.ts), InputSampler (src/input/InputSampler.ts), WP-3 T5 Exit gate (+3 more)
...
Cohesion: 0.29
Nodes (9): extract_run(), Everything Track P needs from one run., S03 + S04 for one run. ``mouse`` / ``grip`` come from the manifest, never from t, RunExtract, load_participant(), load_condition(), main(), Track P pilot run over the S01 mouse x grip cohort.      uv run python src/mouse (+1 more)
...
Cohesion: 0.33
Nodes (4): isExportPayload(), loadAssessmentSessionSummaries(), parseExportPayload(), readExportPayload()
...
Cohesion: 0.36
Nodes (3): armDrill(), pulsePointerLock(), readDrillArmState()
...
Cohesion: 0.43
Nodes (4): createResearcherMenu(), makeButton(), shouldShowResearcherControls(), FakeDocument
...
Cohesion: 0.33
Nodes (5): targetHitboxToConfig(), buildRoundTripPayload(), parseSpiderShot(), buildCurrentExportPayload(), sessionPlanAuditFields()
...
Cohesion: 0.4
Nodes (5): admissible_mechanism_columns(), Split the columns into (admissible, withheld) by coverage alone.      Deliberate, The tier explains why a column tends to fail; the verdict still comes from what, test_admissibility_is_decided_by_coverage_not_by_tier(), test_the_cohort_figure_withholds_both_tier_one_columns()
...
Cohesion: 0.5
Nodes (4): match_prefix(), MatchedPair, One (rep, presentation_index) cell shared by two conditions with identical stimu, Pair two conditions on ``rep + presentation_index`` after verifying the stimulus

### Community 254 - "Community 254"
Cohesion: 0.5
Nodes (4): contrast_comparability(), Distinct values each comparability key takes over ``runs``. One value each means, Reasons two conditions cannot be compared as a device or grip contrast.      T, settings_spread()
...
## Knowledge Gaps
- **485 isolated node(s):** `Assemble the spider-shot-v3 coach proposal HTML from the generated figures.`, `Emit the SVG figures for the spider-shot-v3 coach proposal.  Geometry is compu`, `Horizontal bar path: square at the baseline (x0), rounded at the value end.`, `Leftward horizontal bar: square at the baseline (x_base), rounded at the value e`, `Vertical bar path: square at the baseline (y0), rounded at the top.` (+480 more)
...
- **Why does `bool()` connect `Community 79` to `Community 64`, `Community 65`, `Community 32`, `Community 4`, `Community 69`, `Community 70`, `Community 199`, `Community 40`, `Community 9`, `Community 168`, `Community 46`, `Community 62`, `Community 63`?**
  _High betweenness centrality (0.326) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 4` to `Community 133`, `Community 9`, `Community 144`, `Community 17`, `Community 29`, `Community 30`, `Community 159`, `Community 160`, `Community 158`, `Community 162`, `Community 163`, `Community 168`, `Community 169`, `Community 62`, `Community 63`, `Community 198`, `Community 70`, `Community 75`, `Community 79`, `Community 217`, `Community 95`, `Community 121`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 40` to `Community 79`?**
...
- **Are the 47 inferred relationships involving `createDataRecorder()` (e.g. with `createFinalizationRig()` and `createPauseRig()`) actually correct?**
  _`createDataRecorder()` has 47 INFERRED edges - model-reasoned connections that need verification._
- **Are the 48 inferred relationships involving `createTargetManager()` (e.g. with `activateDrill()` and `loadSceneById()`) actually correct?**
  _`createTargetManager()` has 48 INFERRED edges - model-reasoned connections that need verification._
- **Are the 41 inferred relationships involving `createSimLoop()` (e.g. with `buildSimLoop()` and `createPauseRig()`) actually correct?**
  _`createSimLoop()` has 41 INFERRED edges - model-reasoned connections that need verification._