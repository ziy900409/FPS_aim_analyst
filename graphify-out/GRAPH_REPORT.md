...
## Corpus Check
- 74 files · ~108,285 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 611 nodes · 1195 edges · 44 communities (29 shown, 15 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 61 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5c1b8b69`
...
Cohesion: 0.06
Nodes (43): loadDrill(), createDrillRunner(), setup(), err(), requireFiniteNumber(), requireNonNegativeNumber(), requireObject(), requirePositiveInt() (+35 more)
...
- **Why does `規格書 v1.1 + WBS` connect `Community 8` to `Community 10`, `Community 11`, `Community 12`, `Community 16`, `Community 17`, `Community 23`, `Community 24`?**
