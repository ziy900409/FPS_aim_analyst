...
## Corpus Check
- 715 files · ~1,449,506 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5495 nodes · 13779 edges · 316 communities (272 shown, 44 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1770 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2803c1a1`
...
Cohesion: 0.05
Nodes (51): loadDrill(), createDrillRunner(), makeConfig(), reversalConfig(), run(), setup(), setupArmed(), trackingGuardConfig() (+43 more)
...
Cohesion: 0.05
Nodes (65): createRenderLoop(), lerp(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), attemptPlanForExport(), average(), beginNextProtocolCondition() (+57 more)
...
Cohesion: 0.08
Nodes (51): configWith(), angularFieldDiameterDeg(), err(), requireAngularSeparation(), requireAscendingPositiveRange(), requireAscendingRange(), requireAssessmentMode(), requireBoolean() (+43 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (39): createSimLoop(), applyAimFixture(), canonicalMovingTargetFrames(), createCamera(), runMovingTarget(), advanceUntilTracer(), createCamera(), createTarget() (+31 more)
...
Cohesion: 0.06
Nodes (53): runControl(), appendCurveBand(), appendCurveLine(), appendGuideLine(), appendPath(), classifyResidualSpeed(), countFlags(), createDiagnosisSummary() (+45 more)

### Community 10 - "Community 10"
Cohesion: 0.08
Nodes (56): assess_sufficiency(), bootstrap_f1_interval(), confusion_matrix(), decide(), evaluate_layers(), fit_layers(), _group_false_positive_rate(), LayerRule (+48 more)

### Community 11 - "Community 11"
Cohesion: 0.07
Nodes (24): consume(), createInputSampler(), ImpactView, isDrivenMotion(), motionOffset(), offsetAt(), triangleWave(), drainAll() (+16 more)

### Community 12 - "Community 12"
Cohesion: 0.08
Nodes (55): counter(), _ads_label(), _advanced_diagnostics(), build_report(), _counts(), _delta(), _drill_summary(), _empty_stats() (+47 more)

### Community 13 - "Community 13"
Cohesion: 0.1
Nodes (12): resolveDrillTimeLimitMs(), resolveHitFeedback(), distanceForAngularHeight(), makeVariant(), speedForAngularRate(), variantId(), diffFields(), flatten() (+4 more)
...
Cohesion: 0.07
Nodes (23): createDataRecorder(), FakeSettingsDocument, wireSettingsToRecorder(), buildExportPayload(), capacityForDrill(), makeVaryingHitboxPayload(), payload(), payloadWithStopTransitions() (+15 more)
...
Cohesion: 0.06
Nodes (17): armAndTakeRealLock(), PROBE(), enterResearcherDrillControls(), hudTimeValue(), loadMicroFlick(), loadMicroFlickVariantAndArm(), parseHudTimeMs(), readHudTimeMs() (+9 more)
...
Cohesion: 0.07
Nodes (35): Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., _render_flags(), render_html(), _render_limitations(), _render_verdicts() (+27 more)
...
Cohesion: 0.09
Nodes (20): createAttemptFinalizationGate(), describeAttemptHold(), describeDiscardReason(), invalidAttemptBasename(), planFinalization(), snapshot(), ticksFrom(), evaluateRecordingIntegrity() (+12 more)
...
Cohesion: 0.12
Nodes (25): resolveTargetHitbox(), targetHitboxToConfig(), pushTarget(), requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor() (+17 more)
...
Cohesion: 0.11
Nodes (19): widePayload(), bearingDeg(), buildTicks(), payloadFor(), targetAt(), makeMeta(), makePayload(), makeTick() (+11 more)
...
Cohesion: 0.1
Nodes (34): aggregateCurve(), aggregatePhase(), aggregateSync(), computeCurveMetrics(), computePhaseMetrics(), counterHoldMsForPeek(), curveRow(), curveRows() (+26 more)

### Community 36 - "Community 36"
Cohesion: 0.09
Nodes (11): createSceneLoadCoordinator(), defaultLoader(), disposeScene(), loadScene(), createSceneManager(), createSceneManagerWithStatus(), SceneManager, ReplaySceneAdapter (+3 more)
...
Cohesion: 0.11
Nodes (31): ConfusionMatrix, F1Interval, LayerResult, Whether the reference stage 2 rule *can* fire at a given sample spacing, and by, One (theta, window, layer, split) cell of the ablation. Every field the DoD name, A percentile bootstrap interval for F1, with the seed that produced it., StageTwoReachability, One export's columnar raw mouse block, with absolute sample times derived once. (+23 more)
...
Cohesion: 0.1
Nodes (9): buildLargePayload(), ReplayEffectView, clamp(), createReplayPlayer(), createReplayPresentationSession(), resolveWeapon(), ReplayTargetView, resolveReplayTargetHitbox() (+1 more)
...
Cohesion: 0.14
Nodes (26): createHistoricalRunDetail(), makeButton(), FakeDocument, findByTag(), flatten(), readyValue(), setup(), text() (+18 more)

### Community 53 - "Community 53"
Cohesion: 0.15
Nodes (14): canonicalExportJSON(), canonicalizeValue(), buildEarlyReplayFixture(), buildFixture(), buildFixture(), buildIdentitySegment(), buildRunFilename(), buildRunId() (+6 more)
...
Cohesion: 0.14
Nodes (20): drillSourceFor(), researcherControlsDrills(), resolveAvailableDrill(), baseTargets(), buildTrackingCorePrPilotV1Cell(), corePrPilotV1DrillId(), cubeHitbox(), scoredTiming() (+12 more)
...
Cohesion: 0.15
Nodes (15): brInputs(), createCamera(), runBrVariant(), err(), pushWarning(), requireFiniteNumber(), requireNonNegativeNumber(), requireObject() (+7 more)
...
Cohesion: 0.14
Nodes (19): buildConditionEvidence(), buildTrackingPilotEvidence(), readTrajectorySeed(), renderTrackingPilotReportHtml(), anglesToWorld(), buildPayload(), perfectFollowerPayload(), collectFiles() (+11 more)

### Community 62 - "Community 62"
Cohesion: 0.09
Nodes (20): _axis_grid(), _better(), _direction_change_variance(), _duration_grid(), fit_boundary(), fit_gap_only(), GateCheck, hover_analogue() (+12 more)
...
Cohesion: 0.15
Nodes (19): qualityGateStatusForPayload(), buildCompatibilityKey(), buildSensitivityFovKey(), checkCompatibility(), checkQualityGate(), deriveSessionId(), requireBoolean(), requireNonNegativeFiniteNumber() (+11 more)
...
Cohesion: 0.18
Nodes (14): isLexicallyContained(), walk(), acquireLock(), allocateStage10Environment(), cleanupStage10Environment(), defaultRealHistoryRoot(), lockPath(), releaseLock() (+6 more)
...
Cohesion: 0.2
Nodes (11): createHistoryRepository(), HistoryContainmentError, PracticeNotArchivableError, listAllFiles(), listRunJsonFiles(), makeTempRoot(), removeTempRoot(), buildStage10Fixtures() (+3 more)
...
Cohesion: 0.23
Nodes (13): payloadWithEyeZ(), recordTicks(), recordTicks(), checkTrackingStimulusFidelity(), recoverSightline(), expectedPos(), createTrackingTrajectory(), projectTrackingAngles() (+5 more)
...
Cohesion: 0.17
Nodes (17): 確定性左右交替輪替 (counter-strafe peek 節奏), 依時序排序消費 + 排空 (決定性契約), t_visible (可見時間戳 / 反應時間起點), Crosshair (src/ui/Crosshair.ts), D1 UI = 純 TS + DOM overlay, WP-1 場景 (相機 / Pointer Lock), WP-4 Progress Log, WP-4 T0 Entry gate (+9 more)
...
Cohesion: 0.47
Nodes (4): buildEndConditionByDrillId(), buildPayload(), outcomeFor(), tickAt()
...
- **Why does `bool()` connect `Community 12` to `Community 3`, `Community 167`, `Community 40`, `Community 73`, `Community 77`, `Community 21`, `Community 54`, `Community 55`, `Community 24`, `Community 56`, `Community 152`, `Community 94`?**
  _High betweenness centrality (0.293) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 3` to `Community 12`, `Community 140`, `Community 141`, `Community 143`, `Community 142`, `Community 17`, `Community 24`, `Community 153`, `Community 152`, `Community 155`, `Community 31`, `Community 32`, `Community 39`, `Community 55`, `Community 56`, `Community 206`, `Community 207`, `Community 87`, `Community 117`, `Community 123`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 40` to `Community 12`?**
