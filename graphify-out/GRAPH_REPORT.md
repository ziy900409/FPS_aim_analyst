...
## Corpus Check
- 125 files · ~178,713 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 924 nodes · 2029 edges · 67 communities (49 shown, 18 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 144 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0851cf23`
...
5. `collectMeta()` - 17 edges
6. `loadDrill()` - 17 edges
7. `WP-3 輸入採集層 InputSampler (F1)` - 17 edges
8. `simStep()` - 16 edges
9. `createTargetManager()` - 16 edges
...
Cohesion: 0.08
Nodes (44): round(), simulatePurePunchPattern(), toPatternShot(), createSimLoop(), buttonCss(), createNumberInput(), drawGrid(), drawPattern() (+36 more)
...
Cohesion: 0.12
Nodes (22): createDataRecorder(), assertFinitePayload(), buildExportPayload(), downloadCSV(), downloadJSON(), downloadTextFile(), exportBasename(), formatBoolean() (+14 more)
...
Cohesion: 0.18
Nodes (12): loadDrill(), activeSides(), clipAxis(), deriveTargetEnvelopes(), envelopeForSide(), expandByPoint(), expandForMotion(), formatClearanceViolations() (+4 more)
...
Cohesion: 0.15
Nodes (12): canonicalRun(), runFrames(), snap(), syntheticInputs(), pushEvent(), canonicalTrajectory(), freshState(), runFrames() (+4 more)
...
Cohesion: 0.2
Nodes (16): createDrillRunner(), createPointerLock(), activeWeaponConfig(), buildCurrentExportPayload(), buildSimLoop(), exportBasename(), loadDrillById(), loadSceneById() (+8 more)

### Community 18 - "Community 18"
Cohesion: 0.16
Nodes (8): TargetView, createHUD(), createHUDStats(), createHUDSummary(), fillHUDSummary(), formatElapsed(), formatNumber(), renderMetric()
...
Cohesion: 0.21
Nodes (4): setup(), createTargetManager(), killSequence(), runDrill()
...
Cohesion: 0.24
Nodes (4): punchToThreeRad(), createFpsTestHarness(), makeHarness(), fireOnce()
...
- **Why does `createSimLoop()` connect `Community 0` to `Community 32`, `Community 12`, `Community 13`, `Community 14`, `Community 17`, `Community 24`, `Community 28`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `createSharedState()` connect `Community 13` to `Community 0`, `Community 32`, `Community 8`, `Community 12`, `Community 14`, `Community 16`, `Community 18`, `Community 20`, `Community 24`, `Community 28`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `CameraController` connect `Community 31` to `Community 17`?**
