...
## Corpus Check
- 96 files · ~148,631 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 751 nodes · 1602 edges · 43 communities (29 shown, 14 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 115 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a81e220c`
...
5. `simStep()` - 16 edges
6. `generateRecoilTable()` - 16 edges
...
Cohesion: 0.05
Nodes (40): collect64HzSamples(), createDataRecorder(), loadDrill(), createDrillRunner(), setup(), consume(), createInputSampler(), createSimLoop() (+32 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (59): applyInput(), ballisticRaycast(), fireOneShot(), projectMissOntoEngagementPlane(), recordVisibleEvents(), scheduleFire(), simStep(), cameraLookingDownZ() (+51 more)
...
Cohesion: 0.15
Nodes (20): activeSides(), clipAxis(), deriveTargetEnvelopes(), envelopeForSide(), expandByPoint(), expandForMotion(), inflateAabb(), samplePlayerCorridor() (+12 more)
...
- **Why does `createSharedState()` connect `Community 0` to `Community 1`, `Community 19`, `Community 6`?**
...
- **Are the 7 inferred relationships involving `simStep()` (e.g. with `fireAt()` and `meanSpreadRadius()`) actually correct?**
  _`simStep()` has 7 INFERRED edges - model-reasoned connections that need verification._
