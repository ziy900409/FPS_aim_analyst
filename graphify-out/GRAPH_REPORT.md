...
## Corpus Check
- 143 files · ~210,229 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1038 nodes · 2370 edges · 61 communities (48 shown, 13 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 172 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a9c7fb00`
...
Cohesion: 0.05
Nodes (45): createDrillRunner(), createPointerLock(), createRenderLoop(), lerp(), createRenderer(), pickBackend(), resolveBackend(), ImpactView (+37 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (37): nextAnimationFrame(), percentile(), probeWarmupP95Ms(), readDevicePixelRatio(), readFullscreenElement(), readScreenDim(), requireNonNegativeInteger(), requireNonNegativeNumber() (+29 more)
...
Cohesion: 0.09
Nodes (34): createDataRecorder(), assertFinitePayload(), buildExportPayload(), downloadCSV(), downloadJSON(), downloadTextFile(), exportBasename(), formatBoolean() (+26 more)
...
Cohesion: 0.11
Nodes (22): loadDrill(), activeSides(), assertFiniteEnvelope(), clipAxis(), criticalYawDegrees(), deriveTargetEnvelopes(), envelopeForSide(), envelopeForSpawnArea() (+14 more)
...
Cohesion: 0.17
Nodes (12): applyInput(), ballisticRaycast(), fireOneShot(), projectMissOntoEngagementPlane(), scheduleFire(), punchToThreeRad(), currentPeekId(), firstShotGate() (+4 more)

### Community 14 - "Community 14"
Cohesion: 0.17
Nodes (11): setup(), createMovementController(), run(), runBatches(), createTargetManager(), collectImmediateSpawns(), killSequence(), motionConfig() (+3 more)

### Community 15 - "Community 15"
Cohesion: 0.17
Nodes (12): createSimLoop(), canonicalRun(), runFrames(), snap(), syntheticInputs(), pushEvent(), canonicalFire(), runFire() (+4 more)
...
Cohesion: 0.22
Nodes (10): consume(), resetRecoilState(), drainAll(), drainToArray(), snapshot(), createImpactRing(), createInputRing(), pushImpact() (+2 more)
...
Cohesion: 0.23
Nodes (16): aimForward(), angularEccentricityDeg(), clamp(), derivePresentation(), deriveTrackingMetrics(), finite(), isFiniteNumber(), isOnTarget() (+8 more)
...
Cohesion: 0.39
Nodes (13): err(), requireFiniteNumber(), requireNonEmptyString(), requireNonNegativeNumber(), requireNonNegativeRange(), requireObject(), requirePositiveInt(), requirePositiveNumber() (+5 more)
...
- **Why does `createSimLoop()` connect `Community 15` to `Community 0`, `Community 33`, `Community 1`, `Community 34`, `Community 32`, `Community 2`, `Community 9`, `Community 13`, `Community 14`, `Community 22`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `createSharedState()` connect `Community 14` to `Community 0`, `Community 33`, `Community 1`, `Community 3`, `Community 34`, `Community 32`, `Community 2`, `Community 9`, `Community 13`, `Community 15`, `Community 18`, `Community 20`, `Community 22`, `Community 31`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `createDataRecorder()` connect `Community 3` to `Community 0`, `Community 1`, `Community 34`, `Community 32`, `Community 9`, `Community 15`, `Community 22`?**
