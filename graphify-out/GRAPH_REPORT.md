...
## Corpus Check
- 692 files · ~1,388,560 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5359 nodes · 13367 edges · 310 communities (268 shown, 42 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1722 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `23960f64`
...
## Communities (310 total, 42 thin omitted)
...
Cohesion: 0.07
Nodes (77): canonicalExportJSON(), canonicalizeValue(), fail(), isRecord(), parseAdsEvent(), parseAim(), parseAnnotationEvent(), parseArray() (+69 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (35): createDrillRunner(), makeConfig(), reversalConfig(), run(), setup(), setupArmed(), trackingGuardConfig(), runCadenceTimeoutExport() (+27 more)
...
Cohesion: 0.07
Nodes (36): createDataRecorder(), FakeSettingsDocument, wireSettingsToRecorder(), capacityForDrill(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), cameraLookingDownZ() (+28 more)
...
Cohesion: 0.1
Nodes (39): deriveTrackingMetrics(), deriveTrackingSamples(), adaptPayloadForScoredWindow(), deriveTrackingReversalWindows(), pickPresentation(), buildConditionEvidence(), buildRunEvidence(), buildTrackingPilotEvidence() (+31 more)
...
Cohesion: 0.06
Nodes (24): compileSessionProgram(), requireRestSeconds(), resolveBoundary(), SessionProgramCompileError, summarizeProgram(), describeBoundary(), createRestOverlay(), FakeDocument (+16 more)
...
Cohesion: 0.09
Nodes (28): assertFinitePayload(), buildExportPayload(), exportBasename(), formatBoolean(), formatNumber(), formatOptionalNumber(), rowsToCSV(), sanitizeFilename() (+20 more)
...
Cohesion: 0.08
Nodes (22): fixedClock(), v8SpawnTrace(), createSimLoop(), brInputs(), createCamera(), runBrVariant(), collectImpacts(), collectTracers() (+14 more)

### Community 24 - "Community 24"
Cohesion: 0.08
Nodes (11): readyValue(), realRegistry(), createHistoryClient(), HistoryClientError, isErrorBody(), isRecord(), isSuccessBody(), createHistoryLibraryController() (+3 more)
...
Cohesion: 0.09
Nodes (20): aimForward(), angularDistanceDeg(), angularEccentricityDeg(), clamp(), isFiniteNumber(), radToDeg(), resolveEyeOrigin(), deriveSpiderShotMetrics() (+12 more)
...
Cohesion: 0.14
Nodes (36): _has_flags(), build_peek_windows(), _events_in_window(), _false(), _finite_number(), _first_compatible_fire(), _hit_times_by_shot(), _key() (+28 more)
...
Cohesion: 0.09
Nodes (7): ReplayEffectView, clamp(), createReplayPlayer(), createReplayPresentationSession(), resolveWeapon(), ReplayTargetView, resolveReplayTargetHitbox()
...
Cohesion: 0.13
Nodes (15): resolveFamilyDrillId(), resolveWarmupDrillId(), findSessionPlanPreset(), buildFrozenSessionPlan(), createSessionRunner(), requireFamilyOrder(), resolveFamilyDrillId(), resolveWarmupDrillId() (+7 more)
...
Cohesion: 0.15
Nodes (21): makeMeta(), normalizeReplayRecording(), toSceneDescriptor(), fixtureRecording(), buildLargePayload(), buildSmallPayload(), timeFor(), buildLargePayload() (+13 more)
...
Cohesion: 0.12
Nodes (22): detect_parity_payload(), _detect_presentation(), detect_samples(), DetectParams, _epsilon_with_fixed_target(), _eye_origin_to_json(), _first_sustained_decrease(), _first_tick_index_at_or_after() (+14 more)
...
Cohesion: 0.17
Nodes (20): ADR-5 Pointer Lock + 原始輸入 + coalesced, D1 UI = 純 TS + DOM overlay, WP-6 — drill config (房間/距離正式值), WP-7 — DataRecorder ring buffer / metadata, CameraController (yaw/pitch + pitch clamp + sensitivity/FOV), NotSupportedError fallback (僅 Chromium 降級路徑), pitch 夾角 (clamp ±~89° 避免翻轉), PointerLockHandle (request/locked/onChange/onMove) (+12 more)
...
Cohesion: 0.16
Nodes (12): CORRECTION_SHOTS(), correctionCase(), deg2rad(), nextTickTimeAfter(), observeReplacementSeparation(), quantiles(), scenario(), separationFromEyeDeg() (+4 more)
...
Cohesion: 0.2
Nodes (15): deriveProgramFamilyOrder(), actualWeaponIdFor(), curatedConfigFor(), metaForRun(), payloadFor(), pilotMetaForRun(), pilotSceneIdFor(), weaponMetaForRun() (+7 more)
...
Cohesion: 0.22
Nodes (11): ramp(), aimYaw(), annotationRate(), baseMeta(), buildCohort(), buildPayload(), degPerSecToRadPerTick(), liftFraction() (+3 more)
...
Cohesion: 0.28
Nodes (8): resolveSpiderShotWideV1(), reparse(), requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor(), wideConfig()
...
Cohesion: 0.2
Nodes (14): ADR-4 performance.now() 計時源, 視角走輸入/render 路徑不入 sim (雙迴圈邊界), clock.ts 注入式時間 (now(): performance.now(), OQ-2.3), prev/curr 雙快照 (內插用), RenderLoop alpha 內插 (lerp prev/curr, 唯讀), SharedState (三迴圈唯一溝通管道, 單例), spiral of death 夾住 (Math.min(delta,0.25)), WP-2 T1 — SharedState (型別 + 單例) (+6 more)
...
- **Why does `bool()` connect `Community 32` to `Community 26`, `Community 163`, `Community 71`, `Community 8`, `Community 79`, `Community 51`, `Community 52`, `Community 53`, `Community 154`, `Community 60`, `Community 29`, `Community 63`?**
  _High betweenness centrality (0.289) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 32` to `Community 129`, `Community 8`, `Community 15`, `Community 21`, `Community 152`, `Community 153`, `Community 155`, `Community 156`, `Community 162`, `Community 163`, `Community 51`, `Community 53`, `Community 56`, `Community 185`, `Community 59`, `Community 60`, `Community 204`, `Community 205`, `Community 85`, `Community 110`, `Community 118`, `Community 120`, `Community 127`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 29` to `Community 32`?**
