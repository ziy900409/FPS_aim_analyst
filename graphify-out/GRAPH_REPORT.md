...
## Corpus Check
- 226 files · ~324,308 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1601 nodes · 3684 edges · 104 communities (77 shown, 27 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 411 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `74c4450f`
...
6. `load_export()` - 27 edges
7. `build_peek_windows()` - 27 edges
...
- `runWeapon()` --calls--> `createDataRecorder()`  [INFERRED]
  tests/regression/projectile-determinism.test.ts → src/data/DataRecorder.ts
...
Cohesion: 0.05
Nodes (70): assertFinitePayload(), buildExportPayload(), downloadCSV(), downloadJSON(), downloadTextFile(), exportBasename(), formatBoolean(), formatNumber() (+62 more)
...
Cohesion: 0.07
Nodes (45): _compute_failed_flag(), is_known_quality_flag(), per_segment_apply(), Per-segment computation with a closed, machine-readable quality vocabulary.  E, Summarize finite, unflagged values while counting excluded flagged rows., Summarize finite, unflagged values while counting excluded flagged rows., Return whether *flag* is an exact or templated vocabulary member., Return whether *flag* is an exact or templated vocabulary member. (+37 more)
...
Cohesion: 0.1
Nodes (29): createPointerLock(), activeWeaponConfig(), beginNextProtocolCondition(), buildCurrentExportPayload(), buildSimLoop(), completeActiveProtocolCondition(), exportBasename(), findSceneOption() (+21 more)
...
Cohesion: 0.12
Nodes (20): createDataRecorder(), capacityForDrill(), createDrillRunner(), canonicalRun(), runFrames(), snap(), syntheticInputs(), canonicalLongrangeFrames() (+12 more)
...
Cohesion: 0.13
Nodes (14): collect64HzSamples(), recordVisibleEvents(), simStep(), cameraLookingDownZ(), fireAt(), makeTarget(), meanSpreadRadius(), run() (+6 more)
...
Cohesion: 0.12
Nodes (18): _Candidate, _merge_overlapping(), _prepare_signal(), Submovement segmentation for 128 Hz angular-speed traces., Segment an angular-speed trace into one primary flick and later adjustments., Segment an angular-speed trace into one primary flick and later adjustments., Segment an angular-speed trace into one primary flick and later adjustments., One inclusive submovement interval. (+10 more)
...
Cohesion: 0.19
Nodes (16): _keys_for_tick(), make_synthetic_export(), _profile(), Deterministic schema v2 synthetic export generation.  No clock or random sourc, Create a schema-faithful deterministic v2 payload without writing it to disk., SyntheticSpec, main(), Regenerate the committed T1 schema v2 fixture. (+8 more)
...
Cohesion: 0.25
Nodes (14): createRecoilState(), resetRecoilState(), createMovementController(), run(), runBatches(), createBulletArena(), createImpactRing(), createInputRing() (+6 more)

### Community 26 - "Community 26"
Cohesion: 0.16
Nodes (8): setup(), createRan1(), createTargetManager(), collectImmediateSpawns(), killSequence(), motionConfig(), runDrill(), runPositions()
...
Cohesion: 0.24
Nodes (16): _aim_forward(), _column(), epsilon_deg(), _finite_column(), _finite_scalar(), _geometry(), _hitbox(), omega_deg_s() (+8 more)
...
Cohesion: 0.36
Nodes (4): consume(), drainAll(), drainToArray(), snapshot()
...
Cohesion: 0.46
Nodes (7): test_epsilon_is_zero_at_target_center(), test_epsilon_recovers_known_unsigned_offset(), test_missing_tick_target_uses_visible_event_fallback(), test_omega_known_geometry(), test_omega_uses_adjacent_midpoint_pitch(), test_on_target_resolves_meta_hitbox_before_h1_fallback(), _ticks()
...
Cohesion: 0.43
Nodes (4): _finite_non_negative(), _finite_positive(), _ratio(), ValueError
...
Cohesion: 0.5
Nodes (4): Pre-registered segmentation parameters; changes require a new version., Pre-registered segmentation parameters; changes require a new version., SegmentParams, test_segment_params_reject_invalid_contracts()

## Knowledge Gaps
- **164 isolated node(s):** `Offline research modules.`, `Schema v2 ingestion and fixture generation.`, `Fixed-tick interval quality reporting.`, `Uniformity report; each gap index identifies the right-hand tick row.`, `Compare adjacent tick times with ``1000 / sim_hz`` using a 1e-6 ms tolerance.` (+159 more)
...
- **Why does `load_export()` connect `Community 29` to `Community 34`, `Community 37`, `Community 5`, `Community 6`, `Community 45`, `Community 52`, `Community 21`, `Community 23`, `Community 27`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 16` to `Community 34`, `Community 5`, `Community 6`, `Community 45`, `Community 21`, `Community 61`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `createSharedState()` connect `Community 25` to `Community 0`, `Community 10`, `Community 13`, `Community 14`, `Community 48`, `Community 17`, `Community 50`, `Community 49`, `Community 54`, `Community 56`, `Community 57`, `Community 26`, `Community 59`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
