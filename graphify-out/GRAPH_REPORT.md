...
## Corpus Check
- 349 files · ~589,880 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2875 nodes · 6625 edges · 176 communities (150 shown, 26 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 971 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4bbafa3b`
...
Cohesion: 0.06
Nodes (41): isExportPayload(), loadAssessmentSessionSummaries(), parseExportPayload(), buildCompatibilityKey(), buildSensitivityFovKey(), checkCompatibility(), checkQualityGate(), deriveSessionId() (+33 more)
...
Cohesion: 0.08
Nodes (43): targetHitboxToConfig(), createPointerLock(), createSceneManager(), createSceneManagerWithStatus(), isOutsideCorridor(), activeWeaponConfig(), average(), beginNextProtocolCondition() (+35 more)
...
Cohesion: 0.13
Nodes (19): defaultLoader(), disposeScene(), loadScene(), SceneManager, resolveEyeWorldBase(), err(), requireColorNumber(), requireFiniteNumber() (+11 more)
...
Cohesion: 0.15
Nodes (36): collectMeta(), measureDisplayHz(), measureDisplayRefresh(), nextAnimationFrame(), normalizeOverflow(), normalizeStartedAt(), requireAssessmentMeta(), requireBackend() (+28 more)
...
Cohesion: 0.13
Nodes (30): deriveDetectionMetrics(), aggregateCurve(), aggregatePhase(), aggregateSync(), computeCurveMetrics(), computePhaseMetrics(), computePromotedMetrics(), counterHoldMsForPeek() (+22 more)
...
Cohesion: 0.11
Nodes (19): createDrillRunner(), makeConfig(), reversalConfig(), run(), setup(), applyAimFixture(), canonicalMovingTargetFrames(), createCamera() (+11 more)
...
Cohesion: 0.11
Nodes (12): deriveBrakingSamples(), deriveCounterstrafeMetrics(), sidedStat(), payload(), tick(), buildPeekWindows(), firstTickIndexAtOrAfter(), hitTimesByShotSeq() (+4 more)
...
Cohesion: 0.14
Nodes (16): canonicalRun(), runFrames(), snap(), syntheticInputs(), createMovementController(), run(), runBatches(), createTargetManager() (+8 more)
...
Cohesion: 0.16
Nodes (5): buildCounterstrafeReversalPilotConfigs(), buildHoldClickPilotConfigs(), buildHoldTrackPilotConfigs(), buildSpiderShotPilotConfigs(), allConfigs()
...
Cohesion: 0.16
Nodes (8): ImpactView, createBulletArena(), createImpactRing(), createShotRayRing(), resetBulletArena(), resetImpactRing(), resetShotRayRing(), resetState()
...
Cohesion: 0.33
Nodes (6): deriveHoldClickMetrics(), aimAtPoint(), aimAtTick(), makePayload(), targetAtTick(), tickTime()
...
- **Why does `counter()` connect `Community 5` to `Community 2`, `Community 28`?**
  _High betweenness centrality (0.334) - this node is a cross-community bridge._
- **Why does `_fixture_report()` connect `Community 2` to `Community 16`, `Community 0`, `Community 5`?**
  _High betweenness centrality (0.208) - this node is a cross-community bridge._
- **Why does `load_export()` connect `Community 16` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 9`, `Community 13`, `Community 21`, `Community 26`, `Community 33`, `Community 35`, `Community 36`, `Community 50`, `Community 66`, `Community 67`, `Community 68`, `Community 69`, `Community 76`, `Community 83`, `Community 86`, `Community 87`, `Community 90`, `Community 94`, `Community 95`, `Community 100`, `Community 112`, `Community 113`?**
