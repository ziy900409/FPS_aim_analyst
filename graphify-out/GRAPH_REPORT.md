...
## Corpus Check
- 715 files · ~1,449,769 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5495 nodes · 13780 edges · 298 communities (260 shown, 38 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1770 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `71925b2a`
...
## Communities (298 total, 38 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (57): createDataRecorder(), capacityForDrill(), loadDrill(), createDrillRunner(), setupArmed(), aimAt(), fireFrom(), runCadenceTimeoutExport() (+49 more)
...
Cohesion: 0.05
Nodes (68): createRenderLoop(), lerp(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), attemptPlanForExport(), average(), beginNextProtocolCondition() (+60 more)
...
Cohesion: 0.07
Nodes (51): round(), simulatePurePunchPattern(), toPatternShot(), fixedClock(), v8SpawnTrace(), fixedClock(), v9SpawnTrace(), punchToThreeRad() (+43 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (35): spawnBullet(), stepBullet(), clipAxis(), sweptHitTest(), collect64HzSamples(), applyInput(), ballisticRaycast(), composeProjectileRay() (+27 more)

### Community 6 - "Community 6"
Cohesion: 0.08
Nodes (47): configWith(), angularFieldDiameterDeg(), err(), requireAngularSeparation(), requireAscendingPositiveRange(), requireAscendingRange(), requireAssessmentMode(), requireBoolean() (+39 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (31): consume(), createInputSampler(), advanceProjectiles(), deactivateProjectile(), targetAabb(), resetRecoilState(), ImpactView, drainAll() (+23 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (23): armAndTakeRealLock(), PROBE(), enterResearcherDrillControls(), hudTimeValue(), loadMicroFlick(), loadMicroFlickVariantAndArm(), parseHudTimeMs(), readHudTimeMs() (+15 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (24): FakeSettingsDocument, wireSettingsToRecorder(), buildExportPayload(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), makeVaryingHitboxPayload(), payloadWithStopTransitions() (+16 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (46): aimForward(), angularEccentricityDeg(), clamp(), derivePresentation(), derivePresentationSamples(), deriveTrackingMetrics(), deriveTrackingSamples(), finite() (+38 more)
...
Cohesion: 0.09
Nodes (26): createSimLoop(), advanceUntilTracer(), createCamera(), createTarget(), fireOne(), runAtFrames(), collectImpacts(), collectTracers() (+18 more)
...
Cohesion: 0.09
Nodes (29): renderTrackingPilotReportHtml(), collectFiles(), load(), main(), stimulusCheck(), formatTrackingDeliveredAngles(), computeTrackingFrozenCrosshairRatio(), formatTrackingFrozenCrosshairRatio() (+21 more)
...
Cohesion: 0.1
Nodes (19): createAttemptFinalizationGate(), describeAttemptHold(), describeDiscardReason(), invalidAttemptBasename(), planFinalization(), snapshot(), ticksFrom(), evaluateRecordingIntegrity() (+11 more)
...
Cohesion: 0.11
Nodes (25): makeMeta(), normalizeReplayRecording(), toSceneDescriptor(), fixtureRecording(), fixtureRecording(), buildLargePayload(), buildSmallPayload(), timeFor() (+17 more)
...
Cohesion: 0.12
Nodes (22): resolveTargetHitbox(), targetHitboxToConfig(), pushTarget(), requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor() (+14 more)
...
Cohesion: 0.1
Nodes (16): createHistoryLibraryController(), historyRunSummaryFromPayload(), createHistoryScreen(), makeButton(), createParticipantBrowser(), makeButton(), createHistoryNavigator(), defaultWindow() (+8 more)
...
Cohesion: 0.1
Nodes (6): createPresentationCoordinator(), ReplayEffectView, createReplayPresentationSession(), resolveWeapon(), ReplayTargetView, resolveReplayTargetHitbox()
...
Cohesion: 0.13
Nodes (26): key_state_signed(), key_velocity_xcorr(), Signed strafe key state per tick: ``D`` -> ``+1``, ``A`` -> ``-1``, both or neit, Signed Pearson r at every lag in ``[-max_lag_ticks, +max_lag_ticks]``, plus the, _key_events(), T2 DoD 3, proven from the source rather than by sampling inputs.      Two fact, Alternating A/D holds at a fixed period: a strafe pattern with real autocorrelat, _square_key() (+18 more)
...
Cohesion: 0.11
Nodes (26): _aligned(), _bootstrap_ci(), _checked_flags(), _correlogram(), _gate_verdict(), GateVerdict, _half_agreement(), _median_dt_ms() (+18 more)

### Community 66 - "Community 66"
Cohesion: 0.11
Nodes (18): serializeJSON(), degToRad(), makeRoundTripPayload(), tickTime(), yawDegAt(), aimAtPoint(), aimAtTick(), makePayload() (+10 more)
...
Cohesion: 0.1
Nodes (10): createHistoryClient(), HistoryClientError, isErrorBody(), isRecord(), isSuccessBody(), createReplayController(), downgradeForScene(), resolveSessionScene() (+2 more)
...
Cohesion: 0.1
Nodes (10): createControls(), makeButton(), makeSelect(), makeToggle(), FakeDocument, FakeElement, createDrillStartOverlay(), FakeDocument (+2 more)
...
Cohesion: 0.12
Nodes (22): load_export(), Read and validate one schema v2 JSON export., Read and validate one schema v2 JSON export., Read and validate one schema v2 JSON export., Read and validate one schema v2 JSON export., D-29.2 boundary: the KI-004 defect only touches px/pz, which this WP never reads, WP-30 supersedes D-29.2: trajectory metrics consume px/pz only via strict eye ge, WP-30 supersedes D-29.2: trajectory metrics consume px/pz only via strict eye ge (+14 more)

### Community 83 - "Community 83"
Cohesion: 0.16
Nodes (18): collectFiles(), load(), loadManifest(), main(), isInstructionClass(), baseName(), parseEntry(), readLiftManifest() (+10 more)
...
Cohesion: 0.21
Nodes (11): deriveUnlockedIntervals(), overlapsAny(), segmentByTimeGap(), assessAnnotationChannel(), extractAnnotationIntervals(), segmentationAt(), deriveSamplingHealth(), countDetected() (+3 more)
...
Cohesion: 0.14
Nodes (10): buildConditionEvidence(), buildTrackingPilotEvidence(), anglesToWorld(), buildPayload(), neverAcquirePayload(), perfectFollowerPayload(), anglesToWorld(), buildPayload() (+2 more)
...
Cohesion: 0.21
Nodes (6): pausedPayload(), makeAssessmentPayload(), buildStage10Fixtures(), computeRunId(), syntheticParticipantId(), withSensitivityFov()
...
Cohesion: 0.28
Nodes (5): ReplaySceneAdapter, resolveEyeWorldBase(), nearlyEqual(), requireRoomEnvelope(), requireSpiderShotDeliveryGeometry()
...
- **Why does `bool()` connect `Community 75` to `Community 65`, `Community 99`, `Community 3`, `Community 37`, `Community 35`, `Community 70`, `Community 74`, `Community 13`, `Community 206`, `Community 17`, `Community 83`, `Community 154`?**
  _High betweenness centrality (0.293) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 3` to `Community 13`, `Community 142`, `Community 15`, `Community 143`, `Community 145`, `Community 146`, `Community 144`, `Community 152`, `Community 153`, `Community 154`, `Community 30`, `Community 31`, `Community 35`, `Community 38`, `Community 196`, `Community 70`, `Community 71`, `Community 75`, `Community 98`, `Community 125`?**
