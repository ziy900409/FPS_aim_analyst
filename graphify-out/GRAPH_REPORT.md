...
## Corpus Check
- 687 files · ~1,364,122 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5268 nodes · 13118 edges · 301 communities (257 shown, 44 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1699 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2c273cc7`
...
## Communities (301 total, 44 thin omitted)
...
Cohesion: 0.06
Nodes (37): createDataRecorder(), buildExportPayload(), capacityForDrill(), targetHitboxToConfig(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), cameraLookingDownZ() (+29 more)
...
Cohesion: 0.07
Nodes (54): createPointerLock(), createRenderLoop(), lerp(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), average(), beginNextProtocolCondition() (+46 more)
...
Cohesion: 0.07
Nodes (46): createRan1(), randomFloat(), angularSeparationDeg(), centerRelativeDirection(), minimumActiveSeparationDeg(), centerRelativeAngularSeparationDeg(), copyPos(), fixedClock() (+38 more)
...
Cohesion: 0.08
Nodes (28): canonicalExportJSON(), canonicalizeValue(), buildEarlyReplayFixture(), buildFixture(), fixtureStartedAt(), buildFixture(), buildFixture(), buildIdentitySegment() (+20 more)
...
Cohesion: 0.11
Nodes (27): deriveUnlockedIntervals(), overlapsAny(), segmentByTimeGap(), annotationCountToleranceFor(), assessAnnotationChannel(), auditRun(), boolText(), countPeripheralTrials() (+19 more)
...
Cohesion: 0.13
Nodes (25): qualityGateStatusForPayload(), buildCompatibilityKey(), buildSensitivityFovKey(), checkCompatibility(), checkQualityGate(), deriveSessionId(), requireBoolean(), requireNonNegativeFiniteNumber() (+17 more)
...
Cohesion: 0.15
Nodes (23): serializeJSON(), degToRad(), makeRoundTripPayload(), tickTime(), yawDegAt(), aimAtCenter(), aimAtOffTarget(), aimAtPoint() (+15 more)
...
Cohesion: 0.11
Nodes (24): _aligned(), _bootstrap_ci(), _checked_flags(), _gate_verdict(), GateVerdict, _half_agreement(), _median_dt_ms(), Key-velocity coupling cross-correlation + `gate-v1` reliability verdict (WP-31 / (+16 more)
...
- **Why does `bool()` connect `Community 60` to `Community 64`, `Community 162`, `Community 3`, `Community 42`, `Community 12`, `Community 155`, `Community 78`, `Community 55`, `Community 56`, `Community 57`, `Community 27`, `Community 31`?**
  _High betweenness centrality (0.279) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 3` to `Community 12`, `Community 141`, `Community 142`, `Community 143`, `Community 144`, `Community 17`, `Community 145`, `Community 26`, `Community 154`, `Community 155`, `Community 49`, `Community 52`, `Community 56`, `Community 57`, `Community 60`, `Community 63`, `Community 199`, `Community 200`, `Community 86`, `Community 117`, `Community 120`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 42` to `Community 60`?**
