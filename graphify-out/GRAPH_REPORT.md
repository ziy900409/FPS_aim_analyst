...
## Corpus Check
- 654 files · ~1,238,528 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4856 nodes · 11993 edges · 286 communities (242 shown, 44 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 1481 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5f258f03`
...
## Communities (286 total, 44 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (64): createDataRecorder(), capacityForDrill(), createDrillRunner(), runCadenceTimeoutExport(), runCadenceTimeoutExport(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain() (+56 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (83): round(), simulatePurePunchPattern(), toPatternShot(), buttonCss(), createNumberInput(), drawGrid(), drawPattern(), maxSpreadRadiusDeg() (+75 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (43): resolveTargetHitbox(), targetHitboxToConfig(), loadDrill(), aimAt(), fireFrom(), pushTarget(), measureAtEye(), enumerateLandings() (+35 more)
...
Cohesion: 0.06
Nodes (44): setup(), runTimeoutOnly(), runTimeoutOnly(), drainSpawns(), timeoutHarness(), drainSpawns(), recordSpiderSpawns(), recordSpiderSpawnsWithResetRerun() (+36 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (49): assessmentProtocolVersionForDrill(), createPointerLock(), createRenderLoop(), lerp(), createSceneManagerWithStatus(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides() (+41 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (38): assertFinitePayload(), buildExportPayload(), downloadCSV(), downloadJSON(), downloadTextFile(), exportBasename(), formatBoolean(), formatNumber() (+30 more)
...
Cohesion: 0.08
Nodes (56): _aim_forward(), epsilon_deg(), EyeOrigin, _finite_scalar(), _finite_vec3(), _hitbox(), _meta_eye_origin(), omega_deg_s() (+48 more)
...
Cohesion: 0.1
Nodes (14): angularSizeToHitboxWidthU(), buildPeekClickTransferPilotConfig(), pilotDrillId(), buildPeekClickTransferPilotV2Config(), buildPeekClickTransferPilotV2MaskedConfig(), buildPeekClickTransferPilotV2RandomizedConfig(), peekClickTransferPilotV2CandidateLabel(), pilotV2DrillId() (+6 more)
...
Cohesion: 0.08
Nodes (36): requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor(), deriveProjectedFootprint(), footprintSpread(), nonNegativeFinite() (+28 more)
...
Cohesion: 0.14
Nodes (42): collectMeta(), measureDisplayHz(), measureDisplayRefresh(), nextAnimationFrame(), normalizeOverflow(), normalizeStartedAt(), requireAssessmentMeta(), requireBackend() (+34 more)
...
Cohesion: 0.11
Nodes (22): buildCounterstrafeReversalPilotConfigs(), buildHoldClickPilotConfigs(), buildHoldTrackPilotConfigs(), buildPeekClickTransferPilotConfigs(), buildPeekClickTransferPilotV2Configs(), buildSpiderShotPilotConfigs(), allConfigs(), resolveFamilyDrillId() (+14 more)

### Community 23 - "Community 23"
Cohesion: 0.09
Nodes (21): consume(), createInputSampler(), drainAll(), drainToArray(), snapshot(), createBulletArena(), createImpactRing(), createInputRing() (+13 more)
...
Cohesion: 0.1
Nodes (28): buildConditionEvidence(), buildTrackingPilotEvidence(), renderTrackingPilotReportHtml(), anglesToWorld(), buildPayload(), perfectFollowerPayload(), collectFiles(), load() (+20 more)
...
Cohesion: 0.08
Nodes (20): compileSessionProgram(), deriveProgramFamilyOrder(), requireRestSeconds(), requireWeapon(), resolveBoundary(), SessionProgramCompileError, summarizeProgram(), actualWeaponIdFor() (+12 more)
...
Cohesion: 0.14
Nodes (20): sceneWithRoom(), clipAxis(), firstBlockingIntersection(), isSegmentBlocked(), segmentAabbEntryAlpha(), visibleFractionForTarget(), err(), requireColorNumber() (+12 more)

### Community 42 - "Community 42"
Cohesion: 0.1
Nodes (7): createSceneLoadCoordinator(), defaultLoader(), disposeScene(), loadScene(), createSceneManager(), SceneManager, ReplaySceneAdapter
...
Cohesion: 0.14
Nodes (12): makeMeta(), makePayload(), normalizeReplayRecording(), toSceneDescriptor(), fixtureRecording(), fixtureRecording(), buildLargePayload(), fixtureRecording() (+4 more)
...
Cohesion: 0.11
Nodes (13): resolveSpiderShotWideV1(), enterResearcherDrillControls(), expectYawWindowMatchesResolver(), feed(), loadWideFlick(), runWideFlick(), tapSequence(), wideConfig() (+5 more)
...
Cohesion: 0.12
Nodes (16): widePayload(), bearingDeg(), buildTicks(), payloadFor(), targetAt(), buildTicks(), payloadFor(), scoredTickMs() (+8 more)
...
Cohesion: 0.16
Nodes (16): baseTargets(), buildTrackingCorePrPilotV1Cell(), corePrPilotV1DrillId(), cubeHitbox(), scoredTiming(), sphereHitbox(), trackingPilotAngularSizeToDiameterU(), trackingPilotAngularSizeToEdgeU() (+8 more)
...
Cohesion: 0.16
Nodes (19): _compute_failed_flag(), is_known_quality_flag(), per_segment_apply(), Per-segment computation with a closed, machine-readable quality vocabulary.  E, Summarize finite, unflagged values while counting excluded flagged rows., Summarize finite, unflagged values while counting excluded flagged rows., Return whether *flag* is an exact or templated vocabulary member., Return whether *flag* is an exact or templated vocabulary member. (+11 more)
...
Cohesion: 0.17
Nodes (6): aimAtCenterTarget(), canonicalWideFrames(), createCamera(), runWide(), wideDrillConfig(), runMicro()
...
Cohesion: 0.16
Nodes (5): ReplayEffectView, createReplayPresentationSession(), resolveWeapon(), buildReplayPunchTimeline(), resolveReplayCameraVisualState()
...
- **Why does `bool()` connect `Community 73` to `Community 98`, `Community 26`, `Community 58`, `Community 8`, `Community 10`, `Community 74`, `Community 76`, `Community 139`, `Community 11`, `Community 47`, `Community 53`, `Community 90`?**
  _High betweenness centrality (0.254) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 90` to `Community 129`, `Community 130`, `Community 131`, `Community 132`, `Community 8`, `Community 138`, `Community 139`, `Community 11`, `Community 15`, `Community 27`, `Community 163`, `Community 47`, `Community 183`, `Community 184`, `Community 55`, `Community 58`, `Community 72`, `Community 73`, `Community 81`, `Community 99`, `Community 104`, `Community 108`, `Community 109`, `Community 110`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `counter()` connect `Community 11` to `Community 17`, `Community 15`?**
