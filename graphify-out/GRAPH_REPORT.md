...
## Corpus Check
- 658 files · ~1,248,279 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4869 nodes · 12052 edges · 291 communities (252 shown, 39 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 1485 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ef6ad2d7`
...
Cohesion: 0.05
Nodes (57): targetHitboxToConfig(), requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor(), enterResearcherDrillControls(), expectYawWindowMatchesResolver() (+49 more)
...
Cohesion: 0.06
Nodes (58): resolveTargetHitbox(), pushTarget(), createPointerLock(), createRenderLoop(), lerp(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides() (+50 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (64): _ad_key_events(), build_peek_windows(), _events_in_window(), _false(), _finite_number(), _first_compatible_fire(), _hit_times_by_shot(), _key() (+56 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (37): createDrillRunner(), makeConfig(), reversalConfig(), run(), setup(), trackingGuardConfig(), runCadenceTimeoutExport(), runTimeoutOnly() (+29 more)
...
Cohesion: 0.07
Nodes (28): createDataRecorder(), buildExportPayload(), capacityForDrill(), aimAtPoint(), aimAtTick(), makePayload(), makeVaryingHitboxPayload(), targetAtTick() (+20 more)
...
Cohesion: 0.09
Nodes (28): loadDrill(), angularSizeToHitboxWidthU(), buildPeekClickTransferPilotConfig(), aimAt(), fireFrom(), buildPeekClickTransferPilotV2Config(), activeSides(), assertFiniteEnvelope() (+20 more)
...
Cohesion: 0.05
Nodes (28): createControls(), makeButton(), makeSelect(), makeToggle(), FakeDocument, FakeElement, createHistoryView(), formatNumber() (+20 more)
...
Cohesion: 0.1
Nodes (43): createResultDetailBody(), appendCurveBand(), appendCurveLine(), appendGuideLine(), appendPath(), classifyResidualSpeed(), countFlags(), createDiagnosisSummary() (+35 more)

### Community 23 - "Community 23"
Cohesion: 0.11
Nodes (18): widePayload(), payloadWithEyeZ(), recordTicks(), recordTicks(), makeMeta(), makePayload(), makeTick(), normalizeReplayRecording() (+10 more)
...
Cohesion: 0.12
Nodes (35): load_export(), Read and validate one schema v2 JSON export., Read and validate one schema v2 JSON export., Read and validate one schema v2 JSON export., Read and validate one schema v2 JSON export., _keys_for_tick(), make_synthetic_export(), _profile() (+27 more)
...
Cohesion: 0.1
Nodes (14): reparse(), createDrillMetricRegistry(), realRegistry(), createHistoryClient(), HistoryClientError, isErrorBody(), isRecord(), isSuccessBody() (+6 more)
...
Cohesion: 0.11
Nodes (21): createHistoryAnalysisService(), createSemaphore(), closeHistoryApiState(), contentLengthExceeds(), createHistoryApiMiddleware(), createHistoryApiState(), dispatch(), err() (+13 more)
...
Cohesion: 0.12
Nodes (16): aimForward(), angularDistanceDeg(), angularEccentricityDeg(), clamp(), eyeOriginForTick(), radToDeg(), buildHitboxAtTick(), firstTickAtOrAfter() (+8 more)
...
Cohesion: 0.15
Nodes (17): deriveDetectionMetrics(), deriveUnlockedIntervals(), overlapsAny(), segmentByTimeGap(), deriveRepositioningSuspicion(), longer(), longestStall(), nonNegativeFinite() (+9 more)
...
Cohesion: 0.17
Nodes (21): FakeDocument, findByTag(), flatten(), readyValue(), text(), computePromotedMetrics(), average(), buildResultPresentation() (+13 more)

### Community 57 - "Community 57"
Cohesion: 0.13
Nodes (12): resolveSpiderShotWideV1(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), wideConfig(), aimAtCenterTarget(), canonicalWideFrames(), createCamera() (+4 more)
...
Cohesion: 0.13
Nodes (16): buildConditionEvidence(), buildTrackingPilotEvidence(), anglesToWorld(), buildPayload(), neverAcquirePayload(), perfectFollowerPayload(), computeTrackingFrozenCrosshairRatio(), frozenEpsilonDeg() (+8 more)

### Community 64 - "Community 64"
Cohesion: 0.14
Nodes (17): isFiniteNumber(), resolveEyeOrigin(), deriveVisibilityTimeline(), firstCrossingTimes(), hitboxFromMeta(), isBlocked(), positiveFinite(), resolveOptions() (+9 more)
...
Cohesion: 0.19
Nodes (10): createHistoryRepository(), HistoryContainmentError, HistoryRepositoryError, HistoryRootLockedError, MissingParticipantError, PracticeNotArchivableError, listAllFiles(), listRunJsonFiles() (+2 more)
...
Cohesion: 0.15
Nodes (11): createReplayScreen(), makeButton(), FakeWindow, findAll(), findByAction(), flatten(), makeReadyControls(), makeRecording() (+3 more)

### Community 91 - "Community 91"
Cohesion: 0.2
Nodes (14): renderAt(), clamp(), createReplayPlayer(), createReplayPresentationSession(), resolveWeapon(), clamp(), createReplaySampleBuffer(), eventCursorAt() (+6 more)
...
Cohesion: 0.35
Nodes (6): drillSourceFor(), researcherControlsDrills(), resolveAvailableDrill(), requireWeapon(), buildCuratedRegistry(), isWeaponId()
...
- **Why does `bool()` connect `Community 3` to `Community 35`, `Community 70`, `Community 10`, `Community 12`, `Community 141`, `Community 13`, `Community 47`, `Community 46`, `Community 51`, `Community 53`, `Community 29`?**
  _High betweenness centrality (0.255) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 3` to `Community 131`, `Community 132`, `Community 133`, `Community 134`, `Community 135`, `Community 10`, `Community 140`, `Community 141`, `Community 13`, `Community 16`, `Community 26`, `Community 31`, `Community 35`, `Community 46`, `Community 50`, `Community 186`, `Community 187`, `Community 81`, `Community 104`, `Community 105`, `Community 109`?**
  _High betweenness centrality (0.139) - this node is a cross-community bridge._
- **Why does `counter()` connect `Community 13` to `Community 16`, `Community 25`?**
