...
## Corpus Check
- 301 files · ~532,960 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2660 nodes · 6019 edges · 171 communities (139 shown, 32 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 922 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `83e8860e`
...
Cohesion: 0.09
Nodes (26): createDrillRunner(), setup(), canonicalLongrangeFrames(), createCamera(), runLongrangeTracking(), applyAimFixture(), canonicalMovingTargetFrames(), createCamera() (+18 more)
...
Cohesion: 0.09
Nodes (15): consume(), createInputSampler(), canonicalRun(), runFrames(), snap(), syntheticInputs(), drainAll(), drainToArray() (+7 more)
...
Cohesion: 0.12
Nodes (33): load_export(), Read and validate one schema v2 JSON export., Read and validate one schema v2 JSON export., Read and validate one schema v2 JSON export., _keys_for_tick(), make_synthetic_export(), _profile(), Deterministic schema v2 synthetic export generation.  No clock or random sourc (+25 more)
...
Cohesion: 0.15
Nodes (24): createPointerLock(), activeWeaponConfig(), beginNextProtocolCondition(), buildCurrentExportPayload(), buildSimLoop(), completeActiveProtocolCondition(), currentMouseGain(), exportBasename() (+16 more)
...
Cohesion: 0.12
Nodes (24): _ad_key_events(), _aligned(), _bootstrap_ci(), _checked_flags(), _gate_verdict(), GateVerdict, _half_agreement(), key_event_crosscheck() (+16 more)
...
Cohesion: 0.18
Nodes (14): resetRecoilState(), createMovementController(), run(), runBatches(), createBulletArena(), createImpactRing(), createInputRing(), createShotRayRing() (+6 more)
...
Cohesion: 0.17
Nodes (19): _aim_forward(), epsilon_deg(), _finite_scalar(), _finite_vec3(), _hitbox(), _meta_eye_origin(), on_target(), _positive_scalar() (+11 more)
...
Cohesion: 0.19
Nodes (11): createSimLoop(), collectImpacts(), collectTracers(), createCamera(), createTargetManagerStub(), makeTarget(), runProjectile(), runWeapon() (+3 more)
...
Cohesion: 0.26
Nodes (7): buildExportPayload(), degToRad(), makeRoundTripPayload(), tickTime(), yawDegAt(), aimAtPoint(), makeLeadPayload()
...
- **Why does `counter()` connect `Community 5` to `Community 17`, `Community 2`?**
  _High betweenness centrality (0.329) - this node is a cross-community bridge._
- **Why does `_fixture_report()` connect `Community 2` to `Community 1`, `Community 18`, `Community 5`?**
  _High betweenness centrality (0.208) - this node is a cross-community bridge._
- **Why does `load_export()` connect `Community 18` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 129`, `Community 5`, `Community 7`, `Community 14`, `Community 21`, `Community 28`, `Community 29`, `Community 30`, `Community 45`, `Community 51`, `Community 61`, `Community 62`, `Community 64`, `Community 69`, `Community 77`, `Community 78`, `Community 80`, `Community 85`, `Community 87`, `Community 89`, `Community 97`, `Community 103`?**
