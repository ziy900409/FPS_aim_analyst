...
## Corpus Check
- 661 files · ~1,281,280 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4893 nodes · 12113 edges · 300 communities (258 shown, 42 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 1498 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `15b5e084`
...
Cohesion: 0.06
Nodes (39): loadDrill(), setupArmed(), aimAt(), fireFrom(), runCadenceTimeoutExport(), runTimeoutOnly(), resolveSpiderShotWideV1(), measureAtEye() (+31 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (52): createPointerLock(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), average(), beginNextProtocolCondition(), buildSimLoop(), completeActiveProtocolCondition() (+44 more)
...
Cohesion: 0.09
Nodes (21): createDrillRunner(), runCadenceTimeoutExport(), runTimeoutOnly(), createSimLoop(), brInputs(), createCamera(), runBrVariant(), canonicalLongrangeFrames() (+13 more)

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (23): consume(), createInputSampler(), canonicalRun(), runFrames(), snap(), syntheticInputs(), advanceUntilTracer(), createCamera() (+15 more)
...
Cohesion: 0.09
Nodes (41): PeekWindow, One ``[visible, next visible)`` presentation window in measurement time., One ``[visible, next visible)`` presentation window in measurement time., _can_smooth(), _finalize(), _is_locally_uniform(), _peak_omega(), phase_decompose() (+33 more)
...
Cohesion: 0.11
Nodes (25): resolveTargetHitbox(), targetHitboxToConfig(), pushTarget(), buildRoundTripPayload(), activeSides(), assertFiniteEnvelope(), clipAxis(), collectClearanceViolations() (+17 more)
...
Cohesion: 0.09
Nodes (19): createDataRecorder(), buildExportPayload(), capacityForDrill(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), payload(), aimAtPoint() (+11 more)
...
Cohesion: 0.14
Nodes (20): buildEarlyReplayFixture(), buildFixture(), buildFixture(), buildIdentitySegment(), buildRunFilename(), buildRunId(), buildRunIdentity(), sanitizeSegmentPrefix() (+12 more)
...
Cohesion: 0.15
Nodes (16): requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor(), enumerateLandings(), parseSpiderShot(), requireSpiderWideArenaGeometry() (+8 more)
...
Cohesion: 0.15
Nodes (24): createHistoricalRunDetail(), makeButton(), FakeDocument, findByTag(), flatten(), readyValue(), setup(), text() (+16 more)

### Community 53 - "Community 53"
Cohesion: 0.13
Nodes (22): cameraLookingDownZ(), driveRenderAndSim(), fireAt(), fixedClock(), makeTarget(), meanSpreadRadius(), run(), runAtPumpCadence() (+14 more)
...
Cohesion: 0.13
Nodes (10): punchToThreeRad(), createReplayPresentationSession(), resolveWeapon(), buildReplayPunchTimeline(), lerp(), resolveReplayCameraVisualState(), samplePunchDeg(), buildTimeline() (+2 more)
...
Cohesion: 0.15
Nodes (10): ImpactView, createBulletArena(), createImpactRing(), createShotRayRing(), pushImpact(), pushShotRay(), resetBulletArena(), resetImpactRing() (+2 more)
...
Cohesion: 0.18
Nodes (6): deriveUnlockedIntervals(), overlapsAny(), segmentByTimeGap(), buildLiftSegmentationGolden(), lastSampleMs(), segmentationAt()
...
Cohesion: 0.21
Nodes (14): annotationCountToleranceFor(), assessAnnotationChannel(), auditRun(), boolText(), countPeripheralTrials(), extractAnnotationIntervals(), formatLiftCohortReport(), nearestGapStartMs() (+6 more)
...
Cohesion: 0.26
Nodes (13): annotation(), gap(), latencyCohort(), liftPayload(), liftRun(), move(), traceBlock(), assessCohortSufficiency() (+5 more)
...
Cohesion: 0.35
Nodes (10): collectFiles(), main(), buildLiftCohortReport(), isInstructionClass(), baseName(), parseEntry(), readLiftManifest(), verifyLiftSegmentationGolden() (+2 more)
...
- **Why does `bool()` connect `Community 110` to `Community 1`, `Community 7`, `Community 8`, `Community 44`, `Community 13`, `Community 143`, `Community 15`, `Community 145`, `Community 56`, `Community 59`, `Community 61`?**
  _High betweenness centrality (0.258) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 1` to `Community 131`, `Community 132`, `Community 133`, `Community 8`, `Community 12`, `Community 13`, `Community 144`, `Community 145`, `Community 146`, `Community 23`, `Community 28`, `Community 49`, `Community 56`, `Community 59`, `Community 188`, `Community 189`, `Community 78`, `Community 106`, `Community 107`, `Community 110`, `Community 119`?**
  _High betweenness centrality (0.139) - this node is a cross-community bridge._
- **Why does `counter()` connect `Community 56` to `Community 34`, `Community 12`?**
