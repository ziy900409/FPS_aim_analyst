...
## Corpus Check
- 282 files · ~501,142 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2469 nodes · 5604 edges · 155 communities (129 shown, 26 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 889 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9a345605`
...
8. `loadDrill()` - 35 edges
9. `SyntheticSpec` - 33 edges
10. `resolve_eye_origin()` - 33 edges
...
Cohesion: 0.05
Nodes (51): resolveTargetHitbox(), targetHitboxToConfig(), loadDrill(), distanceForAngularHeight(), makeVariant(), speedForAngularRate(), variantId(), defaultLoader() (+43 more)
...
Cohesion: 0.08
Nodes (48): _ads_label(), _advanced_diagnostics(), build_report(), _counts(), _delta(), _drill_summary(), _empty_stats(), _epsilon_or_none() (+40 more)
...
Cohesion: 0.07
Nodes (33): ⑩ One-line "why this metric is absent" notes for blocked-by-data P2 diagnostics., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., _render_diagnostics_gaps(), render_html(), Contract tests for the one-command coach report v1 (WP-30 T-exit).  Covers the (+25 more)
...
Cohesion: 0.13
Nodes (24): createDataRecorder(), capacityForDrill(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), recordVisibleEvents(), simStep(), cameraLookingDownZ() (+16 more)
...
Cohesion: 0.09
Nodes (17): keyMaskFromKeys(), keyMaskFromState(), keysFromMask(), TickArena, dot(), sgSmooth(), validateCoefficients(), validateMatrix() (+9 more)
...
Cohesion: 0.12
Nodes (21): GateThresholds, key_state_signed(), key_velocity_xcorr(), Signed strafe key state per tick: ``D`` -> ``+1``, ``A`` -> ``-1``, both or neit, Signed Pearson r at every lag in ``[-max_lag_ticks, +max_lag_ticks]``, plus the, ``gate-v1``, frozen by WP-31 T0 on 2026-08-10 (D-31.4) before any real xcorr val, T2 DoD 3, proven from the source rather than by sampling inputs.      Two fact, Alternating A/D holds at a fixed period: a strafe pattern with real autocorrelat (+13 more)
...
Cohesion: 0.19
Nodes (22): omega_deg_s(), Return angular speed for each tick, with ``nan`` at index zero.      Prefers t, Return angular speed for each tick, with ``nan`` at index zero.      The pitch, _assert_relative_parity(), _gate_two_ticks(), No second definition (FM-5/C-D4): d_yaw/d_pitch mirror the aim series exactly he, test_epsilon_is_zero_at_target_center(), test_epsilon_recovers_known_unsigned_offset() (+14 more)
...
Cohesion: 0.17
Nodes (19): _aim_forward(), epsilon_deg(), _finite_scalar(), _finite_vec3(), _hitbox(), _meta_eye_origin(), OmegaResult, on_target() (+11 more)
...
Cohesion: 0.17
Nodes (3): collect64HzSamples(), punchToThreeRad(), fireOnce()
...
## Knowledge Gaps
- **352 isolated node(s):** `Offline research modules.`, `Schema v2 ingestion and fixture generation.`, `Session-level construct presence gate.  Complements the existing format-only gat`, `Return whether *flag* is an exact or templated vocabulary member.`, `A drill family's core construct declaration (frozen; changes require a version b` (+347 more)
...
- **Why does `load_export()` connect `Community 55` to `Community 1`, `Community 2`, `Community 3`, `Community 7`, `Community 8`, `Community 11`, `Community 12`, `Community 20`, `Community 23`, `Community 25`, `Community 26`, `Community 30`, `Community 33`, `Community 41`, `Community 56`, `Community 60`, `Community 71`, `Community 73`, `Community 74`, `Community 76`, `Community 77`, `Community 79`, `Community 86`, `Community 87`, `Community 89`, `Community 102`, `Community 117`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 1` to `Community 34`, `Community 2`, `Community 3`, `Community 7`, `Community 71`, `Community 41`, `Community 74`, `Community 8`, `Community 76`, `Community 77`, `Community 78`, `Community 12`, `Community 79`, `Community 87`, `Community 56`, `Community 25`, `Community 60`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `build_report()` connect `Community 8` to `Community 1`, `Community 7`, `Community 45`, `Community 78`, `Community 84`, `Community 55`, `Community 25`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Are the 52 inferred relationships involving `load_export()` (e.g. with `test_check_construct_presence_08_03_export_is_absent()` and `test_check_construct_presence_09_39_export_is_present()`) actually correct?**
  _`load_export()` has 52 INFERRED edges - model-reasoned connections that need verification._
