...
## Corpus Check
- 693 files · ~1,395,227 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5374 nodes · 13421 edges · 291 communities (249 shown, 42 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1729 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4d768758`
...
1. `createSharedState()` - 125 edges
2. `createDataRecorder()` - 83 edges
3. `createTargetManager()` - 81 edges
4. `load_export()` - 74 edges
5. `createSimLoop()` - 70 edges
6. `loadDrill()` - 68 edges
7. `build_peek_windows()` - 57 edges
8. `createDrillRunner()` - 46 edges
9. `collectMeta()` - 43 edges
...
## Communities (291 total, 42 thin omitted)
...
Cohesion: 0.05
Nodes (53): loadDrill(), createDrillRunner(), makeConfig(), reversalConfig(), run(), setup(), setupArmed(), trackingGuardConfig() (+45 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (62): MouseSampleArena, mouseSampleCapacityForDrill(), deriveUnlockedIntervals(), overlapsAny(), segmentByTimeGap(), cmPerTurn(), countsPerTurn(), deriveMouseThrow() (+54 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (76): canonicalExportJSON(), canonicalizeValue(), fail(), isRecord(), parseAdsEvent(), parseAim(), parseAnnotationEvent(), parseArray() (+68 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (50): round(), simulatePurePunchPattern(), toPatternShot(), fixedClock(), v8SpawnTrace(), punchToThreeRad(), buttonCss(), createNumberInput() (+42 more)
...
Cohesion: 0.06
Nodes (36): createDataRecorder(), buildExportPayload(), capacityForDrill(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), cameraLookingDownZ(), driveRenderAndSim() (+28 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (55): createPointerLock(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), average(), beginNextProtocolCondition(), buildCurrentExportPayload(), buildSimLoop() (+47 more)
...
Cohesion: 0.07
Nodes (52): _blocked(), _finite(), _finite_scalar(), _first_tick_index_at_or_after(), fitts_samples(), FittsParams, FittsResult, FittsSample (+44 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (26): consume(), createInputSampler(), advanceUntilTracer(), createCamera(), createTarget(), fireOne(), runAtFrames(), runFrames() (+18 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (25): keyMaskFromKeys(), keyMaskFromState(), keysFromMask(), TickArena, aimFor(), makeV3Payload(), pointFor(), widePayload() (+17 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (31): createHistoryAnalysisService(), createSemaphore(), closeHistoryApiState(), contentLengthExceeds(), createHistoryApiMiddleware(), createHistoryApiState(), dispatch(), err() (+23 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (26): FakeSettingsDocument, FakeSettingsElement, wireSettingsToRecorder(), applyResolutionMode(), readDevicePixelRatio(), readViewport(), requirePositiveInteger(), resolutionModeLabel() (+18 more)
...
Cohesion: 0.09
Nodes (28): resolveTargetHitbox(), targetHitboxToConfig(), pushTarget(), buildRoundTripPayload(), activeSides(), assertFiniteEnvelope(), clipAxis(), collectClearanceViolations() (+20 more)

### Community 18 - "Community 18"
Cohesion: 0.09
Nodes (49): assess_sufficiency(), bootstrap_f1_interval(), decide(), evaluate_layers(), fit_layers(), _group_false_positive_rate(), LayerRule, promotion_checks() (+41 more)
...
Cohesion: 0.09
Nodes (46): boundary_windows(), derive_gap_boundary_kinematics(), FeatureError, _list(), load_sample_block(), _mapping(), _mean_speed(), _number() (+38 more)
...
Cohesion: 0.07
Nodes (13): realRegistry(), createHistoryClient(), HistoryClientError, isErrorBody(), isRecord(), isSuccessBody(), createHistoryLibraryController(), createHistoryPersistence() (+5 more)
...
Cohesion: 0.09
Nodes (23): buildEarlyReplayFixture(), openFullReplayFromResult(), openHistoricalRunDetail(), openHistory(), waitForHarness(), waitReplayReady(), buildFixture(), fixtureStartedAt() (+15 more)
...
Cohesion: 0.09
Nodes (35): report(), activeValidityFlags(), analyseRun(), assessSequence(), buildGates(), buildRepTrend(), buildSpiderShotV3CoachReport(), buildTails() (+27 more)
...
Cohesion: 0.1
Nodes (30): serializeJSON(), degToRad(), makeRoundTripPayload(), tickTime(), yawDegAt(), aimAtPoint(), aimAtTick(), makePayload() (+22 more)
...
Cohesion: 0.14
Nodes (36): _ad_key_events(), build_peek_windows(), _events_in_window(), _false(), _finite_number(), _first_compatible_fire(), _hit_times_by_shot(), _key() (+28 more)

### Community 39 - "Community 39"
Cohesion: 0.1
Nodes (17): createTrackingPilotSession(), FakeDocument, flush(), makeSession(), startManifest(), buildTrackingPilotManifest(), isTrackingPilotPracticeDrillId(), parseTrackingPilotManifest() (+9 more)
...
Cohesion: 0.12
Nodes (23): makeMeta(), normalizeReplayRecording(), toSceneDescriptor(), fixtureRecording(), fixtureRecording(), buildLargePayload(), buildSmallPayload(), timeFor() (+15 more)
...
Cohesion: 0.09
Nodes (7): createPresentationCoordinator(), buildLargePayload(), ReplayEffectView, createReplayPresentationSession(), resolveWeapon(), ReplayTargetView, resolveReplayTargetHitbox()
...
Cohesion: 0.11
Nodes (16): createDrillBrowser(), createDrillOverview(), makeButton(), historyRunSummaryFromPayload(), createHistoryScreen(), makeButton(), createHistoryNavigator(), defaultWindow() (+8 more)

### Community 51 - "Community 51"
Cohesion: 0.1
Nodes (23): integratedDelta(), omegaDegPerSec(), radToDeg(), requireFiniteNumber(), deriveDetectionMetrics(), resolveEyeOrigin(), deriveSpiderShotMetrics(), isFiniteNumber() (+15 more)
...
Cohesion: 0.13
Nodes (18): brInputs(), createCamera(), runBrVariant(), feedInputs(), runStep(), err(), pushWarning(), requireFiniteNumber() (+10 more)
...
Cohesion: 0.14
Nodes (13): resolveSpiderShotWideV1(), reparse(), requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor(), wideConfig() (+5 more)
...
Cohesion: 0.14
Nodes (24): aimForward(), angularDistanceDeg(), angularEccentricityDeg(), clamp(), eyeOriginForTick(), isFiniteNumber(), radToDeg(), aimForward() (+16 more)
...
Cohesion: 0.1
Nodes (12): drainSpawns(), recordSpiderSpawns(), recordSpiderSpawnsWithResetRerun(), angularSeparationDeg(), centerRelativeDirection(), minimumActiveSeparationDeg(), satisfiesActiveSeparation(), shuffleInPlace() (+4 more)
...
Cohesion: 0.1
Nodes (21): _axis_grid(), _better(), confusion_matrix(), ConfusionMatrix, _direction_change_variance(), _duration_grid(), fit_boundary(), fit_gap_only() (+13 more)
...
Cohesion: 0.14
Nodes (18): createSimLoop(), collectImpacts(), collectTracers(), createCamera(), createTargetManagerStub(), makeTarget(), runProjectile(), runWeapon() (+10 more)
...
Cohesion: 0.14
Nodes (22): ADR-5 Pointer Lock + 原始輸入 + coalesced, D1 UI = 純 TS + DOM overlay, WP-4 — 目標 / 準心, WP-6 — drill config (房間/距離正式值), WP-7 — DataRecorder ring buffer / metadata, NotSupportedError fallback (僅 Chromium 降級路徑), pitch 夾角 (clamp ±~89° 避免翻轉), PointerLockHandle (request/locked/onChange/onMove) (+14 more)
...
Cohesion: 0.25
Nodes (15): assertFinitePayload(), downloadCSV(), downloadJSON(), downloadTextFile(), exportBasename(), formatBoolean(), formatNumber(), formatOptionalNumber() (+7 more)
...
Cohesion: 0.15
Nodes (9): runResultAction(), action(), diagnosisMetricIds(), FakeDocument, flatten(), metricIds(), qualityFlagMetricIds(), section() (+1 more)
...
Cohesion: 0.23
Nodes (17): cross(), deriveSpiderShotTransitions(), dot(), eyeAtVisible(), formatConditionValue(), isFiniteNumber(), isFinitePositiveNumber(), normalize() (+9 more)
...
Cohesion: 0.24
Nodes (12): buildConditionEvidence(), buildTrackingPilotEvidence(), computeTrackingFrozenCrosshairRatio(), frozenEpsilonDeg(), median(), medianAim(), rms(), angularSize() (+4 more)
...
Cohesion: 0.26
Nodes (12): key_event_crosscheck(), _key_transitions(), Cross-check the tick-derived key state against the additive ``key`` event stream, test_the_synthetic_fixture_has_no_key_events_and_that_is_not_a_disagreement(), _key_events(), test_an_event_beyond_the_tolerance_does_not_match(), test_an_export_without_key_events_is_an_absent_witness_not_a_disagreement(), test_key_state_signed_encodes_the_four_tick_states() (+4 more)
...
Cohesion: 0.31
Nodes (7): buildHitboxAtTick(), firstTickAtOrAfter(), lastTickBefore(), normalizeRad(), preAimForPresentation(), targetFromTick(), targetFromVisible()
...
- **Why does `bool()` connect `Community 38` to `Community 2`, `Community 68`, `Community 70`, `Community 10`, `Community 75`, `Community 46`, `Community 16`, `Community 55`, `Community 152`, `Community 27`, `Community 63`?**
  _High betweenness centrality (0.277) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 38` to `Community 5`, `Community 10`, `Community 11`, `Community 139`, `Community 140`, `Community 142`, `Community 141`, `Community 16`, `Community 148`, `Community 21`, `Community 151`, `Community 152`, `Community 27`, `Community 31`, `Community 35`, `Community 55`, `Community 195`, `Community 75`, `Community 87`, `Community 113`, `Community 117`, `Community 119`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 46` to `Community 38`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Are the 64 inferred relationships involving `createSharedState()` (e.g. with `setup()` and `setupArmed()`) actually correct?**
  _`createSharedState()` has 64 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 46 inferred relationships involving `createTargetManager()` (e.g. with `activateDrill()` and `loadSceneById()`) actually correct?**
  _`createTargetManager()` has 46 INFERRED edges - model-reasoned connections that need verification._
