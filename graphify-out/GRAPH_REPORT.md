# Graph Report - FPS_aim_analyst  (2026-07-15)

## Corpus Check
- 170 files · ~262,066 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1218 nodes · 2916 edges · 75 communities (58 shown, 17 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 238 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3adca1bc`
...
Cohesion: 0.06
Nodes (39): createDrillRunner(), canonicalRun(), runFrames(), snap(), syntheticInputs(), applyAimFixture(), canonicalMovingTargetFrames(), createCamera() (+31 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (21): consume(), createInputSampler(), ImpactView, TracerView, isDrivenMotion(), motionOffset(), offsetAt(), triangleWave() (+13 more)
...
Cohesion: 0.12
Nodes (15): brInputs(), createCamera(), runBrVariant(), CameraController, err(), pushWarning(), requireFiniteNumber(), requireNonNegativeNumber() (+7 more)
...
Cohesion: 0.12
Nodes (17): setup(), createSimLoop(), createMovementController(), run(), runBatches(), createSharedState(), canonicalTrajectory(), freshState() (+9 more)
...
Cohesion: 0.18
Nodes (18): round(), simulatePurePunchPattern(), toPatternShot(), simulatePattern(), createRecoilState(), hybridDecay(), recoilOnFire(), recoilTick() (+10 more)

### Community 17 - "Community 17"
Cohesion: 0.18
Nodes (19): createPointerLock(), activeWeaponConfig(), buildCurrentExportPayload(), buildSimLoop(), completeActiveProtocolCondition(), exportBasename(), findSceneOption(), installSceneLoad() (+11 more)
...
Cohesion: 0.53
Nodes (6): beginNextProtocolCondition(), protocolRunningText(), setProtocolStatus(), startBrTrackingProtocol(), startProtocol(), startResolutionProtocol()
...
- **Why does `createDataRecorder()` connect `Community 0` to `Community 1`, `Community 3`, `Community 11`, `Community 13`, `Community 15`, `Community 47`, `Community 17`, `Community 29`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `FakeElement` connect `Community 45` to `Community 37`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `createSimLoop()` connect `Community 13` to `Community 1`, `Community 2`, `Community 3`, `Community 33`, `Community 11`, `Community 14`, `Community 15`, `Community 47`, `Community 17`, `Community 29`?**
