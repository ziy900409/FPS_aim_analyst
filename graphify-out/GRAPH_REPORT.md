...
## Corpus Check
- 687 files · ~1,365,413 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5268 nodes · 13118 edges · 298 communities (261 shown, 37 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1699 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8e03f9d6`
...
## Communities (298 total, 37 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (42): createDataRecorder(), createDrillRunner(), runCadenceTimeoutExport(), runCadenceTimeoutExport(), createSimLoop(), brInputs(), createCamera(), runBrVariant() (+34 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (52): makeConfig(), reversalConfig(), run(), setup(), setupArmed(), trackingGuardConfig(), runTimeoutOnly(), runTimeoutOnly() (+44 more)
...
Cohesion: 0.07
Nodes (49): createPointerLock(), createRenderLoop(), lerp(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), beginNextProtocolCondition(), buildCurrentExportPayload() (+41 more)
...
Cohesion: 0.09
Nodes (25): payload(), tick(), buildCounterstrafeReversalPilotConfigs(), buildHoldClickPilotConfigs(), buildHoldTrackPilotConfigs(), buildPeekClickTransferPilotConfigs(), buildPeekClickTransferPilotV2Configs(), buildSpiderShotPilotConfigs() (+17 more)
...
Cohesion: 0.07
Nodes (16): reparse(), createHistoryClient(), HistoryClientError, isErrorBody(), isRecord(), isSuccessBody(), createHistoryLibraryController(), historyRunSummaryFromPayload() (+8 more)

### Community 16 - "Community 16"
Cohesion: 0.07
Nodes (23): buildExportPayload(), capacityForDrill(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), aimAtPoint(), aimAtTick(), makePayload() (+15 more)
...
Cohesion: 0.07
Nodes (23): compileSessionProgram(), deriveProgramFamilyOrder(), requireRestSeconds(), requireWeapon(), resolveBoundary(), SessionProgramCompileError, summarizeProgram(), actualWeaponIdFor() (+15 more)
...
Cohesion: 0.12
Nodes (9): resolveDrillTimeLimitMs(), resolveHitFeedback(), diffFields(), flatten(), diffFields(), flatten(), buildDeclaredWeaponByDrillId(), buildCuratedRegistry() (+1 more)
...
Cohesion: 0.11
Nodes (31): createRan1(), randomFloat(), shuffleInPlace(), expectedPos(), boundedSpeedScale(), buildSinusoidComponents(), clamp(), createBandLimited2dV1() (+23 more)
...
Cohesion: 0.12
Nodes (25): deriveUnlockedIntervals(), overlapsAny(), segmentByTimeGap(), annotationCountToleranceFor(), assessAnnotationChannel(), auditRun(), boolText(), countPeripheralTrials() (+17 more)
...
Cohesion: 0.09
Nodes (11): punchToThreeRad(), buildLargePayload(), ReplayEffectView, createReplayPresentationSession(), resolveWeapon(), buildReplayPunchTimeline(), lerp(), resolveReplayCameraVisualState() (+3 more)
...
Cohesion: 0.12
Nodes (23): parseEvents(), parseExportPayload(), parseTicks(), walk(), collectFiles(), load(), loadManifest(), main() (+15 more)
...
Cohesion: 0.13
Nodes (20): collectFiles(), load(), main(), stimulusCheck(), formatTrackingDeliveredAngles(), formatTrackingFrozenCrosshairRatio(), evaluateCell(), evaluateTrackingSeedEquivalence() (+12 more)
...
Cohesion: 0.11
Nodes (22): Pure submovement segmentation algorithms., Export, Validated export data prepared for offline analysis., Validated export data prepared for offline analysis., Validated export data prepared for offline analysis., Validated export data prepared for offline analysis., _finite(), _first_shot_hit_count() (+14 more)
...
Cohesion: 0.13
Nodes (13): angularSeparationDeg(), centerRelativeDirection(), minimumActiveSeparationDeg(), satisfiesActiveSeparation(), isDrivenMotion(), motionOffset(), offsetAt(), triangleWave() (+5 more)
...
Cohesion: 0.21
Nodes (16): annotation(), gap(), latencyCohort(), liftPayload(), liftRun(), move(), traceBlock(), collectFiles() (+8 more)
...
- **Why does `bool()` connect `Community 55` to `Community 65`, `Community 163`, `Community 4`, `Community 38`, `Community 39`, `Community 9`, `Community 43`, `Community 77`, `Community 53`, `Community 152`, `Community 58`, `Community 63`?**
  _High betweenness centrality (0.279) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 4` to `Community 9`, `Community 142`, `Community 143`, `Community 144`, `Community 18`, `Community 151`, `Community 152`, `Community 32`, `Community 48`, `Community 53`, `Community 55`, `Community 58`, `Community 59`, `Community 195`, `Community 196`, `Community 87`, `Community 121`, `Community 122`, `Community 123`, `Community 126`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 43` to `Community 55`?**
