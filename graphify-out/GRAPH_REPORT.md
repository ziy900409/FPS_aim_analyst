...
## Corpus Check
- 210 files · ~299,586 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1435 nodes · 3315 edges · 91 communities (68 shown, 23 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 334 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `de382048`
...
Cohesion: 0.09
Nodes (25): _Candidate, _finite_non_negative(), _finite_positive(), _merge_overlapping(), _prepare_signal(), _ratio(), Submovement segmentation for 128 Hz angular-speed traces., List-compatible result carrying flags when no segment can hold them. (+17 more)
...
Cohesion: 0.12
Nodes (23): _compute_failed_flag(), is_known_quality_flag(), per_segment_apply(), Per-segment computation with a closed, machine-readable quality vocabulary.  Exa, Summarize finite, unflagged values while counting excluded flagged rows., Summarize finite, unflagged values while counting excluded flagged rows., Return whether *flag* is an exact or templated vocabulary member., Return whether *flag* is an exact or templated vocabulary member. (+15 more)

### Community 15 - "Community 15"
Cohesion: 0.15
Nodes (17): createTargetManager(), collectImmediateSpawns(), killSequence(), motionConfig(), runDrill(), runPositions(), createSharedState(), applyMode() (+9 more)
...
Cohesion: 0.15
Nodes (15): createPointerLock(), beginNextProtocolCondition(), completeActiveProtocolCondition(), exportBasename(), onExportCSV(), onExportJSON(), protocolRunningText(), setProtocolStatus() (+7 more)
...
Cohesion: 0.19
Nodes (7): createSimLoop(), canonicalLongrangeFrames(), createCamera(), runLongrangeTracking(), canonicalFire(), runFire(), freshLoop()
...
Cohesion: 0.29
Nodes (15): _aim_forward(), _column(), _finite_column(), _finite_scalar(), _geometry(), _hitbox(), omega_deg_s(), on_target() (+7 more)
...
Cohesion: 0.22
Nodes (6): createDrillRunner(), setup(), canonicalRun(), runFrames(), snap(), syntheticInputs()

### Community 37 - "Community 37"
Cohesion: 0.24
Nodes (5): isDrivenMotion(), motionOffset(), offsetAt(), triangleWave(), fireOnce()
...
Cohesion: 0.27
Nodes (5): createDataRecorder(), capacityForDrill(), brInputs(), createCamera(), runBrVariant()
...
## Knowledge Gaps
- **136 isolated node(s):** `Offline research modules.`, `Schema v2 ingestion and fixture generation.`, `Fixed-tick interval quality reporting.`, `Uniformity report; each gap index identifies the right-hand tick row.`, `Compare adjacent tick times with ``1000 / sim_hz`` using a 1e-6 ms tolerance.` (+131 more)
...
- **Why does `createDataRecorder()` connect `Community 41` to `Community 0`, `Community 1`, `Community 36`, `Community 42`, `Community 15`, `Community 17`, `Community 49`, `Community 19`, `Community 52`, `Community 22`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `createSimLoop()` connect `Community 22` to `Community 0`, `Community 3`, `Community 36`, `Community 4`, `Community 40`, `Community 41`, `Community 42`, `Community 13`, `Community 15`, `Community 17`, `Community 49`, `Community 19`, `Community 51`, `Community 52`, `Community 55`?**
