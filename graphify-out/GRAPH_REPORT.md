...
## Corpus Check
- 720 files · ~1,468,266 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5536 nodes · 13864 edges · 317 communities (274 shown, 43 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1778 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `31eaccd9`
...
## Communities (317 total, 43 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (87): fail(), isRecord(), parseAdsEvent(), parseAim(), parseAnnotationEvent(), parseArray(), parseAssessmentMeta(), parseBoolean() (+79 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (55): createRig(), makeDrillConfig(), createDrillRunner(), makeConfig(), reversalConfig(), run(), setup(), setupArmed() (+47 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (76): assessmentProtocolVersionForDrill(), resolveTargetHitbox(), targetHitboxToConfig(), pushTarget(), buildRoundTripPayload(), parseSpiderShot(), activateDrill(), activeWeaponConfig() (+68 more)
...
Cohesion: 0.06
Nodes (79): collectMeta(), measureDisplayHz(), measureDisplayRefresh(), nextAnimationFrame(), normalizeOverflow(), normalizeStartedAt(), requireAssessmentMeta(), requireBackend() (+71 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (44): consume(), createSimLoop(), canonicalRun(), runFrames(), snap(), syntheticInputs(), advanceUntilTracer(), createCamera() (+36 more)
...
Cohesion: 0.07
Nodes (32): createDataRecorder(), FakeSettingsDocument, wireSettingsToRecorder(), buildExportPayload(), capacityForDrill(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain() (+24 more)
...
Cohesion: 0.11
Nodes (12): resolveDrillTimeLimitMs(), resolveHitFeedback(), pilotDrillId(), buildPeekClickTransferPilotV2MaskedConfig(), buildPeekClickTransferPilotV2RandomizedConfig(), peekClickTransferPilotV2CandidateLabel(), pilotV2DrillId(), diffFields() (+4 more)
...
Cohesion: 0.09
Nodes (11): createSceneLoadCoordinator(), SceneManager, createReplayPresentationSession(), resolveWeapon(), ReplaySceneAdapter, ReplayTargetView, resolveReplayTargetHitbox(), resolveEyeWorldBase() (+3 more)
...
Cohesion: 0.12
Nodes (39): buildEndConditionByDrillId(), eyeOriginForTick(), angularRadiusDeg(), angularRadiusSource(), attributeShot(), cadenceWaitWithin(), candidatesAtKill(), candidatesForShot() (+31 more)
...
Cohesion: 0.09
Nodes (15): reparse(), createDrillMetricRegistry(), realRegistry(), createHistoryClient(), HistoryClientError, isErrorBody(), isRecord(), isSuccessBody() (+7 more)
...
Cohesion: 0.13
Nodes (15): canonicalExportJSON(), canonicalizeValue(), buildEarlyReplayFixture(), buildFixture(), fixtureStartedAt(), buildFixture(), buildFixture(), buildIdentitySegment() (+7 more)
...
Cohesion: 0.09
Nodes (12): brInputs(), createCamera(), runBrVariant(), createMicroFlickHarness(), expectObjectIsDeep(), feedInputs(), runStep(), fixedClock() (+4 more)
...
Cohesion: 0.13
Nodes (17): aimForward(), angularDistanceDeg(), angularEccentricityDeg(), clamp(), isFiniteNumber(), radToDeg(), resolveEyeOrigin(), deriveStopTransitions() (+9 more)

### Community 48 - "Community 48"
Cohesion: 0.12
Nodes (13): deriveBrakingSamples(), baseMeta(), payload(), deriveCounterstrafeMetrics(), deriveHoldClickMetrics(), derivePeekClickTransferMetrics(), buildPeekWindows(), firstTickIndexAtOrAfter() (+5 more)
...
Cohesion: 0.18
Nodes (15): requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor(), enumerateLandings(), requireSpiderWideArenaGeometry(), spiderWideArenaClearance() (+7 more)
...
Cohesion: 0.12
Nodes (8): createInputSampler(), createPausableTimeMapper(), createPauseRig(), pausedRig(), run(), createRig(), framesAt(), runStrategy()

### Community 69 - "Community 69"
Cohesion: 0.13
Nodes (22): activeTargets(), angularSeparationDeg(), collectReplacementTrace(), direction(), expectPopulationInvariant(), externalTarget(), fallbackTarget(), fixedClock() (+14 more)
...
Cohesion: 0.14
Nodes (15): compileSessionProgram(), deriveProgramFamilyOrder(), requireRestSeconds(), resolveBoundary(), SessionProgramCompileError, summarizeProgram(), actualWeaponIdFor(), curatedConfigFor() (+7 more)
...
Cohesion: 0.15
Nodes (18): _finite(), _first_shot_hit_count(), first_shot_hits(), Drill-level metrics that reproduce the frozen ``compute-v1`` semantics., Per-peek compatible-first-shot hit indicator under frozen ``compute-v1``., Match frozen ``compute-v1``: finite values, linear p50, population SD., Compute the three frozen timeline metrics and retain every peek window., Return a JSON-ready payload; writing remains at the notebook boundary. (+10 more)
...
Cohesion: 0.2
Nodes (10): createTrackingPilotSession(), buildTrackingPilotManifest(), parseTrackingPilotManifest(), requireNonEmptyString(), requireRecord(), resolveTrackingPilotBlockConfig(), validManifestJson(), createTrackingPilotRunner() (+2 more)
...
Cohesion: 0.19
Nodes (14): timeFor(), renderAt(), clamp(), createReplayPlayer(), normalize(), clamp(), createReplaySampleBuffer(), eventCursorAt() (+6 more)
...
Cohesion: 0.16
Nodes (12): buildHitboxAtTick(), firstTickAtOrAfter(), lastTickBefore(), normalizeRad(), preAimForPresentation(), targetFromTick(), targetFromVisible(), aimAtPoint() (+4 more)
...
Cohesion: 0.27
Nodes (9): createAttemptFinalizationGate(), describeAttemptHold(), describeDiscardReason(), invalidAttemptBasename(), planFinalization(), snapshot(), ticksFrom(), createFinalizationRig() (+1 more)
...
Cohesion: 0.22
Nodes (3): createRetryRig(), protocolConfig(), startSession()
...
Cohesion: 0.27
Nodes (4): createConditionRecoveryScreen(), makeButton(), FakeDocument, setup()
...
Cohesion: 0.36
Nodes (5): extractAnnotationIntervals(), buildLiftSegmentationGolden(), lastSampleMs(), segmentationAt(), verifyLiftSegmentationGolden()
...
- **Why does `bool()` connect `Community 67` to `Community 33`, `Community 164`, `Community 7`, `Community 9`, `Community 78`, `Community 175`, `Community 46`, `Community 50`, `Community 82`, `Community 22`, `Community 92`?**
  _High betweenness centrality (0.299) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 67` to `Community 131`, `Community 132`, `Community 133`, `Community 7`, `Community 9`, `Community 14`, `Community 22`, `Community 152`, `Community 153`, `Community 26`, `Community 27`, `Community 155`, `Community 163`, `Community 164`, `Community 37`, `Community 46`, `Community 183`, `Community 55`, `Community 82`, `Community 87`, `Community 114`, `Community 124`, `Community 125`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 33` to `Community 67`?**
