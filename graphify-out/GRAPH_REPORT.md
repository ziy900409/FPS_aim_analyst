...
## Corpus Check
- 654 files · ~1,223,209 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4847 nodes · 11970 edges · 291 communities (246 shown, 45 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 1479 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e3c2a8bd`
...
## Communities (291 total, 45 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (57): createDataRecorder(), createDrillRunner(), runCadenceTimeoutExport(), runCadenceTimeoutExport(), createSimLoop(), brInputs(), createCamera(), runBrVariant() (+49 more)
...
Cohesion: 0.08
Nodes (34): resolveTargetHitbox(), loadDrill(), aimAt(), fireFrom(), pushTarget(), measureAtEye(), activeSides(), assertFiniteEnvelope() (+26 more)
...
Cohesion: 0.09
Nodes (21): assessmentProtocolVersionForDrill(), angularSizeToHitboxWidthU(), buildPeekClickTransferPilotConfig(), pilotDrillId(), buildPeekClickTransferPilotV2Config(), buildPeekClickTransferPilotV2MaskedConfig(), buildPeekClickTransferPilotV2RandomizedConfig(), peekClickTransferPilotV2CandidateLabel() (+13 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (50): createPointerLock(), createRenderLoop(), lerp(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), average(), beginNextProtocolCondition() (+42 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (41): setup(), runTimeoutOnly(), runTimeoutOnly(), drainSpawns(), timeoutHarness(), wideConfig(), createMovementController(), run() (+33 more)
...
Cohesion: 0.07
Nodes (40): createRan1(), randomFloat(), angularSeparationDeg(), centerRelativeDirection(), minimumActiveSeparationDeg(), satisfiesActiveSeparation(), shuffleInPlace(), expectedPos() (+32 more)
...
Cohesion: 0.07
Nodes (31): requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor(), enterResearcherDrillControls(), expectYawWindowMatchesResolver(), feed() (+23 more)
...
Cohesion: 0.06
Nodes (20): SessionProgramCompileError, summarizeProgram(), describeBoundary(), createRestOverlay(), FakeDocument, FakeElement, createSessionPlanSetup(), describeStep() (+12 more)
...
Cohesion: 0.11
Nodes (44): epsilon_deg(), EyeOrigin, _finite_scalar(), _finite_vec3(), _meta_eye_origin(), omega_deg_s(), Return angular speed for each tick, with ``nan`` at index zero.      Prefers t, Return unsigned aim-to-target-center angular error for each tick.      The ray (+36 more)
...
Cohesion: 0.09
Nodes (21): capacityForDrill(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), cameraLookingDownZ(), driveRenderAndSim(), fireAt(), fixedClock() (+13 more)
...
Cohesion: 0.09
Nodes (15): deriveBrakingSamples(), baseMeta(), payload(), deriveCounterstrafeMetrics(), sidedStat(), payload(), tick(), buildPeekWindows() (+7 more)
...
Cohesion: 0.11
Nodes (24): exportBasename(), resolveFamilyDrillId(), resolveWarmupDrillId(), findSessionPlanPreset(), compileSessionProgram(), deriveProgramFamilyOrder(), requireRestSeconds(), requireWeapon() (+16 more)

### Community 33 - "Community 33"
Cohesion: 0.08
Nodes (14): FakeDocument, findByTag(), flatten(), readyValue(), setup(), text(), realRegistry(), createHistoryClient() (+6 more)
...
Cohesion: 0.1
Nodes (23): createHistoryAnalysisService(), createSemaphore(), closeHistoryApiState(), contentLengthExceeds(), createHistoryApiMiddleware(), createHistoryApiState(), dispatch(), err() (+15 more)
...
Cohesion: 0.09
Nodes (32): check_construct_presence(), ConstructReport, ConstructRule, is_known_construct_flag(), Session-level construct presence gate.  Complements the existing format-only gat, Return whether *flag* is an exact or templated vocabulary member., A drill family's core construct declaration (frozen; changes require a version b, Session-level presence verdict. ``present is None`` iff the family is unregister (+24 more)
...
Cohesion: 0.1
Nodes (19): buildExportPayload(), serializeJSON(), targetHitboxToConfig(), degToRad(), makeRoundTripPayload(), tickTime(), yawDegAt(), aimAtPoint() (+11 more)
...
Cohesion: 0.11
Nodes (27): _ad_key_events(), _bootstrap_ci(), _checked_flags(), _correlogram(), _gate_verdict(), GateVerdict, _half_agreement(), _median_dt_ms() (+19 more)
...
Cohesion: 0.16
Nodes (19): key_event_crosscheck(), _key_transitions(), _pearson(), Cross-check the tick-derived key state against the additive ``key`` event stream, Signed Pearson r, or ``nan`` for too-few samples / a zero-variance input (PA ``_, test_the_synthetic_fixture_has_no_key_events_and_that_is_not_a_disagreement(), _key_events(), T2 DoD 3, proven from the source rather than by sampling inputs.      Two fact (+11 more)
...
Cohesion: 0.23
Nodes (18): buildHitboxAtTick(), deriveHoldClickMetrics(), average(), buildResultPresentation(), createResultSummary(), diagnosisForPayload(), diagnosisInputsForPayload(), formatNumber() (+10 more)
...
Cohesion: 0.13
Nodes (17): _aligned(), key_state_signed(), key_velocity_xcorr(), Signed strafe key state per tick: ``D`` -> ``+1``, ``A`` -> ``-1``, both or neit, Signed Pearson r at every lag in ``[-max_lag_ticks, +max_lag_ticks]``, plus the, Drop ``omega_deg_s``'s contractual leading ``nan`` from **both** channels togeth, Alternating A/D holds at a fixed period: a strafe pattern with real autocorrelat, _square_key() (+9 more)
...
- **Why does `bool()` connect `Community 51` to `Community 2`, `Community 38`, `Community 9`, `Community 11`, `Community 76`, `Community 13`, `Community 139`, `Community 49`, `Community 52`, `Community 27`?**
  _High betweenness centrality (0.253) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 2` to `Community 128`, `Community 129`, `Community 130`, `Community 131`, `Community 133`, `Community 9`, `Community 138`, `Community 139`, `Community 13`, `Community 15`, `Community 19`, `Community 26`, `Community 46`, `Community 49`, `Community 51`, `Community 52`, `Community 185`, `Community 58`, `Community 70`, `Community 103`, `Community 107`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `load_export()` connect `Community 50` to `Community 128`, `Community 129`, `Community 2`, `Community 131`, `Community 133`, `Community 9`, `Community 138`, `Community 139`, `Community 13`, `Community 15`, `Community 19`, `Community 148`, `Community 26`, `Community 162`, `Community 38`, `Community 42`, `Community 45`, `Community 46`, `Community 49`, `Community 52`, `Community 185`, `Community 65`, `Community 198`, `Community 70`, `Community 103`, `Community 107`?**
