...
## Corpus Check
- 664 files · ~1,232,725 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5185 nodes · 12828 edges · 304 communities (261 shown, 43 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1660 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6337d03f`
...
8. `parseExportPayload()` - 53 edges
9. `render_html()` - 41 edges
10. `createDrillRunner()` - 41 edges
...
- `load()` --calls--> `parseExportPayload()`  [INFERRED]
  scripts/_probe-wide2.ts → src/data/exportPayloadSchema.ts
- `load()` --calls--> `parseExportPayload()`  [INFERRED]
  scripts/_probe-wide3.ts → src/data/exportPayloadSchema.ts
- `load()` --calls--> `parseExportPayload()`  [INFERRED]
  scripts/_probe-wide4.ts → src/data/exportPayloadSchema.ts
- `load()` --calls--> `parseExportPayload()`  [INFERRED]
  scripts/_probe-wide6.ts → src/data/exportPayloadSchema.ts
...
Cohesion: 0.06
Nodes (71): collectMeta(), measureDisplayHz(), measureDisplayRefresh(), nextAnimationFrame(), normalizeOverflow(), normalizeStartedAt(), requireAssessmentMeta(), requireBackend() (+63 more)
...
Cohesion: 0.06
Nodes (40): makeConfig(), reversalConfig(), run(), trackingGuardConfig(), createSimLoop(), canonicalRun(), runFrames(), snap() (+32 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (41): spawnBullet(), stepBullet(), clipAxis(), sweptHitTest(), collect64HzSamples(), advanceProjectiles(), applyInput(), ballisticRaycast() (+33 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (30): createDataRecorder(), buildExportPayload(), capacityForDrill(), targetHitboxToConfig(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), aimAtPoint() (+22 more)
...
Cohesion: 0.07
Nodes (51): runControl(), appendCurveBand(), appendCurveLine(), appendGuideLine(), appendPath(), classifyResidualSpeed(), countFlags(), createDiagnosisSummary() (+43 more)
...
Cohesion: 0.07
Nodes (36): createDrillRunner(), setup(), runCadenceTimeoutExport(), runTimeoutOnly(), runCadenceTimeoutExport(), runTimeoutOnly(), measureAtEye(), canonicalLongrangeFrames() (+28 more)
...
Cohesion: 0.08
Nodes (46): createPointerLock(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), average(), beginNextProtocolCondition(), buildSimLoop(), completeActiveProtocolCondition() (+38 more)
...
Cohesion: 0.09
Nodes (25): resolveSpiderShotWideV1(), requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor(), enterResearcherDrillControls(), expectYawWindowMatchesResolver() (+17 more)

### Community 18 - "Community 18"
Cohesion: 0.1
Nodes (30): deriveUnlockedIntervals(), overlapsAny(), segmentByTimeGap(), collectFiles(), main(), collectFiles(), load(), loadManifest() (+22 more)
...
Cohesion: 0.08
Nodes (16): createPresentationCoordinator(), normalizeReplayRecording(), toSceneDescriptor(), fixtureRecording(), fixtureRecording(), classifyReplaySupport(), classifyStatus(), isMonotonicTimeline() (+8 more)

### Community 22 - "Community 22"
Cohesion: 0.09
Nodes (34): _axis_grid(), _better(), bootstrap_f1_interval(), confusion_matrix(), _duration_grid(), evaluate_layers(), fit_boundary(), fit_gap_only() (+26 more)
...
Cohesion: 0.08
Nodes (26): integratedDelta(), omegaDegPerSec(), radToDeg(), requireFiniteNumber(), deriveDetectionMetrics(), deriveSpiderShotMetrics(), isFiniteNumber(), percentile() (+18 more)
...
Cohesion: 0.07
Nodes (33): _Candidate, _finite_non_negative(), _finite_positive(), _merge_overlapping(), _prepare_signal(), _ratio(), Submovement segmentation for 128 Hz angular-speed traces., List-compatible result carrying flags when no segment can hold them. (+25 more)

### Community 30 - "Community 30"
Cohesion: 0.09
Nodes (18): createDrillOverview(), makeButton(), historyRunSummaryFromPayload(), createHistoryScreen(), makeButton(), FakeDocument, flatten(), text() (+10 more)
...
Cohesion: 0.08
Nodes (30): detect_parity_payload(), _detect_presentation(), detect_samples(), DetectSample, _epsilon_with_fixed_target(), _eye_origin_to_json(), _first_sustained_decrease(), _first_tick_index_at_or_after() (+22 more)

### Community 41 - "Community 41"
Cohesion: 0.12
Nodes (32): _finalize(), _is_locally_uniform(), _peak_omega(), phase_decompose(), phase_table(), PhaseParams, PhaseSample, REC/MR/V phase decomposition (WP-30 / T2, FR-D11).  ``phase-v1`` answers "whic (+24 more)
...
Cohesion: 0.1
Nodes (10): reparse(), createHistoryClient(), HistoryClientError, isErrorBody(), isRecord(), isSuccessBody(), createHistoryLibraryController(), createHistoryPersistence() (+2 more)
...
Cohesion: 0.13
Nodes (27): adaptPayloadForScoredWindow(), applySmoothing(), applySmoothingToSeries(), clamp(), computeSignedBias(), computeSignedOmegaSeries(), deriveTrackingDynamics(), deriveTrackingReversalWindows() (+19 more)

### Community 49 - "Community 49"
Cohesion: 0.12
Nodes (20): keysFromMask(), widePayload(), payloadWithEyeZ(), recordTicks(), bearingDeg(), buildTicks(), payloadFor(), targetAt() (+12 more)
...
Cohesion: 0.1
Nodes (18): nextAnimationFrame(), percentile(), probeWarmupP95Ms(), readDevicePixelRatio(), readFullscreenElement(), readScreenDim(), requireNonNegativeInteger(), requireNonNegativeNumber() (+10 more)
...
Cohesion: 0.1
Nodes (11): parseEvents(), parseExportPayload(), parseTicks(), cmPerTurn(), countsPerTurn(), deriveMouseThrow(), isFinitePositive(), load() (+3 more)
...
Cohesion: 0.1
Nodes (26): counter(), _ads_label(), build_report(), _counts(), _delta(), _drill_summary(), _flag_counts(), _group_key() (+18 more)

### Community 64 - "Community 64"
Cohesion: 0.12
Nodes (16): deriveProjectedFootprint(), footprintSpread(), nonNegativeFinite(), positiveFinite(), projectedSphereFootprint(), readResolvedFovDegVertical(), offAxisDeg(), windowCorners() (+8 more)
...
Cohesion: 0.15
Nodes (22): aimForward(), angularEccentricityDeg(), clamp(), derivePresentation(), derivePresentationSamples(), deriveTrackingMetrics(), deriveTrackingSamples(), finite() (+14 more)
...
Cohesion: 0.13
Nodes (20): DetectParams, Mirrors TS ``ResolvedDetectionDerivationOptions`` (``detectionDerivation`` ``DEF, PeekWindow, One ``[visible, next visible)`` presentation window in measurement time., One ``[visible, next visible)`` presentation window in measurement time., Pre-registered ``sparc-v1`` parameters (T0/D-31.5); changes require a new versio, SparcParams, candidate_params() (+12 more)
...
Cohesion: 0.19
Nodes (14): aimFor(), makeV3Payload(), pointFor(), report(), collectFiles(), firstSentence(), load(), main() (+6 more)
...
Cohesion: 0.22
Nodes (11): buildConditionEvidence(), buildTrackingPilotEvidence(), computeTrackingFrozenCrosshairRatio(), frozenEpsilonDeg(), median(), medianAim(), rms(), angularSize() (+3 more)

### Community 113 - "Community 113"
Cohesion: 0.26
Nodes (13): buildCompatibilityKey(), buildSensitivityFovKey(), checkCompatibility(), checkQualityGate(), deriveSessionId(), requireBoolean(), requireNonNegativeFiniteNumber(), requireNonNegativeInteger() (+5 more)
...
Cohesion: 0.2
Nodes (9): exportBasename(), compileSessionProgram(), deriveProgramFamilyOrder(), requireRestSeconds(), resolveBoundary(), SessionProgramCompileError, summarizeProgram(), metaForRun() (+1 more)
...
Cohesion: 0.23
Nodes (13): ADR-2 雙迴圈解耦, ADR-3 128 Hz tick, WP-0 — 環境設置 (scaffold/createRenderer seam), WP-3 — 高頻輸入採集 (getCoalescedEvents 入緩衝), WP-4 — 目標 / 準心, WP-5 — movement / 急停物理, WP-1 Progress Log, WP-1 — FPS 控制 + Pointer Lock (exec-plan) (+5 more)
...
Cohesion: 0.27
Nodes (4): distanceForAngularHeight(), makeVariant(), speedForAngularRate(), variantId()
...
Cohesion: 0.29
Nodes (5): expectOk(), metaWith(), minimalMeta(), minimalPayload(), payloadWithEvents()
...
- **Why does `bool()` connect `Community 63` to `Community 1`, `Community 164`, `Community 68`, `Community 9`, `Community 41`, `Community 44`, `Community 12`, `Community 18`, `Community 152`, `Community 60`, `Community 62`?**
  _High betweenness centrality (0.295) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 1` to `Community 9`, `Community 12`, `Community 14`, `Community 145`, `Community 146`, `Community 151`, `Community 152`, `Community 26`, `Community 40`, `Community 63`, `Community 68`, `Community 69`, `Community 199`, `Community 200`, `Community 75`, `Community 82`, `Community 108`, `Community 110`, `Community 122`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 44` to `Community 63`?**
