...
## Corpus Check
- 577 files · ~1,033,364 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4398 nodes · 10640 edges · 260 communities (221 shown, 39 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 1299 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `32c51cca`
...
Cohesion: 0.05
Nodes (59): createDataRecorder(), capacityForDrill(), createDrillRunner(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), createSimLoop(), cameraLookingDownZ() (+51 more)
...
Cohesion: 0.08
Nodes (33): resolveTargetHitbox(), targetHitboxToConfig(), loadDrill(), aimAt(), fireFrom(), pushTarget(), measureAtEye(), activeSides() (+25 more)
...
Cohesion: 0.08
Nodes (51): createPointerLock(), createSceneManagerWithStatus(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), average(), beginNextProtocolCondition(), buildCurrentExportPayload() (+43 more)
...
Cohesion: 0.09
Nodes (33): buildExportPayload(), serializeJSON(), degToRad(), makeRoundTripPayload(), tickTime(), yawDegAt(), aimAtPoint(), aimAtTick() (+25 more)
...
Cohesion: 0.1
Nodes (8): createSceneLoadCoordinator(), defaultLoader(), disposeScene(), loadScene(), createSceneManager(), SceneManager, ReplaySceneAdapter, resolveEyeWorldBase()
...
Cohesion: 0.12
Nodes (37): EyeOrigin, omega_deg_s(), Return angular speed for each tick, with ``nan`` at index zero.      Prefers t, Return angular speed for each tick, with ``nan`` at index zero.      The pitch, Resolved ray/ballistic origin (world domain) for one export.      Mirrors the, Resolve the eye world base and sim->world scale for ``epsilon_deg``/``on_target`, resolve_eye_origin(), _assert_relative_parity() (+29 more)

### Community 27 - "Community 27"
Cohesion: 0.11
Nodes (18): createDrillMetricRegistry(), closeHistoryApiState(), createHistoryApiMiddleware(), createHistoryApiState(), historyPlugin(), mountHistoryApi(), resolveRoot(), bootDevServer() (+10 more)
...
Cohesion: 0.13
Nodes (17): bearingDeg(), buildTicks(), payloadFor(), targetAt(), buildTicks(), payloadFor(), scoredTickMs(), shotEvents() (+9 more)
...
Cohesion: 0.13
Nodes (20): detect_samples(), Derive ``t_detect`` / ``eccentricity_at_spawn`` for every peek, TS-parity by con, build_payload(), generate_all(), main(), Generate the committed Python side of the T1 t_detect parity gate (WP-30).  Fixt, _detect_payload(), test_all_committed_detect_parity_payloads_match_python_generator() (+12 more)
...
Cohesion: 0.19
Nodes (18): payload(), aimForward(), angularEccentricityDeg(), clamp(), derivePresentation(), derivePresentationSamples(), finite(), hitboxFromMeta() (+10 more)
...
Cohesion: 0.28
Nodes (10): payloadWithEyeZ(), recordTicks(), checkTrackingStimulusFidelity(), recoverSightline(), createTrackingTrajectory(), deliveredRms2d(), makeSample(), project() (+2 more)
...
- **Why does `counter()` connect `Community 48` to `Community 11`, `Community 22`?**
  _High betweenness centrality (0.337) - this node is a cross-community bridge._
- **Why does `_fixture_report()` connect `Community 11` to `Community 48`, `Community 45`, `Community 6`?**
  _High betweenness centrality (0.241) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 6` to `Community 3`, `Community 11`, `Community 18`, `Community 40`, `Community 41`, `Community 42`, `Community 172`, `Community 173`, `Community 48`, `Community 54`, `Community 65`, `Community 99`, `Community 100`, `Community 120`, `Community 121`, `Community 122`, `Community 123`, `Community 124`, `Community 125`?**
