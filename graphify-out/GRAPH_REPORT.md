...
## Corpus Check
- 523 files · ~901,499 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4074 nodes · 9648 edges · 249 communities (207 shown, 42 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 1192 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `302dfedf`
...
Cohesion: 0.06
Nodes (61): round(), simulatePurePunchPattern(), toPatternShot(), buttonCss(), createNumberInput(), drawGrid(), drawPattern(), maxSpreadRadiusDeg() (+53 more)
...
Cohesion: 0.06
Nodes (43): qualityGateStatusForPayload(), buildCompatibilityKey(), buildSensitivityFovKey(), checkCompatibility(), checkQualityGate(), deriveSessionId(), requireBoolean(), requireNonNegativeFiniteNumber() (+35 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (30): consume(), createInputSampler(), advanceUntilTracer(), createCamera(), createTarget(), fireOne(), runAtFrames(), isDrivenMotion() (+22 more)
...
Cohesion: 0.08
Nodes (38): createDrillRunner(), setup(), runCadenceTimeoutExport(), runTimeoutOnly(), runTimeoutOnly(), createSimLoop(), canonicalRun(), runFrames() (+30 more)
...
Cohesion: 0.08
Nodes (47): resolveTargetHitbox(), pushTarget(), createPointerLock(), createSceneManagerWithStatus(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), average() (+39 more)
...
Cohesion: 0.1
Nodes (28): createDataRecorder(), buildExportPayload(), capacityForDrill(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), cameraLookingDownZ(), driveRenderAndSim() (+20 more)
...
Cohesion: 0.08
Nodes (11): createHistoryAnalysisService(), createSemaphore(), realRegistry(), createHistoryClient(), HistoryClientError, isErrorBody(), isRecord(), isSuccessBody() (+3 more)

### Community 23 - "Community 23"
Cohesion: 0.12
Nodes (16): targetHitboxToConfig(), makeConfig(), reversalConfig(), run(), trackingGuardConfig(), angularSizeToHitboxWidthU(), buildPeekClickTransferPilotConfig(), pilotDrillId() (+8 more)
...
Cohesion: 0.1
Nodes (11): buildLargePayload(), ReplayEffectView, createReplayPresentationSession(), resolveWeapon(), buildReplayPunchTimeline(), lerp(), resolveReplayCameraVisualState(), samplePunchDeg() (+3 more)
...
Cohesion: 0.15
Nodes (23): createHistoricalRunDetail(), makeButton(), FakeDocument, findByTag(), flatten(), readyValue(), setup(), text() (+15 more)
...
Cohesion: 0.14
Nodes (21): counterstrafe_ad_v1 drill config, D1 UI = 純 TS + DOM overlay, WP-5 fire/急停/首發 (即時狀態), WP-6 drill 控制 (DrillRunner/DrillLoader), WP-9 整合 + 計時效度驗證, M3 — 完整 drill 能端到端匯出資料 (可開始 pilot), WP-7 T6 — Exit gate (宣告 M3), compute.ts (computeMetrics 純函式) (+13 more)
...
Cohesion: 0.36
Nodes (8): beginNextProtocolCondition(), completeActiveProtocolCondition(), protocolRunningText(), setProtocolStatus(), startBrTrackingProtocol(), startProtocol(), startResolutionProtocol(), startSessionPlan()
...
- **Why does `counter()` connect `Community 8` to `Community 17`, `Community 27`?**
  _High betweenness centrality (0.371) - this node is a cross-community bridge._
- **Why does `_fixture_report()` connect `Community 17` to `Community 8`, `Community 2`, `Community 20`?**
  _High betweenness centrality (0.224) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 2` to `Community 132`, `Community 7`, `Community 8`, `Community 13`, `Community 17`, `Community 21`, `Community 157`, `Community 158`, `Community 42`, `Community 46`, `Community 58`, `Community 82`, `Community 83`, `Community 84`, `Community 89`, `Community 104`, `Community 105`, `Community 106`, `Community 113`, `Community 115`?**
