...
## Corpus Check
- 492 files · ~847,141 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3854 nodes · 9095 edges · 236 communities (200 shown, 36 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1154 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `29221824`
...
Cohesion: 0.07
Nodes (37): resolveTargetHitbox(), targetHitboxToConfig(), loadDrill(), angularSizeToHitboxWidthU(), buildPeekClickTransferPilotConfig(), pilotDrillId(), aimAt(), fireFrom() (+29 more)
...
Cohesion: 0.07
Nodes (38): downloadCSV(), downloadJSON(), downloadTextFile(), createPointerLock(), ImpactView, applyHistoryOverrides(), average(), beginNextProtocolCondition() (+30 more)
...
Cohesion: 0.09
Nodes (32): serializeJSON(), angleBetweenDeg(), anglesFromDirection(), clamp(), deriveLeadError(), finite(), interpolateState(), lerp() (+24 more)
...
Cohesion: 0.09
Nodes (20): createPresentationCoordinator(), makeMeta(), normalizeReplayRecording(), toSceneDescriptor(), fixtureRecording(), fixtureRecording(), buildLargePayload(), buildSmallPayload() (+12 more)
...
Cohesion: 0.11
Nodes (28): recordCueEvents(), recordTargetStopEvents(), recordVisibleEvents(), simStep(), cameraLookingDownZ(), driveRenderAndSim(), fireAt(), fixedClock() (+20 more)
...
Cohesion: 0.08
Nodes (10): openFullReplayFromResult(), openHistoricalRunDetail(), openHistory(), waitForHarness(), waitReplayReady(), buildFixture(), fixtureStartedAt(), makePayload() (+2 more)
...
Cohesion: 0.13
Nodes (20): createDataRecorder(), buildExportPayload(), capacityForDrill(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), aimAtPoint(), aimAtTick() (+12 more)
...
Cohesion: 0.11
Nodes (29): GateThresholds, key_state_signed(), key_velocity_xcorr(), Signed strafe key state per tick: ``D`` -> ``+1``, ``A`` -> ``-1``, both or neit, Signed Pearson r at every lag in ``[-max_lag_ticks, +max_lag_ticks]``, plus the, ``gate-v1``, frozen by WP-31 T0 on 2026-08-10 (D-31.4) before any real xcorr val, _key_events(), T2 DoD 3, proven from the source rather than by sampling inputs.      Two fact (+21 more)

### Community 33 - "Community 33"
Cohesion: 0.11
Nodes (17): collect64HzSamples(), canonicalRun(), runFrames(), snap(), syntheticInputs(), createMovementController(), run(), runBatches() (+9 more)
...
Cohesion: 0.12
Nodes (10): consume(), createInputSampler(), isDrivenMotion(), motionOffset(), offsetAt(), triangleWave(), drainAll(), drainToArray() (+2 more)
...
Cohesion: 0.15
Nodes (22): aimForward(), angularEccentricityDeg(), clamp(), derivePresentation(), eccentricitySamples(), finite(), firstSustainedDecrease(), firstTickAtOrAfter() (+14 more)
...
Cohesion: 0.18
Nodes (10): distanceForAngularHeight(), makeVariant(), speedForAngularRate(), variantId(), applyAimFixture(), canonicalSprayFrames(), collectImpacts(), createCamera() (+2 more)
...
Cohesion: 0.2
Nodes (6): createReplayPresentationSession(), resolveWeapon(), ReplayTargetView, resolveReplayTargetHitbox(), getWeapon(), isWeaponId()
...
- **Why does `counter()` connect `Community 7` to `Community 26`, `Community 5`?**
  _High betweenness centrality (0.361) - this node is a cross-community bridge._
- **Why does `_fixture_report()` connect `Community 5` to `Community 4`, `Community 7`, `Community 55`?**
  _High betweenness centrality (0.224) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 4` to `Community 3`, `Community 37`, `Community 5`, `Community 133`, `Community 7`, `Community 8`, `Community 108`, `Community 110`, `Community 111`, `Community 17`, `Community 83`, `Community 84`, `Community 150`, `Community 119`, `Community 56`, `Community 86`, `Community 151`, `Community 63`?**
