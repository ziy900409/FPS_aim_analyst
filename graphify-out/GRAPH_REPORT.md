...
## Corpus Check
- 76 files · ~109,377 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 623 nodes · 1225 edges · 41 communities (28 shown, 13 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 65 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f8f4feea`
...
Cohesion: 0.06
Nodes (37): createDataRecorder(), loadDrill(), createDrillRunner(), setup(), consume(), createInputSampler(), applyInput(), createSimLoop() (+29 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (34): collectMeta(), measureDisplayHz(), nextAnimationFrame(), normalizeOverflow(), normalizeStartedAt(), requireBackend(), requireBoolean(), requireNonEmptyString() (+26 more)
...
Cohesion: 0.12
Nodes (19): assertFinitePayload(), buildExportPayload(), downloadCSV(), downloadJSON(), downloadTextFile(), exportBasename(), formatBoolean(), formatNumber() (+11 more)

### Community 8 - "Community 8"
Cohesion: 0.17
Nodes (16): buildPeekWindows(), coefficientOfVariation(), computeMetrics(), computeSwitchTimes(), computeVisibleIntervals(), finiteValues(), stat(), classifyResidualSpeed() (+8 more)

### Community 9 - "Community 9"
Cohesion: 0.21
Nodes (17): createRecoilState(), hybridDecay(), recoilOnFire(), recoilTick(), resetRecoilState(), round(), simulateAk47TenShot(), toShotSnapshot() (+9 more)
...
- **Why does `規格書 v1.1 + WBS` connect `Community 12` to `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 16`, `Community 19`?**
