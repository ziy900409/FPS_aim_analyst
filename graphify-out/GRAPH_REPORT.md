...
## Corpus Check
- 296 files · ~513,226 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2642 nodes · 5983 edges · 174 communities (145 shown, 29 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 922 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5c82bfc5`
...
Cohesion: 0.08
Nodes (31): createDrillRunner(), setup(), brInputs(), createCamera(), runBrVariant(), canonicalRun(), runFrames(), snap() (+23 more)
...
Cohesion: 0.08
Nodes (15): consume(), createInputSampler(), ImpactView, drainAll(), drainToArray(), snapshot(), createBulletArena(), createImpactRing() (+7 more)
...
Cohesion: 0.15
Nodes (35): collectMeta(), measureDisplayHz(), measureDisplayRefresh(), nextAnimationFrame(), normalizeOverflow(), normalizeStartedAt(), requireBackend(), requireBoolean() (+27 more)

### Community 17 - "Community 17"
Cohesion: 0.11
Nodes (29): createPointerLock(), isOutsideCorridor(), activeWeaponConfig(), beginNextProtocolCondition(), buildCurrentExportPayload(), buildSimLoop(), completeActiveProtocolCondition(), currentMouseGain() (+21 more)
...
Cohesion: 0.14
Nodes (17): createSimLoop(), collectImpacts(), collectTracers(), createCamera(), createTargetManagerStub(), makeTarget(), runProjectile(), runWeapon() (+9 more)
...
Cohesion: 0.17
Nodes (16): spawnBullet(), applyInput(), ballisticRaycast(), composeProjectileRay(), fireOneShot(), projectMissOntoEngagementPlane(), scheduleFire(), spawnProjectile() (+8 more)
...
Cohesion: 0.13
Nodes (12): collect64HzSamples(), recordVisibleEvents(), simStep(), advanceUntilTracer(), createCamera(), createTarget(), fireOne(), runAtFrames() (+4 more)
...
Cohesion: 0.17
Nodes (20): EyeOrigin, _finite_scalar(), _finite_vec3(), _meta_eye_origin(), Resolved ray/ballistic origin (world domain) for one export.      Mirrors the, Resolve the eye world base and sim->world scale for ``epsilon_deg``/``on_target`, resolve_eye_origin(), _meta() (+12 more)
...
Cohesion: 0.19
Nodes (16): _aim_forward(), _column(), _finite_column(), _geometry(), _hitbox(), OmegaResult, on_target(), _positive_scalar() (+8 more)
...
Cohesion: 0.14
Nodes (15): _can_smooth(), _finalize(), _is_locally_uniform(), _peak_omega(), phase_table(), PhaseSample, REC/MR/V phase decomposition (WP-30 / T2, FR-D11).  ``phase-v1`` answers "which, Batch :func:`phase_decompose` over every peek of one export into one row-per-pee (+7 more)
...
Cohesion: 0.28
Nodes (10): firstBulletSuppression(), generateRecoilTable(), lerp(), requireFinite(), validateParams(), createRan1(), randomFloat(), baseClock() (+2 more)
...
Cohesion: 0.21
Nodes (9): _finite_non_negative(), _finite_positive(), _ratio(), Submovement segmentation for 128 Hz angular-speed traces., Pre-registered segmentation parameters; changes require a new version., Pre-registered segmentation parameters; changes require a new version., SegmentParams, test_segment_params_reject_invalid_contracts() (+1 more)
...
Cohesion: 0.27
Nodes (6): buildPeekWindows(), computeCurveMetrics(), computePhaseMetrics(), computePromotedMetrics(), computeSyncMetrics(), sortedTicks()
...
Cohesion: 0.25
Nodes (9): DetectSample, One presentation's detection derivation. Mirrors TS ``DetectionPresentationDeriv, PeekWindow, One ``[visible, next visible)`` presentation window in measurement time., One ``[visible, next visible)`` presentation window in measurement time., PhaseParams, Pre-registered ``phase-v1`` parameters; changes require a new version (D-30.4)., test_phase_params_reject_invalid_contracts() (+1 more)
...
- **Why does `counter()` connect `Community 6` to `Community 3`, `Community 84`?**
  _High betweenness centrality (0.328) - this node is a cross-community bridge._
- **Why does `_fixture_report()` connect `Community 3` to `Community 1`, `Community 14`, `Community 6`?**
  _High betweenness centrality (0.201) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 1` to `Community 0`, `Community 3`, `Community 68`, `Community 69`, `Community 102`, `Community 39`, `Community 4`, `Community 6`, `Community 76`, `Community 108`, `Community 78`, `Community 15`, `Community 81`, `Community 56`, `Community 24`, `Community 59`, `Community 92`, `Community 57`?**
