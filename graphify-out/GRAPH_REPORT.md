...
## Corpus Check
- 694 files · ~1,406,213 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5379 nodes · 13459 edges · 300 communities (258 shown, 42 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1732 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7d26fb0d`
...
## Communities (300 total, 42 thin omitted)
...
Cohesion: 0.06
Nodes (51): createDrillRunner(), makeConfig(), reversalConfig(), run(), setup(), setupArmed(), trackingGuardConfig(), v8SpawnTrace() (+43 more)
...
Cohesion: 0.08
Nodes (39): resolveTargetHitbox(), targetHitboxToConfig(), loadDrill(), aimAt(), fireFrom(), pushTarget(), buildRoundTripPayload(), activeSides() (+31 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (58): createPointerLock(), createRenderLoop(), lerp(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), average(), beginNextProtocolCondition() (+50 more)
...
Cohesion: 0.05
Nodes (30): consume(), createInputSampler(), canonicalRun(), runFrames(), snap(), syntheticInputs(), advanceUntilTracer(), createCamera() (+22 more)
...
Cohesion: 0.07
Nodes (27): createDataRecorder(), FakeSettingsDocument, wireSettingsToRecorder(), buildExportPayload(), capacityForDrill(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain() (+19 more)
...
Cohesion: 0.08
Nodes (26): resolveSpiderShotWideV1(), requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor(), enterResearcherDrillControls(), expectYawWindowMatchesResolver() (+18 more)
...
Cohesion: 0.09
Nodes (25): makeMeta(), normalizeReplayRecording(), toSceneDescriptor(), fixtureRecording(), buildLargePayload(), buildSmallPayload(), timeFor(), buildLargePayload() (+17 more)
...
Cohesion: 0.09
Nodes (33): assertFinitePayload(), downloadCSV(), downloadJSON(), downloadTextFile(), exportBasename(), formatBoolean(), formatNumber(), formatOptionalNumber() (+25 more)
...
Cohesion: 0.12
Nodes (5): resolveDrillTimeLimitMs(), payload(), tick(), buildDeclaredWeaponByDrillId(), SessionProgramCompileError

### Community 22 - "Community 22"
Cohesion: 0.08
Nodes (18): createDrillOverview(), makeButton(), createHistoryLibraryController(), historyRunSummaryFromPayload(), createHistoryScreen(), makeButton(), createParticipantBrowser(), makeButton() (+10 more)
...
Cohesion: 0.09
Nodes (22): aimFor(), makeV3Payload(), pointFor(), widePayload(), payloadWithEyeZ(), recordTicks(), bearingDeg(), buildTicks() (+14 more)
...
Cohesion: 0.09
Nodes (22): deriveBrakingSamples(), baseMeta(), payload(), deriveCounterstrafeMetrics(), sidedStat(), buildHitboxAtTick(), deriveHoldClickMetrics(), firstTickAtOrAfter() (+14 more)

### Community 27 - "Community 27"
Cohesion: 0.1
Nodes (28): fixedClock(), fixedClock(), firstBulletSuppression(), generateRecoilTable(), lerp(), requireFinite(), validateParams(), createRan1() (+20 more)
...
Cohesion: 0.12
Nodes (27): point(), deriveProjectedFootprint(), footprintSpread(), nonNegativeFinite(), positiveFinite(), projectedSphereFootprint(), readResolvedFovDegVertical(), offAxisDeg() (+19 more)
...
Cohesion: 0.14
Nodes (21): parseEvents(), parseExportPayload(), parseTicks(), expectOk(), walk(), collectFiles(), load(), loadManifest() (+13 more)
...
Cohesion: 0.13
Nodes (19): renderTrackingPilotReportHtml(), collectFiles(), load(), main(), stimulusCheck(), formatTrackingDeliveredAngles(), formatTrackingFrozenCrosshairRatio(), evaluateCell() (+11 more)
...
Cohesion: 0.11
Nodes (24): PeekWindow, One ``[visible, next visible)`` presentation window in measurement time., One ``[visible, next visible)`` presentation window in measurement time., bins_at_or_below_fc(), _compute_traced(), _degenerate(), _finalize(), SPARC spectral-arc-length smoothness (WP-31 / T1, FR-D13).  ``sparc-v1`` answe (+16 more)
...
Cohesion: 0.13
Nodes (11): runControl(), classifyResidualSpeed(), runResultAction(), action(), diagnosisMetricIds(), FakeDocument, flatten(), metricIds() (+3 more)
...
Cohesion: 0.13
Nodes (11): createPresentationCoordinator(), fixtureRecording(), createReplayPresentationSession(), resolveWeapon(), build(), _extend_ticks(), main(), _mouse_samples() (+3 more)
...
Cohesion: 0.16
Nodes (7): brInputs(), createCamera(), runBrVariant(), feedInputs(), runStep(), getWeapon(), resolveActiveWeapon()
...
Cohesion: 0.18
Nodes (12): build_parity_payload(), _eye_origin_to_json(), _is_finite_number(), main(), Generate the committed Python side of the T2 epsilon parity gate., Derive presentation metrics using only Python research functions., Derive presentation metrics using only Python research functions.      KI-004/, Mirror TS ``ResolvedEyeOrigin`` JSON shape so `actual.options` deep-equals this (+4 more)
...
Cohesion: 0.26
Nodes (7): canonicalExportJSON(), canonicalizeValue(), metaWith(), minimalMeta(), minimalPayload(), payloadWithEvents(), payloadWithTargets()
...
- **Why does `bool()` connect `Community 83` to `Community 65`, `Community 2`, `Community 36`, `Community 70`, `Community 59`, `Community 10`, `Community 77`, `Community 82`, `Community 155`, `Community 63`, `Community 31`?**
  _High betweenness centrality (0.282) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 2` to `Community 10`, `Community 15`, `Community 145`, `Community 146`, `Community 147`, `Community 154`, `Community 155`, `Community 30`, `Community 176`, `Community 48`, `Community 59`, `Community 63`, `Community 65`, `Community 198`, `Community 199`, `Community 72`, `Community 83`, `Community 91`, `Community 120`, `Community 121`, `Community 125`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 36` to `Community 83`?**
