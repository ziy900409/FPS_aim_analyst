...
## Corpus Check
- 585 files · ~1,034,542 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4424 nodes · 10724 edges · 275 communities (236 shown, 39 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 1306 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d065a743`
...
Cohesion: 0.06
Nodes (38): resolveTargetHitbox(), targetHitboxToConfig(), loadDrill(), angularSizeToHitboxWidthU(), buildPeekClickTransferPilotConfig(), pilotDrillId(), aimAt(), fireFrom() (+30 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (42): createDataRecorder(), capacityForDrill(), createSimLoop(), payloadWithStopTransitions(), brInputs(), createCamera(), runBrVariant(), canonicalLongrangeFrames() (+34 more)
...
Cohesion: 0.07
Nodes (35): createDrillRunner(), setup(), runCadenceTimeoutExport(), runTimeoutOnly(), runTimeoutOnly(), measureAtEye(), canonicalRun(), runFrames() (+27 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (42): assessmentProtocolVersionForDrill(), createPointerLock(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), beginNextProtocolCondition(), buildCurrentExportPayload(), buildSimLoop() (+34 more)
...
Cohesion: 0.09
Nodes (21): payload(), tick(), buildCounterstrafeReversalPilotConfigs(), buildHoldClickPilotConfigs(), buildHoldTrackPilotConfigs(), buildPeekClickTransferPilotConfigs(), buildPeekClickTransferPilotV2Configs(), buildSpiderShotPilotConfigs() (+13 more)

### Community 15 - "Community 15"
Cohesion: 0.08
Nodes (14): reparse(), createHistoryClient(), HistoryClientError, isErrorBody(), isRecord(), isSuccessBody(), createHistoryLibraryController(), historyRunSummaryFromPayload() (+6 more)

### Community 16 - "Community 16"
Cohesion: 0.12
Nodes (30): round(), simulatePurePunchPattern(), toPatternShot(), simulatePattern(), createRecoilState(), hybridDecay(), recoilOnFire(), recoilTick() (+22 more)
...
Cohesion: 0.12
Nodes (35): load_export(), Read and validate one schema v2 JSON export., Read and validate one schema v2 JSON export., Read and validate one schema v2 JSON export., _keys_for_tick(), make_synthetic_export(), _profile(), Deterministic schema v2 synthetic export generation.  No clock or random sourc (+27 more)
...
Cohesion: 0.14
Nodes (17): resolveSpiderShotWideV1(), requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor(), aimAtCenterTarget(), canonicalWideFrames() (+9 more)

### Community 37 - "Community 37"
Cohesion: 0.13
Nodes (26): _aim_forward(), _column(), epsilon_deg(), _finite_column(), _finite_scalar(), _geometry(), _hitbox(), on_target() (+18 more)
...
Cohesion: 0.11
Nodes (16): makeConfig(), reversalConfig(), run(), trackingGuardConfig(), activeTargets(), angularSeparationDeg(), collectReplacementTrace(), direction() (+8 more)
...
Cohesion: 0.19
Nodes (18): aggregate(), aggregatePresentationMetric(), aggregateScalar(), aggregateSidedMetric(), aggregateSpiderMetric(), evaluateDiagnosis(), evidence(), match() (+10 more)
...
- **Why does `counter()` connect `Community 39` to `Community 25`, `Community 12`?**
  _High betweenness centrality (0.334) - this node is a cross-community bridge._
- **Why does `_fixture_report()` connect `Community 12` to `Community 20`, `Community 6`, `Community 39`?**
  _High betweenness centrality (0.235) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 6` to `Community 4`, `Community 132`, `Community 9`, `Community 12`, `Community 17`, `Community 155`, `Community 37`, `Community 39`, `Community 45`, `Community 176`, `Community 177`, `Community 69`, `Community 101`, `Community 111`, `Community 112`, `Community 122`, `Community 124`, `Community 125`, `Community 126`, `Community 127`?**
