...
## Corpus Check
- 468 files · ~779,184 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3679 nodes · 8661 edges · 219 communities (185 shown, 34 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1111 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3efbe521`
...
Cohesion: 0.06
Nodes (72): fail(), isRecord(), parseAdsEvent(), parseAim(), parseArray(), parseAssessmentMeta(), parseBoolean(), parseCounterEvent() (+64 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (60): assertFinitePayload(), downloadCSV(), downloadJSON(), downloadTextFile(), exportBasename(), formatBoolean(), formatNumber(), formatOptionalNumber() (+52 more)
...
Cohesion: 0.08
Nodes (29): resolveTargetHitbox(), targetHitboxToConfig(), loadDrill(), aimAt(), fireFrom(), pushTarget(), activeSides(), assertFiniteEnvelope() (+21 more)
...
Cohesion: 0.09
Nodes (29): createDataRecorder(), buildExportPayload(), capacityForDrill(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), createSimLoop(), cameraLookingDownZ() (+21 more)
...
Cohesion: 0.08
Nodes (32): createDrillRunner(), makeConfig(), reversalConfig(), run(), setup(), runCadenceTimeoutExport(), runTimeoutOnly(), canonicalLongrangeFrames() (+24 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (41): ⑩ One-line "why this metric is absent" notes for blocked-by-data P2 diagnostics., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., _render_diagnostics_gaps(), _render_flags(), render_html() (+33 more)
...
Cohesion: 0.08
Nodes (23): consume(), createInputSampler(), advanceUntilTracer(), createCamera(), createTarget(), fireOne(), runAtFrames(), createMovementController() (+15 more)

### Community 18 - "Community 18"
Cohesion: 0.09
Nodes (37): createPointerLock(), activeWeaponConfig(), applyHistoryOverrides(), beginNextProtocolCondition(), buildCurrentExportPayload(), buildSimLoop(), completeActiveProtocolCondition(), currentMouseGain() (+29 more)
...
Cohesion: 0.13
Nodes (17): buildHitShotSeqs(), buildSpiderShotV2ConditionCell(), median(), projectSpiderShotV2(), qualityGateStatusForPayload(), roundTo(), toTrendCompatibilityKey(), validDurationMs() (+9 more)
...
Cohesion: 0.15
Nodes (11): createDrillMetricRegistry(), closeHistoryApiState(), createHistoryApiMiddleware(), createHistoryApiState(), historyPlugin(), mountHistoryApi(), resolveRoot(), bootDevServer() (+3 more)

### Community 44 - "Community 44"
Cohesion: 0.22
Nodes (16): canonicalExportJSON(), canonicalizeValue(), buildIdentitySegment(), buildRunFilename(), buildRunId(), buildRunIdentity(), isLexicallyContained(), sanitizeSegmentPrefix() (+8 more)
...
Cohesion: 0.23
Nodes (17): deriveHoldClickMetrics(), deriveTrackingMetrics(), average(), buildResultPresentation(), createResultSummary(), diagnosisForPayload(), diagnosisInputsForPayload(), formatNumber() (+9 more)

### Community 58 - "Community 58"
Cohesion: 0.18
Nodes (13): collectImpacts(), collectTracers(), createCamera(), createTargetManagerStub(), makeTarget(), runProjectile(), runWeapon(), pushEvent() (+5 more)
...
Cohesion: 0.14
Nodes (14): generate(), main(), Write exactly one self-contained HTML report and return its path., Write exactly one self-contained HTML report and return its path., Write exactly one self-contained HTML report and return its path., Write exactly one self-contained HTML report and return its path., Write exactly one self-contained HTML report and return its path., generate_all() (+6 more)
...
- **Why does `counter()` connect `Community 11` to `Community 16`, `Community 122`?**
  _High betweenness centrality (0.358) - this node is a cross-community bridge._
- **Why does `_fixture_report()` connect `Community 16` to `Community 11`, `Community 6`, `Community 47`?**
  _High betweenness centrality (0.225) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 6` to `Community 3`, `Community 11`, `Community 12`, `Community 141`, `Community 142`, `Community 16`, `Community 20`, `Community 36`, `Community 40`, `Community 55`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 87`, `Community 100`, `Community 103`, `Community 105`, `Community 120`?**
