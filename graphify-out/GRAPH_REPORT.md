...
## Corpus Check
- 710 files · ~1,437,961 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5455 nodes · 13654 edges · 309 communities (264 shown, 45 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1749 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5b95e48d`
...
1. `createSharedState()` - 132 edges
2. `createDataRecorder()` - 88 edges
3. `createTargetManager()` - 84 edges
4. `createSimLoop()` - 77 edges
5. `load_export()` - 74 edges
...
## Communities (309 total, 45 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (61): createDataRecorder(), createSimLoop(), cameraLookingDownZ(), driveRenderAndSim(), fireAt(), fixedClock(), makeTarget(), run() (+53 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (66): canonicalExportJSON(), createDrillRunner(), makeConfig(), reversalConfig(), run(), setup(), setupArmed(), trackingGuardConfig() (+58 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (84): canonicalizeValue(), fail(), isRecord(), parseAdsEvent(), parseAim(), parseAnnotationEvent(), parseArray(), parseAssessmentMeta() (+76 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (74): round(), simulatePurePunchPattern(), toPatternShot(), runtime(), buttonCss(), createNumberInput(), drawGrid(), drawPattern() (+66 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (44): resolveFamilyDrillId(), resolveWarmupDrillId(), findSessionPlanPreset(), compileSessionProgram(), deriveProgramFamilyOrder(), requireRestSeconds(), requireWeapon(), resolveBoundary() (+36 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (53): configWith(), angularFieldDiameterDeg(), err(), requireAngularSeparation(), requireAscendingPositiveRange(), requireAscendingRange(), requireAssessmentMode(), requireBoolean() (+45 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (64): assessmentProtocolVersionForDrill(), createRenderLoop(), lerp(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), average(), beginNextProtocolCondition() (+56 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (40): resolveTargetHitbox(), targetHitboxToConfig(), loadDrill(), angularSizeToHitboxWidthU(), buildPeekClickTransferPilotConfig(), pilotDrillId(), aimAt(), fireFrom() (+32 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (72): collectMeta(), measureDisplayHz(), measureDisplayRefresh(), nextAnimationFrame(), normalizeOverflow(), normalizeStartedAt(), requireAssessmentMeta(), requireBackend() (+64 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (30): resolveDrillTimeLimitMs(), resolveHitFeedback(), drillSourceFor(), researcherControlsDrills(), resolveAvailableDrill(), buildEndConditionByDrillId(), resolveSpiderShotWideV1(), diffFields() (+22 more)
...
Cohesion: 0.05
Nodes (24): consume(), createInputSampler(), createPausableTimeMapper(), ImpactView, drainAll(), drainToArray(), snapshot(), createBulletArena() (+16 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (34): createDrillMetricRegistry(), createHistoryAnalysisService(), createSemaphore(), realRegistry(), closeHistoryApiState(), contentLengthExceeds(), createHistoryApiMiddleware(), createHistoryApiState() (+26 more)
...
Cohesion: 0.08
Nodes (35): buildExportPayload(), serializeJSON(), degToRad(), makeRoundTripPayload(), tickTime(), yawDegAt(), aimAtPoint(), aimAtTick() (+27 more)
...
Cohesion: 0.06
Nodes (38): ⑩ One-line "why this metric is absent" notes for blocked-by-data P2 diagnostics., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., _render_diagnostics_gaps(), _render_flags(), render_html() (+30 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (38): _axis_grid(), _better(), bootstrap_f1_interval(), confusion_matrix(), _direction_change_variance(), _duration_grid(), evaluate_layers(), fit_boundary() (+30 more)

### Community 20 - "Community 20"
Cohesion: 0.09
Nodes (42): _keys_for_tick(), make_synthetic_export(), _profile(), Deterministic schema v2 synthetic export generation.  No clock or random sourc, Create a schema-faithful deterministic v2 payload without writing it to disk., Create a schema-faithful deterministic v2 payload without writing it to disk., SyntheticSpec, main() (+34 more)
...
Cohesion: 0.08
Nodes (27): aimForward(), angularDistanceDeg(), angularEccentricityDeg(), clamp(), isFiniteNumber(), radToDeg(), resolveEyeOrigin(), buildHitboxAtTick() (+19 more)
...
Cohesion: 0.1
Nodes (37): ConfusionMatrix, decide(), F1Interval, GateCheck, LayerResult, Whether the reference stage 2 rule *can* fire at a given sample spacing, and by, One (theta, window, layer, split) cell of the ablation. Every field the DoD name, A percentile bootstrap interval for F1, with the seed that produced it. (+29 more)

### Community 27 - "Community 27"
Cohesion: 0.11
Nodes (17): buildEarlyReplayFixture(), buildFixture(), fixtureStartedAt(), buildFixture(), buildFixture(), buildIdentitySegment(), buildRunFilename(), buildRunId() (+9 more)

### Community 28 - "Community 28"
Cohesion: 0.11
Nodes (12): createSceneLoadCoordinator(), defaultLoader(), disposeScene(), loadScene(), createSceneManager(), createSceneManagerWithStatus(), SceneManager, ReplaySceneAdapter (+4 more)
...
Cohesion: 0.13
Nodes (31): _can_smooth(), _finalize(), _peak_omega(), phase_decompose(), phase_table(), PhaseParams, REC/MR/V phase decomposition (WP-30 / T2, FR-D11).  ``phase-v1`` answers "which, Decompose one peek into REC/MR/V, cross-checked (not redefined) against ``t_dete (+23 more)

### Community 35 - "Community 35"
Cohesion: 0.15
Nodes (34): build_peek_windows(), _events_in_window(), _false(), _finite_number(), _first_compatible_fire(), _hit_times_by_shot(), _key(), _keys() (+26 more)
...
Cohesion: 0.11
Nodes (19): payloadWithEyeZ(), recordTicks(), bearingDeg(), buildTicks(), payloadFor(), targetAt(), buildTicks(), payloadFor() (+11 more)
...
Cohesion: 0.11
Nodes (11): FakeSettingsDocument, wireSettingsToRecorder(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), parseSpiderShot(), aimAtCenterTarget(), canonicalWideFrames() (+3 more)

### Community 48 - "Community 48"
Cohesion: 0.11
Nodes (28): _ad_key_events(), _aligned(), _bootstrap_ci(), _checked_flags(), _correlogram(), _gate_verdict(), GateVerdict, _half_agreement() (+20 more)

### Community 49 - "Community 49"
Cohesion: 0.12
Nodes (29): appendCurveBand(), appendCurveLine(), appendGuideLine(), appendPath(), countFlags(), createPromotedSummary(), createQualityFlagSummary(), createRecoilOverlayModel() (+21 more)
...
Cohesion: 0.13
Nodes (10): createPresentationCoordinator(), normalizeReplayRecording(), toSceneDescriptor(), fixtureRecording(), fixtureRecording(), downgradeForScene(), resolveSessionScene(), normalize() (+2 more)
...
Cohesion: 0.15
Nodes (18): makeMeta(), buildLargePayload(), buildSmallPayload(), timeFor(), buildLargePayload(), fixtureRecording(), renderAt(), clamp() (+10 more)
...
Cohesion: 0.12
Nodes (24): _compute_failed_flag(), _has_flags(), is_known_quality_flag(), per_segment_apply(), Per-segment computation with a closed, machine-readable quality vocabulary.  E, Summarize finite, unflagged values while counting excluded flagged rows., Summarize finite, unflagged values while counting excluded flagged rows., Return whether *flag* is an exact or templated vocabulary member. (+16 more)
...
Cohesion: 0.14
Nodes (21): detect_samples(), Derive ``t_detect`` / ``eccentricity_at_spawn`` for every peek, TS-parity by con, build_payload(), generate_all(), main(), Generate the committed Python side of the T1 t_detect parity gate (WP-30).  Fixt, _flag_counts(), generate_all() (+13 more)

### Community 67 - "Community 67"
Cohesion: 0.14
Nodes (12): createHistoryLibraryController(), historyRunSummaryFromPayload(), createHistoryNavigator(), defaultWindow(), decodeSegment(), formatHistoryHash(), historyRouteAncestors(), isHistoryHash() (+4 more)
...
Cohesion: 0.17
Nodes (11): deriveBrakingSamples(), baseMeta(), payload(), deriveCounterstrafeMetrics(), sidedStat(), payload(), tick(), deriveHoldClickMetrics() (+3 more)
...
Cohesion: 0.16
Nodes (6): TargetView, both(), moving(), only(), target(), createTargetHitRing()

### Community 92 - "Community 92"
Cohesion: 0.15
Nodes (5): capacityForDrill(), keyMaskFromKeys(), keyMaskFromState(), keysFromMask(), TickArena

### Community 93 - "Community 93"
Cohesion: 0.16
Nodes (19): ADR-2 三迴圈經 SharedState 溝通, ADR-3 精準度來源 = sub-tick 輸入時間戳, ADR-4 performance.now() / event.timeStamp 同源, ADR-5 coalesced events, getCoalescedEvents 次幀採樣 (高頻滑鼠不丟樣本), 依時序排序消費 + 排空 (決定性契約), sub-tick 輸入時間戳 (精準度真正來源), 時間戳同源 (event.timeStamp = performance.now() 基準) (+11 more)
...
Cohesion: 0.14
Nodes (6): addItem(), FakeElement, rowControl(), selectMode(), setReps(), setWeapon()
...
Cohesion: 0.15
Nodes (8): classifyResidualSpeed(), diagnosisMetricIds(), FakeDocument, flatten(), metricIds(), qualityFlagMetricIds(), section(), text()
...
Cohesion: 0.18
Nodes (17): 確定性左右交替輪替 (counter-strafe peek 節奏), t_visible (可見時間戳 / 反應時間起點), Crosshair (src/ui/Crosshair.ts), D1 UI = 純 TS + DOM overlay, WP-1 場景 (相機 / Pointer Lock), WP-2 雙迴圈骨架 (sim tick + clock + 決定性), WP-4 Progress Log, WP-4 T0 Entry gate (+9 more)
...
Cohesion: 0.23
Nodes (10): widePayload(), collectFiles(), load(), loadManifest(), main(), baseName(), parseEntry(), readLiftManifest() (+2 more)
...
Cohesion: 0.21
Nodes (7): createHistoricalRunDetail(), makeButton(), createHistoryScreen(), makeButton(), createParticipantBrowser(), makeButton(), createResultDetailBody()

### Community 126 - "Community 126"
Cohesion: 0.16
Nodes (8): firstTickIndexAtOrAfter(), hitTimesByShotSeq(), lastReleaseTransition(), releaseAnchor(), tickRangeForWindow(), deriveStopTransitions(), fireAngleError(), lastTickAtOrBefore()
...
Cohesion: 0.21
Nodes (13): key_state_signed(), Signed strafe key state per tick: ``D`` -> ``+1``, ``A`` -> ``-1``, both or neit, _key_events(), test_a_known_lag_is_recovered_within_one_tick_with_the_documented_sign(), test_an_event_beyond_the_tolerance_does_not_match(), test_an_export_without_key_events_is_an_absent_witness_not_a_disagreement(), test_key_state_signed_encodes_the_four_tick_states(), test_key_state_signed_ignores_non_strafe_keys() (+5 more)
...
Cohesion: 0.25
Nodes (5): computeCurveMetrics(), computePhaseMetrics(), computePromotedMetrics(), computeSyncMetrics(), sortedTicks()
...
Cohesion: 0.36
Nodes (7): createReplayPresentationSession(), resolveWeapon(), buildReplayPunchTimeline(), lerp(), resolveReplayCameraVisualState(), samplePunchDeg(), buildTimeline()
...
Cohesion: 0.38
Nodes (9): _detect_payload(), _only_sample(), test_both_target_sources_missing_flags_instead_of_crashing(), test_flags_detections_below_human_rt_lower_bound_as_anticipation(), test_flags_first_presentation_short_baseline_as_insufficient(), test_missing_tick_target_center_falls_back_to_visible_event(), test_recovers_known_onset_within_one_tick(), test_returns_timeout_when_no_sustained_decrease() (+1 more)
...
Cohesion: 0.67
Nodes (6): createResultSummary(), formatNumber(), formatPercent(), formatStatMean(), statCard(), summarizeResidualSpeed()
...
## Knowledge Gaps
- **434 isolated node(s):** `Assemble the spider-shot-v3 coach proposal HTML from the generated figures.`, `Emit the SVG figures for the spider-shot-v3 coach proposal.  Geometry is compu`, `Horizontal bar path: square at the baseline (x0), rounded at the value end.`, `Leftward horizontal bar: square at the baseline (x_base), rounded at the value e`, `Vertical bar path: square at the baseline (y0), rounded at the top.` (+429 more)
...
- **Why does `bool()` connect `Community 61` to `Community 33`, `Community 35`, `Community 45`, `Community 46`, `Community 48`, `Community 50`, `Community 83`, `Community 51`, `Community 22`, `Community 154`?**
  _High betweenness centrality (0.275) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 35` to `Community 144`, `Community 17`, `Community 145`, `Community 147`, `Community 20`, `Community 23`, `Community 154`, `Community 155`, `Community 42`, `Community 45`, `Community 176`, `Community 50`, `Community 51`, `Community 54`, `Community 61`, `Community 66`, `Community 203`, `Community 204`, `Community 77`, `Community 104`, `Community 112`, `Community 113`, `Community 114`, `Community 122`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 33` to `Community 61`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Are the 67 inferred relationships involving `createSharedState()` (e.g. with `createPauseRig()` and `setup()`) actually correct?**
  _`createSharedState()` has 67 INFERRED edges - model-reasoned connections that need verification._
- **Are the 46 inferred relationships involving `createDataRecorder()` (e.g. with `createPauseRig()` and `wireSettingsToRecorder()`) actually correct?**
  _`createDataRecorder()` has 46 INFERRED edges - model-reasoned connections that need verification._
