...
## Corpus Check
- 148 files · ~230,123 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1083 nodes · 2556 edges · 66 communities (50 shown, 16 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 209 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4dc772c8`
...
- `runLongrangeTracking()` --calls--> `loadDrill()`  [INFERRED]
  tests/regression/longrangeTrackingDeterminismFixture.ts → src/drill/DrillLoader.ts
...
Cohesion: 0.05
Nodes (68): createDataRecorder(), capacityForDrill(), createDrillRunner(), setup(), consume(), createInputSampler(), createSimLoop(), canonicalRun() (+60 more)
...
Cohesion: 0.1
Nodes (24): resolveTargetHitbox(), targetHitboxToConfig(), loadDrill(), activeSides(), assertFiniteEnvelope(), clipAxis(), criticalYawDegrees(), deriveTargetEnvelopes() (+16 more)
...
Cohesion: 0.15
Nodes (14): applyInput(), ballisticRaycast(), fireOneShot(), projectMissOntoEngagementPlane(), scheduleFire(), currentPeekId(), firstShotGate(), raycastFromCenter() (+6 more)
...
Cohesion: 0.42
Nodes (7): firstBulletSuppression(), generateRecoilTable(), lerp(), requireFinite(), validateParams(), createRan1(), randomFloat()
...
Cohesion: 0.6
Nodes (3): createControls(), makeButton(), makeSelect()
...
- **Why does `createDataRecorder()` connect `Community 0` to `Community 1`, `Community 18`, `Community 21`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `TickArena` connect `Community 27` to `Community 0`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `TargetView` connect `Community 23` to `Community 18`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
