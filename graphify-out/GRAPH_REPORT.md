...
## Corpus Check
- 296 files · ~514,644 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2642 nodes · 5983 edges · 173 communities (143 shown, 30 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 922 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2902f844`
...
## Communities (173 total, 30 thin omitted)
...
Cohesion: 0.08
Nodes (25): setup(), canonicalRun(), runFrames(), snap(), syntheticInputs(), ImpactView, createMovementController(), run() (+17 more)
...
Cohesion: 0.11
Nodes (22): createDrillRunner(), createSimLoop(), canonicalLongrangeFrames(), createCamera(), runLongrangeTracking(), applyAimFixture(), canonicalSprayFrames(), collectImpacts() (+14 more)
...
Cohesion: 0.15
Nodes (29): Run the three frozen ``gate-v1`` criteria per session and return one verdict eac, reliability_gate(), _block_key(), _coupled_window(), _key_events(), _keys_from_state(), _noise_window(), _peek() (+21 more)
...
Cohesion: 0.12
Nodes (13): collect64HzSamples(), recordVisibleEvents(), simStep(), advanceUntilTracer(), createCamera(), createTarget(), fireOne(), runAtFrames() (+5 more)
...
Cohesion: 0.17
Nodes (21): Session-level construct presence gate.  Complements the existing format-only gat, DtReport, Fixed-tick interval quality reporting., Uniformity report; each gap index identifies the right-hand tick row., _list(), _mapping(), _non_empty_string(), _number() (+13 more)
...
Cohesion: 0.16
Nodes (16): advanceProjectiles(), applyInput(), ballisticRaycast(), composeProjectileRay(), deactivateProjectile(), fireOneShot(), projectMissOntoEngagementPlane(), scheduleFire() (+8 more)

### Community 29 - "Community 29"
Cohesion: 0.14
Nodes (23): check_construct_presence(), ConstructReport, ConstructRule, is_known_construct_flag(), Return whether *flag* is an exact or templated vocabulary member., A drill family's core construct declaration (frozen; changes require a version b, Session-level presence verdict. ``present is None`` iff the family is unregister, Resolve *drill_id* to a registered construct family.      Strips a leading ``syn (+15 more)
...
Cohesion: 0.21
Nodes (20): omega_deg_s(), Return angular speed for each tick, with ``nan`` at index zero.      Prefers t, Return angular speed for each tick, with ``nan`` at index zero.      The pitch, _assert_relative_parity(), _gate_two_ticks(), test_epsilon_is_zero_at_target_center(), test_epsilon_recovers_known_unsigned_offset(), test_gate_two_degenerates_to_legacy_formula_when_eye_base_z_is_zero() (+12 more)
...
Cohesion: 0.16
Nodes (5): consume(), createInputSampler(), drainAll(), drainToArray(), snapshot()
...
Cohesion: 0.24
Nodes (5): raycastFromCenter(), raycastWithRay(), cameraLookingDownZ(), makeTarget(), movingSetup()
...
Cohesion: 0.29
Nodes (4): spawnBullet(), stepBullet(), clipAxis(), sweptHitTest()
...
- **Why does `counter()` connect `Community 60` to `Community 2`, `Community 12`, `Community 86`?**
  _High betweenness centrality (0.328) - this node is a cross-community bridge._
- **Why does `_fixture_report()` connect `Community 2` to `Community 1`, `Community 60`, `Community 13`?**
  _High betweenness centrality (0.201) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 68`, `Community 72`, `Community 41`, `Community 59`, `Community 107`, `Community 12`, `Community 14`, `Community 79`, `Community 80`, `Community 51`, `Community 83`, `Community 56`, `Community 57`, `Community 27`, `Community 93`?**
