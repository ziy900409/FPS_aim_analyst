...
## Corpus Check
- 679 files · ~1,352,745 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5241 nodes · 13021 edges · 300 communities (262 shown, 38 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1690 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fc605a36`
...
## Communities (300 total, 38 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (56): createDataRecorder(), createDrillRunner(), aimAt(), fireFrom(), pushTarget(), runCadenceTimeoutExport(), createSimLoop(), brInputs() (+48 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (68): round(), simulatePurePunchPattern(), toPatternShot(), buttonCss(), createNumberInput(), drawGrid(), drawPattern(), maxSpreadRadiusDeg() (+60 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (52): makeConfig(), reversalConfig(), run(), setup(), setupArmed(), trackingGuardConfig(), runCadenceTimeoutExport(), runTimeoutOnly() (+44 more)
...
Cohesion: 0.06
Nodes (51): resolveHitFeedback(), createPointerLock(), ImpactView, activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), average(), beginNextProtocolCondition() (+43 more)

### Community 5 - "Community 5"
Cohesion: 0.08
Nodes (62): collectMeta(), measureDisplayHz(), measureDisplayRefresh(), nextAnimationFrame(), normalizeOverflow(), normalizeStartedAt(), requireAssessmentMeta(), requireBackend() (+54 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (48): qualityGateStatusForPayload(), buildCompatibilityKey(), buildSensitivityFovKey(), checkCompatibility(), checkQualityGate(), deriveSessionId(), requireBoolean(), requireNonNegativeFiniteNumber() (+40 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (30): resolveTargetHitbox(), targetHitboxToConfig(), loadDrill(), measureAtEye(), buildRoundTripPayload(), activeSides(), assertFiniteEnvelope(), clipAxis() (+22 more)
...
Cohesion: 0.07
Nodes (24): consume(), createInputSampler(), both(), moving(), only(), target(), drainAll(), drainToArray() (+16 more)
...
Cohesion: 0.07
Nodes (36): buildExportPayload(), serializeJSON(), degToRad(), makeRoundTripPayload(), tickTime(), yawDegAt(), aimAtPoint(), aimAtTick() (+28 more)

### Community 13 - "Community 13"
Cohesion: 0.1
Nodes (28): enumerateLandings(), sceneWithRoom(), resolveEyeWorldBase(), err(), requireColorNumber(), requireFiniteNumber(), requireNonEmptyString(), requireNonNegativeNumber() (+20 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (37): renderTrackingPilotReportHtml(), core2x2(), makeCell(), collectFiles(), load(), main(), stimulusCheck(), formatTrackingDeliveredAngles() (+29 more)
...
Cohesion: 0.11
Nodes (39): deriveTrackingMetrics(), deriveTrackingSamples(), adaptPayloadForScoredWindow(), applySmoothing(), applySmoothingToSeries(), clamp(), computeSignedBias(), computeSignedOmegaSeries() (+31 more)
...
Cohesion: 0.09
Nodes (22): resolveFamilyDrillId(), resolveWarmupDrillId(), findSessionPlanPreset(), compileSessionProgram(), requireRestSeconds(), requireWeapon(), resolveBoundary(), SessionProgramCompileError (+14 more)
...
Cohesion: 0.08
Nodes (30): Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., render_html(), Contract tests for the one-command coach report v1 (WP-30 T-exit).  Covers the, C-D3 / GD-20: a metric without a construct gate must not appear as a number., C-D3 / GD-20: registered phase/curve constructs are labeled; SPARC/xcorr/Fitts n (+22 more)
...
Cohesion: 0.08
Nodes (9): realRegistry(), createHistoryClient(), isErrorBody(), isRecord(), isSuccessBody(), createHistoryLibraryController(), historyRunSummaryFromPayload(), createHistoryPersistence() (+1 more)
...
Cohesion: 0.09
Nodes (36): _ads_label(), _advanced_diagnostics(), _delta(), _epsilon_or_none(), _finite(), _fitts_block(), _gap_text(), _group_key() (+28 more)

### Community 43 - "Community 43"
Cohesion: 0.1
Nodes (24): requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor(), deriveProjectedFootprint(), footprintSpread(), nonNegativeFinite() (+16 more)
...
Cohesion: 0.09
Nodes (16): collectImpacts(), collectTracers(), createCamera(), createTargetManagerStub(), makeTarget(), runProjectile(), runWeapon(), spiderEyePolarPos() (+8 more)
...
Cohesion: 0.17
Nodes (19): parseEvents(), parseExportPayload(), parseTicks(), collectFiles(), load(), loadManifest(), main(), isInstructionClass() (+11 more)
...
Cohesion: 0.14
Nodes (8): assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), aimAtCenterTarget(), canonicalWideFrames(), createCamera(), runWide(), wideDrillConfig()
...
Cohesion: 0.15
Nodes (16): buildLargePayload(), buildSmallPayload(), timeFor(), buildLargePayload(), renderAt(), clamp(), createReplayPlayer(), clamp() (+8 more)

### Community 73 - "Community 73"
Cohesion: 0.12
Nodes (9): capacityForDrill(), keyMaskFromKeys(), keyMaskFromState(), keysFromMask(), TickArena, bearingDeg(), buildTicks(), payloadFor() (+1 more)
...
Cohesion: 0.2
Nodes (16): drillSourceFor(), researcherControlsDrills(), resolveAvailableDrill(), baseTargets(), buildTrackingCorePrPilotV1Cell(), corePrPilotV1DrillId(), cubeHitbox(), scoredTiming() (+8 more)
...
Cohesion: 0.19
Nodes (12): deriveUnlockedIntervals(), overlapsAny(), segmentByTimeGap(), extractAnnotationIntervals(), deriveSamplingHealth(), countDetected(), fmt(), formatSpiderWideRepositioningSummary() (+4 more)
...
Cohesion: 0.13
Nodes (6): HistoryClientError, createPresentationCoordinator(), createReplayController(), downgradeForScene(), resolveSessionScene(), resolveReplaySceneConfig()
...
Cohesion: 0.19
Nodes (9): punchToThreeRad(), createReplayPresentationSession(), resolveWeapon(), buildReplayPunchTimeline(), lerp(), resolveReplayCameraVisualState(), samplePunchDeg(), buildTimeline() (+1 more)

### Community 98 - "Community 98"
Cohesion: 0.16
Nodes (3): createRenderLoop(), lerp(), TargetView
...
Cohesion: 0.18
Nodes (18): ADR-2 三迴圈經 SharedState 溝通, ADR-3 精準度來源 = sub-tick 輸入時間戳, ADR-4 performance.now() / event.timeStamp 同源, ADR-5 coalesced events, getCoalescedEvents 次幀採樣 (高頻滑鼠不丟樣本), sub-tick 輸入時間戳 (精準度真正來源), 時間戳同源 (event.timeStamp = performance.now() 基準), t_visible 在 sim tick 內蓋一次 (非 render frame) (+10 more)
...
- **Why does `bool()` connect `Community 86` to `Community 70`, `Community 9`, `Community 105`, `Community 78`, `Community 23`, `Community 55`, `Community 54`, `Community 87`, `Community 151`, `Community 58`, `Community 59`, `Community 30`?**
  _High betweenness centrality (0.288) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 105` to `Community 137`, `Community 138`, `Community 139`, `Community 9`, `Community 141`, `Community 140`, `Community 142`, `Community 17`, `Community 19`, `Community 149`, `Community 23`, `Community 151`, `Community 26`, `Community 31`, `Community 50`, `Community 55`, `Community 58`, `Community 59`, `Community 194`, `Community 85`, `Community 86`, `Community 112`, `Community 116`, `Community 119`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 30` to `Community 86`?**
