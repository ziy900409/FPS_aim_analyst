# Graph Report - FPS_aim_analyst  (2026-07-05)

## Corpus Check
- 78 files · ~110,151 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 635 nodes · 1253 edges · 44 communities (29 shown, 15 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 68 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `790a85cc`
...
Cohesion: 0.05
Nodes (45): createDataRecorder(), loadDrill(), createDrillRunner(), setup(), consume(), createInputSampler(), createPointerLock(), applyInput() (+37 more)
...
Cohesion: 0.14
Nodes (26): createRecoilState(), hybridDecay(), recoilOnFire(), recoilTick(), resetRecoilState(), round(), simulateAk47TenShot(), toShotSnapshot() (+18 more)
...
Cohesion: 0.2
Nodes (6): createRenderLoop(), lerp(), createControls(), makeButton(), createExportPanel(), makeButton()
...
- **Why does `規格書 v1.1 + WBS` connect `Community 10` to `Community 9`, `Community 11`, `Community 12`, `Community 13`, `Community 16`, `Community 21`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `D1 UI = 純 TS + DOM overlay` connect `Community 3` to `Community 2`?**
