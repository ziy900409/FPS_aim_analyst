...
## Corpus Check
- 130 files · ~187,155 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 966 nodes · 2143 edges · 61 communities (45 shown, 16 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 153 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fe8aae20`
...
7. `createDataRecorder()` - 17 edges
8. `collectMeta()` - 17 edges
...
Cohesion: 0.06
Nodes (34): createDrillRunner(), createPointerLock(), createRenderLoop(), lerp(), createRenderer(), pickBackend(), resolveBackend(), ImpactView (+26 more)

### Community 1 - "Community 1"
Cohesion: 0.08
Nodes (39): loadDrill(), canonicalRun(), runFrames(), snap(), syntheticInputs(), activeSides(), assertFiniteEnvelope(), clipAxis() (+31 more)
...
Cohesion: 0.09
Nodes (34): buildIdealPath(), buildPeekWindows(), coefficientOfVariation(), compensationError(), computeMetrics(), computeRecoilCompensationError(), computeRecoilCompensationPath(), computeSwitchTimes() (+26 more)
...
Cohesion: 0.1
Nodes (27): createDataRecorder(), assertFinitePayload(), buildExportPayload(), downloadCSV(), downloadJSON(), downloadTextFile(), exportBasename(), formatBoolean() (+19 more)
...
Cohesion: 0.18
Nodes (11): setup(), createSimLoop(), createTargetManager(), collectImmediateSpawns(), killSequence(), runDrill(), createSharedState(), baseClock() (+3 more)
...
Cohesion: 0.2
Nodes (12): collect64HzSamples(), recordVisibleEvents(), simStep(), cameraLookingDownZ(), fireAt(), makeTarget(), meanSpreadRadius(), run() (+4 more)

### Community 19 - "Community 19"
Cohesion: 0.15
Nodes (8): pushEvent(), canonicalTrajectory(), freshState(), runFrames(), snap(), syntheticInputs(), canonicalFire(), runFire()
...
- **Why does `createSharedState()` connect `Community 13` to `Community 32`, `Community 1`, `Community 34`, `Community 35`, `Community 2`, `Community 7`, `Community 14`, `Community 15`, `Community 18`, `Community 19`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `createSimLoop()` connect `Community 13` to `Community 0`, `Community 1`, `Community 2`, `Community 35`, `Community 14`, `Community 18`, `Community 19`, `Community 31`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `CameraController` connect `Community 29` to `Community 0`?**
