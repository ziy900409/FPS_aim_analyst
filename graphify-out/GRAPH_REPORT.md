...
## Corpus Check
- 658 files · ~1,260,662 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4872 nodes · 12056 edges · 284 communities (241 shown, 43 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 1485 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `63d31876`
...
## Communities (284 total, 43 thin omitted)
...
Cohesion: 0.06
Nodes (56): createPointerLock(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), average(), beginNextProtocolCondition(), buildSimLoop(), completeActiveProtocolCondition() (+48 more)
...
Cohesion: 0.08
Nodes (30): loadDrill(), createDrillRunner(), measureAtEye(), brInputs(), createCamera(), runBrVariant(), canonicalLongrangeFrames(), createCamera() (+22 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (31): angularSizeToHitboxWidthU(), buildPeekClickTransferPilotConfig(), aimAt(), fireFrom(), runCadenceTimeoutExport(), runTimeoutOnly(), buildPeekClickTransferPilotV2Config(), runCadenceTimeoutExport() (+23 more)

### Community 8 - "Community 8"
Cohesion: 0.09
Nodes (14): assessmentProtocolVersionForDrill(), pilotDrillId(), buildPeekClickTransferPilotV2MaskedConfig(), buildPeekClickTransferPilotV2RandomizedConfig(), peekClickTransferPilotV2CandidateLabel(), pilotV2DrillId(), buildCounterstrafeReversalPilotConfigs(), buildHoldClickPilotConfigs() (+6 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (27): createDataRecorder(), buildExportPayload(), capacityForDrill(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), degToRad(), makeRoundTripPayload() (+19 more)
...
Cohesion: 0.07
Nodes (30): createSimLoop(), advanceUntilTracer(), createCamera(), createTarget(), fireOne(), runAtFrames(), collectImpacts(), collectTracers() (+22 more)
...
Cohesion: 0.07
Nodes (20): consume(), createInputSampler(), canonicalRun(), runFrames(), snap(), syntheticInputs(), ImpactView, drainAll() (+12 more)
...
Cohesion: 0.09
Nodes (18): widePayload(), makeMeta(), makePayload(), makeTick(), normalizeReplayRecording(), toSceneDescriptor(), fixtureRecording(), fixtureRecording() (+10 more)
...
Cohesion: 0.08
Nodes (23): buildTrackingCompatibilityKey(), checkTrackingCompatibility(), requireAscendingRange(), requirePositiveFiniteNumber(), requireTrackingTrajectorySummary(), requireTrimmedNonEmptyString(), createTrackingPilotSession(), FakeDocument (+15 more)
...
Cohesion: 0.1
Nodes (8): createSceneLoadCoordinator(), defaultLoader(), disposeScene(), loadScene(), createSceneManager(), createSceneManagerWithStatus(), SceneManager, ReplaySceneAdapter
...
Cohesion: 0.07
Nodes (21): SessionProgramCompileError, summarizeProgram(), describeBoundary(), createRestOverlay(), FakeDocument, FakeElement, createSessionPlanSetup(), describeStep() (+13 more)
...
Cohesion: 0.13
Nodes (21): enumerateLandings(), sceneWithRoom(), err(), requireColorNumber(), requireFiniteNumber(), requireNonEmptyString(), requireNonNegativeNumber(), requireObject() (+13 more)
...
Cohesion: 0.12
Nodes (19): createRan1(), angularSeparationDeg(), centerRelativeDirection(), minimumActiveSeparationDeg(), centerRelativeAngularSeparationDeg(), copyPos(), fixedClock(), inspectV8Population() (+11 more)
...
Cohesion: 0.12
Nodes (13): createControls(), makeButton(), makeSelect(), makeToggle(), FakeDocument, FakeElement, createHUD(), createHUDStats() (+5 more)
...
Cohesion: 0.18
Nodes (13): deriveUnlockedIntervals(), overlapsAny(), segmentByTimeGap(), extractAnnotationIntervals(), deriveSamplingHealth(), bool(), countDetected(), fmt() (+5 more)
...
Cohesion: 0.18
Nodes (16): buildCompatibilityKey(), buildSensitivityFovKey(), checkCompatibility(), checkQualityGate(), deriveSessionId(), requireBoolean(), requireNonNegativeFiniteNumber(), requireNonNegativeInteger() (+8 more)
...
Cohesion: 0.2
Nodes (14): measureDisplayHz(), measureDisplayRefresh(), nextAnimationFrame(), resolveTargetHitbox(), targetHitboxToConfig(), pushTarget(), buildRoundTripPayload(), resolveEyeWorldBase() (+6 more)
...
Cohesion: 0.24
Nodes (8): Export, Validated export data prepared for offline analysis., Validated export data prepared for offline analysis., Validated export data prepared for offline analysis., Validated export data prepared for offline analysis., _export(), test_parity_payload_is_json_ready_and_records_final_end_as_null(), test_timeline_metrics_uses_visible_denominator_and_requires_both_alignment_anchors()
...
Cohesion: 0.39
Nodes (4): buildLiftSegmentationGolden(), lastSampleMs(), segmentationAt(), verifyLiftSegmentationGolden()
...
- **Why does `bool()` connect `Community 72` to `Community 64`, `Community 3`, `Community 10`, `Community 11`, `Community 13`, `Community 141`, `Community 48`, `Community 53`, `Community 57`, `Community 126`, `Community 31`?**
  _High betweenness centrality (0.256) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 3` to `Community 128`, `Community 129`, `Community 130`, `Community 131`, `Community 137`, `Community 138`, `Community 10`, `Community 140`, `Community 141`, `Community 13`, `Community 19`, `Community 29`, `Community 164`, `Community 48`, `Community 53`, `Community 55`, `Community 185`, `Community 186`, `Community 72`, `Community 78`, `Community 110`, `Community 127`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `counter()` connect `Community 53` to `Community 19`, `Community 37`?**
