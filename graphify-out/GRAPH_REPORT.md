# Graph Report - FPS_aim_analyst  (2026-08-05)

## Corpus Check
- 213 files · ~303,213 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1477 nodes · 3395 edges · 96 communities (68 shown, 28 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 353 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `03a7daec`
...
7. `load_export()` - 23 edges
8. `createDrillRunner()` - 22 edges
9. `collectMeta()` - 21 edges
10. `規格書 v1.1 + WBS` - 21 edges
...
Cohesion: 0.05
Nodes (67): check_dt(), DtReport, Fixed-tick interval quality reporting., Uniformity report; each gap index identifies the right-hand tick row., Compare adjacent tick times with ``1000 / sim_hz`` using a 1e-6 ms tolerance., Pure submovement segmentation algorithms., Export, _list() (+59 more)
...
Cohesion: 0.08
Nodes (37): buildHitShotSeqs(), buildIdealPath(), buildPeekWindows(), coefficientOfVariation(), compensationError(), computeMetrics(), computeRecoilCompensationError(), computeRecoilCompensationPath() (+29 more)
...
Cohesion: 0.07
Nodes (43): _compute_failed_flag(), is_known_quality_flag(), per_segment_apply(), Per-segment computation with a closed, machine-readable quality vocabulary.  Exa, Summarize finite, unflagged values while counting excluded flagged rows., Summarize finite, unflagged values while counting excluded flagged rows., Return whether *flag* is an exact or templated vocabulary member., Return whether *flag* is an exact or templated vocabulary member. (+35 more)
...
Cohesion: 0.11
Nodes (25): defaultLoader(), disposeScene(), loadScene(), createSceneManager(), createSceneManagerWithStatus(), SceneManager, err(), requireColorNumber() (+17 more)
...
Cohesion: 0.1
Nodes (24): resolveTargetHitbox(), targetHitboxToConfig(), distanceForAngularHeight(), makeVariant(), speedForAngularRate(), variantId(), activeSides(), assertFiniteEnvelope() (+16 more)
...
Cohesion: 0.1
Nodes (18): collect64HzSamples(), recordVisibleEvents(), simStep(), cameraLookingDownZ(), fireAt(), makeTarget(), meanSpreadRadius(), run() (+10 more)

### Community 15 - "Community 15"
Cohesion: 0.14
Nodes (19): loadDrill(), createDrillRunner(), createSimLoop(), canonicalRun(), runFrames(), snap(), syntheticInputs(), canonicalLongrangeFrames() (+11 more)

### Community 16 - "Community 16"
Cohesion: 0.16
Nodes (23): createPointerLock(), activeWeaponConfig(), beginNextProtocolCondition(), buildCurrentExportPayload(), buildSimLoop(), completeActiveProtocolCondition(), exportBasename(), findSceneOption() (+15 more)
...
Cohesion: 0.17
Nodes (13): consume(), drainAll(), drainToArray(), snapshot(), createBulletArena(), createImpactRing(), createInputRing(), createShotRayRing() (+5 more)
...
Cohesion: 0.15
Nodes (12): setup(), createTargetManager(), collectImmediateSpawns(), killSequence(), motionConfig(), runDrill(), runPositions(), createSharedState() (+4 more)
...
Cohesion: 0.21
Nodes (8): createDataRecorder(), capacityForDrill(), applyAimFixture(), canonicalMovingTargetFrames(), createCamera(), runMovingTarget(), canonicalFire(), runFire()
...
Cohesion: 0.26
Nodes (14): _aim_forward(), _column(), _finite_column(), _finite_scalar(), _geometry(), _hitbox(), omega_deg_s(), on_target() (+6 more)

### Community 32 - "Community 32"
Cohesion: 0.19
Nodes (12): _Candidate, _finite_non_negative(), _finite_positive(), _merge_overlapping(), _prepare_signal(), _ratio(), Submovement segmentation for 128 Hz angular-speed traces., Pre-registered segmentation parameters; changes require a new version. (+4 more)
...
Cohesion: 0.2
Nodes (10): Segment an angular-speed trace into one primary flick and later adjustments., Segment an angular-speed trace into one primary flick and later adjustments., Segment an angular-speed trace into one primary flick and later adjustments., segment_submovements(), test_constant_motion_returns_empty_segments_with_no_peak_flag(), test_known_submovement_boundaries_are_within_two_ticks(), test_short_signal_uses_explicit_sg_fallback_flag(), test_tightly_spaced_double_peak_does_not_fragment() (+2 more)

### Community 36 - "Community 36"
Cohesion: 0.16
Nodes (10): butter_filter(), Zero-phase Butterworth low-pass filtering., Low-pass a finite one-dimensional signal without phase shift.      Invalid cutof, Savitzky-Golay smoothing with explicit input contracts., Smooth a finite one-dimensional signal.      Degenerate inputs raise :class:`Val, sg_filter(), test_butter_filter_is_zero_phase_and_attenuates_high_frequency(), test_butter_filter_rejects_degenerate_inputs() (+2 more)
...
## Knowledge Gaps
- **145 isolated node(s):** `Offline research modules.`, `Schema v2 ingestion and fixture generation.`, `Fixed-tick interval quality reporting.`, `Uniformity report; each gap index identifies the right-hand tick row.`, `Compare adjacent tick times with ``1000 / sim_hz`` using a 1e-6 ms tolerance.` (+140 more)
...
- **Why does `createSharedState()` connect `Community 20` to `Community 2`, `Community 6`, `Community 7`, `Community 43`, `Community 45`, `Community 14`, `Community 15`, `Community 18`, `Community 50`, `Community 52`, `Community 51`, `Community 23`, `Community 28`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `TracerView` connect `Community 38` to `Community 16`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `createDataRecorder()` connect `Community 28` to `Community 0`, `Community 7`, `Community 43`, `Community 45`, `Community 14`, `Community 15`, `Community 16`, `Community 51`?**
