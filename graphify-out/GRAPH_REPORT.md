...
## Corpus Check
- 685 files · ~1,361,051 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5261 nodes · 13074 edges · 309 communities (269 shown, 40 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1693 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8758fb47`
...
Cohesion: 0.06
Nodes (40): createDrillRunner(), makeConfig(), reversalConfig(), run(), setup(), setupArmed(), trackingGuardConfig(), runCadenceTimeoutExport() (+32 more)
...
Cohesion: 0.06
Nodes (49): downloadCSV(), downloadJSON(), downloadTextFile(), createPointerLock(), createRenderLoop(), lerp(), activateDrill(), activeWeaponConfig() (+41 more)
...
Cohesion: 0.06
Nodes (53): _axis_grid(), _better(), bootstrap_f1_interval(), confusion_matrix(), ConfusionMatrix, _duration_grid(), evaluate_layers(), F1Interval (+45 more)
...
Cohesion: 0.07
Nodes (22): buildLargePayload(), buildSmallPayload(), timeFor(), buildLargePayload(), renderAt(), ReplayEffectView, clamp(), createReplayPlayer() (+14 more)
...
Cohesion: 0.12
Nodes (7): resolveDrillTimeLimitMs(), resolveSpiderShotWideV1(), createDrillMetricRegistry(), payload(), tick(), buildDeclaredWeaponByDrillId(), wideConfig()

### Community 19 - "Community 19"
Cohesion: 0.09
Nodes (31): aimForward(), angularDistanceDeg(), angularEccentricityDeg(), clamp(), eyeOriginForTick(), isFiniteNumber(), radToDeg(), resolveEyeOrigin() (+23 more)
...
Cohesion: 0.1
Nodes (18): widePayload(), payloadWithEyeZ(), recordTicks(), bearingDeg(), buildTicks(), payloadFor(), targetAt(), recordTicks() (+10 more)
...
Cohesion: 0.11
Nodes (26): qualityGateStatusForPayload(), buildCompatibilityKey(), buildSensitivityFovKey(), checkCompatibility(), checkQualityGate(), deriveSessionId(), requireBoolean(), requireNonNegativeFiniteNumber() (+18 more)
...
Cohesion: 0.14
Nodes (21): resolveHitFeedback(), drillSourceFor(), researcherControlsDrills(), resolveAvailableDrill(), diffFields(), flatten(), baseTargets(), buildTrackingCorePrPilotV1Cell() (+13 more)

### Community 53 - "Community 53"
Cohesion: 0.11
Nodes (12): deriveBrakingSamples(), baseMeta(), payload(), deriveCounterstrafeMetrics(), sidedStat(), buildPeekWindows(), firstTickIndexAtOrAfter(), hitTimesByShotSeq() (+4 more)

### Community 54 - "Community 54"
Cohesion: 0.14
Nodes (25): _aim_forward(), _column(), epsilon_deg(), _finite_column(), _finite_scalar(), _geometry(), _hitbox(), OmegaResult (+17 more)
...
Cohesion: 0.17
Nodes (12): createHistoryRepository(), HistoryContainmentError, MissingParticipantError, PracticeNotArchivableError, listAllFiles(), listRunJsonFiles(), makeTempRoot(), removeTempRoot() (+4 more)
...
Cohesion: 0.14
Nodes (7): PROBE(), ReplaySceneAdapter, sample(), resolveEyeWorldBase(), nearlyEqual(), requireRoomEnvelope(), requireSpiderShotDeliveryGeometry()
...
Cohesion: 0.21
Nodes (14): assertFinitePayload(), exportBasename(), formatBoolean(), formatNumber(), formatOptionalNumber(), rowsToCSV(), sanitizeFilename(), serializeCSV() (+6 more)
...
Cohesion: 0.17
Nodes (18): coalesced events (getCoalescedEvents), backend (render backend webgpu/webgl2), 原始輸入 (unadjustedMovement), 技術棧 (Three.js WebGPU + TS + Vite), 附錄 E 驗收清單 (階段 A), ADR-1 WebGPURenderer + WebGL2 fallback, ADR-5 Pointer Lock + 原始輸入 + coalesced events, 附錄 C 匯出資料 schema (+10 more)
...
Cohesion: 0.27
Nodes (13): collectFiles(), load(), loadManifest(), main(), assessDirectionality(), countDetected(), fmt(), formatSpiderWideRepositioningSummary() (+5 more)
...
Cohesion: 0.4
Nodes (6): 不可違反的硬約束 (技術), cross-origin isolation (COOP/COEP), MetricsDashboard 元件, D1 — 2D UI = 純 TS + DOM overlay, D3 — COOP/COEP 部署 (Vite plugin + 靜態主機後定), ADR-4 performance.now() + cross-origin isolation
...
- **Why does `bool()` connect `Community 70` to `Community 98`, `Community 153`, `Community 5`, `Community 39`, `Community 75`, `Community 45`, `Community 145`, `Community 50`, `Community 121`, `Community 59`, `Community 29`, `Community 63`?**
  _High betweenness centrality (0.281) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 98` to `Community 5`, `Community 143`, `Community 16`, `Community 144`, `Community 146`, `Community 152`, `Community 153`, `Community 28`, `Community 45`, `Community 178`, `Community 50`, `Community 54`, `Community 55`, `Community 63`, `Community 70`, `Community 202`, `Community 203`, `Community 81`, `Community 104`, `Community 110`, `Community 111`, `Community 117`, `Community 119`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 39` to `Community 70`?**
