...
## Corpus Check
- 687 files · ~1,365,244 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5268 nodes · 13118 edges · 298 communities (258 shown, 40 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1699 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9a225db5`
...
1. `createSharedState()` - 119 edges
2. `createDataRecorder()` - 80 edges
3. `createTargetManager()` - 75 edges
...
Cohesion: 0.05
Nodes (53): createDataRecorder(), capacityForDrill(), createDrillRunner(), setupArmed(), runCadenceTimeoutExport(), runTimeoutOnly(), runCadenceTimeoutExport(), runTimeoutOnly() (+45 more)
...
Cohesion: 0.07
Nodes (57): x(), aimFor(), makeV3Payload(), pointFor(), collectFiles(), firstSentence(), load(), main() (+49 more)
...
Cohesion: 0.07
Nodes (48): createPointerLock(), createRenderLoop(), lerp(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), beginNextProtocolCondition(), buildCurrentExportPayload() (+40 more)

### Community 6 - "Community 6"
Cohesion: 0.09
Nodes (30): resolveTargetHitbox(), loadDrill(), aimAt(), fireFrom(), pushTarget(), wideConfig(), activeSides(), assertFiniteEnvelope() (+22 more)
...
Cohesion: 0.07
Nodes (37): measureAtEye(), createRan1(), randomFloat(), angularSeparationDeg(), centerRelativeDirection(), minimumActiveSeparationDeg(), satisfiesActiveSeparation(), shuffleInPlace() (+29 more)
...
Cohesion: 0.06
Nodes (40): Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., _render_flags(), render_html(), _render_limitations(), Contract tests for the one-command coach report v1 (WP-30 T-exit).  Covers the (+32 more)
...
Cohesion: 0.09
Nodes (22): widePayload(), payloadWithEyeZ(), recordTicks(), bearingDeg(), buildTicks(), payloadFor(), targetAt(), recordTicks() (+14 more)
...
Cohesion: 0.08
Nodes (18): reparse(), createHistoryClient(), HistoryClientError, isErrorBody(), isRecord(), isSuccessBody(), createHistoryLibraryController(), createHistoryPersistence() (+10 more)

### Community 21 - "Community 21"
Cohesion: 0.09
Nodes (28): resolveFamilyDrillId(), resolveWarmupDrillId(), findSessionPlanPreset(), compileSessionProgram(), deriveProgramFamilyOrder(), requireRestSeconds(), requireWeapon(), resolveBoundary() (+20 more)
...
Cohesion: 0.11
Nodes (18): buildEarlyReplayFixture(), openFullReplayFromResult(), openHistoricalRunDetail(), openHistory(), waitForHarness(), waitReplayReady(), buildFixture(), fixtureStartedAt() (+10 more)
...
Cohesion: 0.13
Nodes (8): resolveDrillTimeLimitMs(), resolveHitFeedback(), diffFields(), flatten(), diffFields(), flatten(), buildDeclaredWeaponByDrillId(), isWeaponId()
...
Cohesion: 0.09
Nodes (20): drainSpawns(), recordSpiderSpawns(), recordSpiderSpawnsWithResetRerun(), createMovementController(), run(), runBatches(), collectHitboxes(), collectImmediateSpawns() (+12 more)
...
Cohesion: 0.12
Nodes (27): buildConditionEvidence(), buildTrackingPilotEvidence(), readTrajectorySeed(), renderTrackingPilotReportHtml(), collectFiles(), load(), main(), stimulusCheck() (+19 more)
...
Cohesion: 0.13
Nodes (33): assess_sufficiency(), decide(), fit_layers(), hover_analogue(), The reference stage 2 rule, read as evidence *for* a lift rather than as a trim., The reference stage 3 rule: does the boundary look like a hovering, jittering ha, Attach the layer inputs to T2's candidate table, for one boundary-window length., The four rules, in order. Layers 3 and 4 fit nothing -- they only add the refere (+25 more)
...
Cohesion: 0.12
Nodes (19): aimForward(), angularDistanceDeg(), angularEccentricityDeg(), clamp(), eyeOriginForTick(), isFiniteNumber(), radToDeg(), resolveEyeOrigin() (+11 more)
...
Cohesion: 0.09
Nodes (13): keyMaskFromKeys(), keyMaskFromState(), keysFromMask(), TickArena, buildTicks(), payloadFor(), scoredTickMs(), shotEvents() (+5 more)
...
Cohesion: 0.11
Nodes (15): assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), cameraLookingDownZ(), driveRenderAndSim(), fireAt(), fixedClock(), makeTarget() (+7 more)
...
Cohesion: 0.14
Nodes (16): deriveUnlockedIntervals(), overlapsAny(), segmentByTimeGap(), assessAnnotationChannel(), extractAnnotationIntervals(), buildLiftSegmentationGolden(), lastSampleMs(), segmentationAt() (+8 more)
...
Cohesion: 0.12
Nodes (26): _aligned(), _bootstrap_ci(), _checked_flags(), _correlogram(), _gate_verdict(), GateVerdict, _half_agreement(), key_velocity_xcorr() (+18 more)
...
Cohesion: 0.1
Nodes (25): PeekWindow, One ``[visible, next visible)`` presentation window in measurement time., One ``[visible, next visible)`` presentation window in measurement time., bins_at_or_below_fc(), _compute_traced(), _degenerate(), _finalize(), SPARC spectral-arc-length smoothness (WP-31 / T1, FR-D13).  ``sparc-v1`` answe (+17 more)
...
Cohesion: 0.17
Nodes (22): FakeDocument, findByTag(), flatten(), readyValue(), text(), computePromotedMetrics(), average(), buildResultPresentation() (+14 more)
...
Cohesion: 0.11
Nodes (22): key_state_signed(), _pearson(), Signed strafe key state per tick: ``D`` -> ``+1``, ``A`` -> ``-1``, both or neit, Signed Pearson r, or ``nan`` for too-few samples / a zero-variance input (PA ``_, T2 DoD 3, proven from the source rather than by sampling inputs.      Two fact, Alternating A/D holds at a fixed period: a strafe pattern with real autocorrelat, _square_key(), test_a_constant_key_state_is_flagged_rather_than_scored_zero() (+14 more)
...
Cohesion: 0.1
Nodes (12): createResultDetailBody(), createResultSummaryResult(), diagnosisMetricIds(), FakeDocument, FakeElement, flatten(), metricIds(), qualityFlagMetricIds() (+4 more)

### Community 75 - "Community 75"
Cohesion: 0.13
Nodes (14): buildExportPayload(), targetHitboxToConfig(), aimAtPoint(), aimAtTick(), makePayload(), makeVaryingHitboxPayload(), targetAtTick(), tickTime() (+6 more)
...
Cohesion: 0.21
Nodes (11): resolveSpiderShotWideV1(), requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor(), halfHorizontalFovRad(), ndcForEyeAngles() (+3 more)
...
Cohesion: 0.15
Nodes (12): parseEvents(), parseExportPayload(), parseTicks(), isExportPayload(), loadAssessmentSessionSummaries(), parseExportPayload(), readExportPayload(), walk() (+4 more)
...
Cohesion: 0.15
Nodes (11): createDrillMetricRegistry(), aimAt(), aimYaw(), makePayload(), makeV3Payload(), targetAt(), visible(), withMeta() (+3 more)
...
Cohesion: 0.15
Nodes (12): createTrendChart(), decimalsFor(), directionWordFor(), formatDelta(), formatMetricValue(), FakeDocument, findByTag(), flatten() (+4 more)
...
Cohesion: 0.28
Nodes (13): collectFiles(), load(), loadManifest(), main(), isInstructionClass(), baseName(), parseEntry(), readLiftManifest() (+5 more)
...
Cohesion: 0.18
Nodes (7): createDrillOverview(), makeButton(), createHistoricalRunDetail(), makeButton(), setup(), createHistoryScreen(), makeButton()
...
Cohesion: 0.26
Nodes (9): deriveDetectionMetrics(), deriveRepositioningSuspicion(), longer(), longestStall(), nonNegativeFinite(), positiveFinite(), loadExport(), loadJson() (+1 more)
...
Cohesion: 0.24
Nodes (3): assessmentProtocolVersionForDrill(), SessionProgramCompileError, summarizeProgram()
...
- **Why does `bool()` connect `Community 70` to `Community 34`, `Community 3`, `Community 166`, `Community 38`, `Community 9`, `Community 78`, `Community 52`, `Community 53`, `Community 154`, `Community 59`, `Community 61`, `Community 62`?**
  _High betweenness centrality (0.279) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 3` to `Community 9`, `Community 143`, `Community 16`, `Community 145`, `Community 146`, `Community 144`, `Community 153`, `Community 154`, `Community 26`, `Community 48`, `Community 53`, `Community 61`, `Community 63`, `Community 64`, `Community 197`, `Community 70`, `Community 198`, `Community 89`, `Community 117`, `Community 118`, `Community 123`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 34` to `Community 70`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Are the 61 inferred relationships involving `createSharedState()` (e.g. with `setup()` and `setupArmed()`) actually correct?**
  _`createSharedState()` has 61 INFERRED edges - model-reasoned connections that need verification._
- **Are the 42 inferred relationships involving `createDataRecorder()` (e.g. with `capacityForDrill()` and `mouseSampleCapacityForDrill()`) actually correct?**
  _`createDataRecorder()` has 42 INFERRED edges - model-reasoned connections that need verification._
- **Are the 43 inferred relationships involving `createTargetManager()` (e.g. with `activateDrill()` and `loadSceneById()`) actually correct?**
  _`createTargetManager()` has 43 INFERRED edges - model-reasoned connections that need verification._
