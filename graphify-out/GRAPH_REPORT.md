...
## Corpus Check
- 303 files · ~534,957 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2674 nodes · 6061 edges · 168 communities (137 shown, 31 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 928 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `46959d97`
...
4. `createDataRecorder()` - 44 edges
5. `createSimLoop()` - 43 edges
...
Cohesion: 0.05
Nodes (56): _compute_failed_flag(), is_known_quality_flag(), per_segment_apply(), Per-segment computation with a closed, machine-readable quality vocabulary.  E, Summarize finite, unflagged values while counting excluded flagged rows., Summarize finite, unflagged values while counting excluded flagged rows., Return whether *flag* is an exact or templated vocabulary member., Return whether *flag* is an exact or templated vocabulary member. (+48 more)
...
Cohesion: 0.11
Nodes (23): resolveTargetHitbox(), targetHitboxToConfig(), loadDrill(), distanceForAngularHeight(), makeVariant(), speedForAngularRate(), variantId(), activeSides() (+15 more)
...
Cohesion: 0.09
Nodes (26): createDrillRunner(), setup(), canonicalRun(), runFrames(), snap(), syntheticInputs(), createMovementController(), run() (+18 more)
...
Cohesion: 0.13
Nodes (23): assertFinitePayload(), buildExportPayload(), downloadCSV(), downloadJSON(), downloadTextFile(), exportBasename(), formatBoolean(), formatNumber() (+15 more)
...
Cohesion: 0.13
Nodes (26): createPointerLock(), isOutsideCorridor(), activeWeaponConfig(), beginNextProtocolCondition(), buildCurrentExportPayload(), buildSimLoop(), completeActiveProtocolCondition(), currentMouseGain() (+18 more)
...
Cohesion: 0.13
Nodes (17): aimForward(), angularEccentricityDeg(), clamp(), eyeOriginForTick(), isFiniteNumber(), radToDeg(), resolveEyeOrigin(), deriveVisibilityTimeline() (+9 more)
...
Cohesion: 0.21
Nodes (22): _list(), load_export(), _mapping(), _non_empty_string(), _number(), _optional_number(), Load the JSON form of the schema v2 export documented in docs/operational/schema, A schema v2 validation error with a machine-readable JSON field path. (+14 more)
...
Cohesion: 0.14
Nodes (15): createMetricsDashboard(), buildPeekWindows(), hitTimesByShotSeq(), computeCurveMetrics(), computePhaseMetrics(), computePromotedMetrics(), computeSyncMetrics(), sortedTicks() (+7 more)
...
Cohesion: 0.15
Nodes (4): firstTickIndexAtOrAfter(), lastReleaseTransition(), releaseAnchor(), tickRangeForWindow()
...
- **Why does `counter()` connect `Community 25` to `Community 2`, `Community 69`?**
  _High betweenness centrality (0.330) - this node is a cross-community bridge._
- **Why does `_fixture_report()` connect `Community 2` to `Community 1`, `Community 35`, `Community 25`?**
  _High betweenness centrality (0.200) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 1` to `Community 0`, `Community 66`, `Community 2`, `Community 3`, `Community 102`, `Community 91`, `Community 43`, `Community 78`, `Community 15`, `Community 80`, `Community 82`, `Community 83`, `Community 61`, `Community 25`, `Community 59`, `Community 29`, `Community 62`?**
