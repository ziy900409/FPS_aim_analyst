# Graph Report - FPS_aim_analyst  (2026-07-13)

## Corpus Check
- 150 files · ~235,500 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1099 nodes · 2588 edges · 73 communities (55 shown, 18 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 209 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `57bff5dd`
...
Cohesion: 0.14
Nodes (20): createDataRecorder(), capacityForDrill(), createSimLoop(), canonicalRun(), runFrames(), snap(), syntheticInputs(), pushEvent() (+12 more)
...
Cohesion: 0.25
Nodes (9): consume(), drainAll(), drainToArray(), snapshot(), createImpactRing(), createInputRing(), pushImpact(), resetImpactRing() (+1 more)
...
- **Why does `TargetView` connect `Community 25` to `Community 21`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `createSharedState()` connect `Community 22` to `Community 1`, `Community 34`, `Community 4`, `Community 37`, `Community 38`, `Community 39`, `Community 40`, `Community 41`, `Community 12`, `Community 14`, `Community 17`, `Community 20`, `Community 23`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `TickArena` connect `Community 28` to `Community 12`?**
