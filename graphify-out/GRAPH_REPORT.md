...
## Corpus Check
- 687 files · ~1,363,708 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5268 nodes · 13118 edges · 297 communities (255 shown, 42 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1699 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ab30f1ac`
...
## Communities (297 total, 42 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (40): createDrillRunner(), runCadenceTimeoutExport(), createSimLoop(), brInputs(), createCamera(), runBrVariant(), canonicalRun(), runFrames() (+32 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (49): makeConfig(), reversalConfig(), run(), setup(), setupArmed(), trackingGuardConfig(), runCadenceTimeoutExport(), runTimeoutOnly() (+41 more)
...
Cohesion: 0.06
Nodes (52): createPointerLock(), createRenderLoop(), lerp(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), beginNextProtocolCondition(), buildCurrentExportPayload() (+44 more)
...
Cohesion: 0.07
Nodes (35): createDataRecorder(), buildExportPayload(), capacityForDrill(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), cameraLookingDownZ(), driveRenderAndSim() (+27 more)
...
Cohesion: 0.09
Nodes (31): resolveTargetHitbox(), targetHitboxToConfig(), loadDrill(), aimAt(), fireFrom(), pushTarget(), buildRoundTripPayload(), activeSides() (+23 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (24): consume(), createInputSampler(), ImpactView, createMovementController(), run(), runBatches(), drainAll(), drainToArray() (+16 more)
...
Cohesion: 0.1
Nodes (9): resolveDrillTimeLimitMs(), resolveHitFeedback(), diffFields(), flatten(), diffFields(), flatten(), payload(), tick() (+1 more)

### Community 16 - "Community 16"
Cohesion: 0.07
Nodes (19): reparse(), createHistoryClient(), HistoryClientError, isErrorBody(), isRecord(), isSuccessBody(), createHistoryLibraryController(), createHistoryPersistence() (+11 more)
...
Cohesion: 0.09
Nodes (21): widePayload(), payloadWithEyeZ(), recordTicks(), bearingDeg(), buildTicks(), payloadFor(), targetAt(), buildTicks() (+13 more)
...
Cohesion: 0.1
Nodes (27): resolveFamilyDrillId(), resolveWarmupDrillId(), findSessionPlanPreset(), compileSessionProgram(), deriveProgramFamilyOrder(), requireRestSeconds(), resolveBoundary(), actualWeaponIdFor() (+19 more)
...
Cohesion: 0.15
Nodes (38): collectMeta(), normalizeStartedAt(), requireAssessmentMeta(), requireBackend(), requireBoolean(), requireClutterTier(), requireDisplaySelfReport(), requireDisplayState() (+30 more)
...
Cohesion: 0.11
Nodes (15): createPresentationCoordinator(), makeMeta(), normalizeReplayRecording(), toSceneDescriptor(), fixtureRecording(), fixtureRecording(), buildLargePayload(), buildSmallPayload() (+7 more)
...
Cohesion: 0.11
Nodes (21): aimForward(), angularDistanceDeg(), angularEccentricityDeg(), clamp(), eyeOriginForTick(), isFiniteNumber(), radToDeg(), resolveEyeOrigin() (+13 more)
...
Cohesion: 0.12
Nodes (24): parseEvents(), parseExportPayload(), parseTicks(), walk(), collectFiles(), load(), loadManifest(), main() (+16 more)
...
Cohesion: 0.13
Nodes (28): annotation(), gap(), latencyCohort(), liftPayload(), liftRun(), move(), traceBlock(), collectFiles() (+20 more)
...
Cohesion: 0.11
Nodes (29): counter(), build_report(), _counts(), _drill_summary(), _empty_stats(), _flag_counts(), _groups(), _parameters() (+21 more)

### Community 62 - "Community 62"
Cohesion: 0.13
Nodes (20): buildConditionEvidence(), buildTrackingPilotEvidence(), renderTrackingPilotReportHtml(), anglesToWorld(), buildPayload(), perfectFollowerPayload(), collectFiles(), load() (+12 more)
...
Cohesion: 0.09
Nodes (26): _aligned(), _checked_flags(), key_state_signed(), key_velocity_xcorr(), _median_dt_ms(), One window's cross-correlation.      ``correlogram`` entries are ``(lag_ms, r,, Signed strafe key state per tick: ``D`` -> ``+1``, ``A`` -> ``-1``, both or neit, Signed Pearson r at every lag in ``[-max_lag_ticks, +max_lag_ticks]``, plus the (+18 more)

### Community 67 - "Community 67"
Cohesion: 0.11
Nodes (23): _bootstrap_ci(), _correlogram(), _gate_verdict(), GateVerdict, _half_agreement(), _peak(), _peak_strength(), _pearson() (+15 more)
...
Cohesion: 0.15
Nodes (16): integratedDelta(), omegaDegPerSec(), radToDeg(), requireFiniteNumber(), deriveDetectionMetrics(), deriveSpiderShotMetrics(), isFiniteNumber(), percentile() (+8 more)
...
Cohesion: 0.17
Nodes (11): createFrameLog(), frameLogCapacity(), assertReadyState(), createProtocolRunner(), requireCondition(), requireNonEmptyString(), requirePositiveInteger(), requireRecord() (+3 more)
...
Cohesion: 0.24
Nodes (9): enumerateLandings(), sceneWithRoom(), requireSpiderWideArenaGeometry(), spiderWideArenaClearance(), spiderWideArenaExtremes(), spiderWideTargetRadiusU(), spiderEyePolarPos(), spiderWideEyeAngles() (+1 more)
...
Cohesion: 0.24
Nodes (10): resolveSpiderShotWideV1(), requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor(), expectYawWindowMatchesResolver(), halfHorizontalFovRad() (+2 more)
...
Cohesion: 0.19
Nodes (15): ADR-2 雙迴圈解耦, ADR-3 128 Hz tick, WP-0 — 環境設置 (scaffold/createRenderer seam), WP-3 — 高頻輸入採集 (getCoalescedEvents 入緩衝), WP-5 — movement / 急停物理, WP-1 Progress Log, WP-1 — FPS 控制 + Pointer Lock (exec-plan), 視角走輸入/render 路徑不入 sim (雙迴圈邊界) (+7 more)
...
Cohesion: 0.23
Nodes (10): buildTrackingContactCoverageReport(), countExclusionReasons(), buildTrackingContactReport(), conditionAggregates(), renderTrackingContactReportHtml(), serializeTrackingContactReport(), aimAt(), onTargetPayload() (+2 more)
...
Cohesion: 0.19
Nodes (6): createDrillBrowser(), createHistoricalRunDetail(), makeButton(), setup(), createHistoryScreen(), makeButton()
...
Cohesion: 0.53
Nodes (5): measureDisplayHz(), measureDisplayRefresh(), nextAnimationFrame(), normalizeOverflow(), requireNonNegativeInteger()
...
- **Why does `bool()` connect `Community 61` to `Community 67`, `Community 5`, `Community 41`, `Community 138`, `Community 11`, `Community 78`, `Community 54`, `Community 55`, `Community 24`, `Community 89`, `Community 56`, `Community 151`?**
  _High betweenness centrality (0.279) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 5` to `Community 11`, `Community 139`, `Community 141`, `Community 142`, `Community 140`, `Community 20`, `Community 150`, `Community 151`, `Community 24`, `Community 29`, `Community 49`, `Community 54`, `Community 56`, `Community 59`, `Community 61`, `Community 194`, `Community 195`, `Community 87`, `Community 96`, `Community 113`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 41` to `Community 61`?**
