...
## Corpus Check
- 674 files · ~1,334,339 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5207 nodes · 12916 edges · 293 communities (256 shown, 37 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1682 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dbc2e674`
...
## Communities (293 total, 37 thin omitted)
...
Cohesion: 0.06
Nodes (62): measureDisplayHz(), measureDisplayRefresh(), nextAnimationFrame(), resolveDrillTimeLimitMs(), createPointerLock(), createSceneManagerWithStatus(), activateDrill(), activeWeaponConfig() (+54 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (26): createDataRecorder(), MouseSampleArena, mouseSampleCapacityForDrill(), capacityForDrill(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), payload() (+18 more)
...
Cohesion: 0.1
Nodes (13): assessmentProtocolVersionForDrill(), buildPeekClickTransferPilotV2MaskedConfig(), buildPeekClickTransferPilotV2RandomizedConfig(), peekClickTransferPilotV2CandidateLabel(), buildCounterstrafeReversalPilotConfigs(), buildHoldClickPilotConfigs(), buildHoldTrackPilotConfigs(), buildPeekClickTransferPilotConfigs() (+5 more)
...
Cohesion: 0.07
Nodes (27): setup(), setupArmed(), aimAt(), fireFrom(), runCadenceTimeoutExport(), runTimeoutOnly(), runCadenceTimeoutExport(), runTimeoutOnly() (+19 more)

### Community 11 - "Community 11"
Cohesion: 0.09
Nodes (22): loadDrill(), createDrillRunner(), measureAtEye(), brInputs(), createCamera(), runBrVariant(), canonicalLongrangeFrames(), createCamera() (+14 more)
...
Cohesion: 0.1
Nodes (26): resolveTargetHitbox(), targetHitboxToConfig(), pushTarget(), buildRoundTripPayload(), parseSpiderShot(), activeSides(), assertFiniteEnvelope(), clipAxis() (+18 more)
...
Cohesion: 0.09
Nodes (25): resolveSpiderShotWideV1(), reparse(), requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor(), enterResearcherDrillControls() (+17 more)
...
Cohesion: 0.09
Nodes (13): createSceneLoadCoordinator(), defaultLoader(), disposeScene(), loadScene(), createSceneManager(), SceneManager, createReplayPresentationSession(), resolveWeapon() (+5 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (36): Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., render_html(), _render_limitations(), Contract tests for the one-command coach report v1 (WP-30 T-exit).  Covers the, C-D3 / GD-20: a metric without a construct gate must not appear as a number. (+28 more)
...
Cohesion: 0.08
Nodes (17): deriveBrakingSamples(), baseMeta(), payload(), deriveCounterstrafeMetrics(), payload(), tick(), deriveHoldClickMetrics(), derivePeekClickTransferMetrics() (+9 more)
...
Cohesion: 0.09
Nodes (25): resolveFamilyDrillId(), findSessionPlanPreset(), compileSessionProgram(), deriveProgramFamilyOrder(), requireRestSeconds(), requireWeapon(), resolveBoundary(), actualWeaponIdFor() (+17 more)
...
Cohesion: 0.1
Nodes (36): _advanced_diagnostics(), _empty_stats(), _epsilon_or_none(), _finite(), _fitts_block(), _gap_text(), _number(), _phase_entries() (+28 more)
...
Cohesion: 0.09
Nodes (10): enterResearcherDrillControls(), loadMicroFlick(), openPlanSetup(), runLiveSessionPlan(), waitForHarness(), armAndWaitRunning(), armDrill(), installAutoArm() (+2 more)
...
Cohesion: 0.13
Nodes (15): createDrillBrowser(), createDrillOverview(), makeButton(), createHistoryScreen(), makeButton(), createHistoryNavigator(), defaultWindow(), decodeSegment() (+7 more)
...
Cohesion: 0.14
Nodes (22): createSimLoop(), createRan1(), centerRelativeAngularSeparationDeg(), copyPos(), fixedClock(), inspectV8Population(), observeCurrentV8(), rayAimedAtKilledCenterHitsReplacement() (+14 more)
...
Cohesion: 0.15
Nodes (14): deriveUnlockedIntervals(), overlapsAny(), segmentByTimeGap(), extractAnnotationIntervals(), segmentationAt(), verifyLiftSegmentationGolden(), deriveSamplingHealth(), countDetected() (+6 more)
...
Cohesion: 0.14
Nodes (13): advanceUntilTracer(), createCamera(), createTarget(), fireOne(), runAtFrames(), angularSeparationDeg(), centerRelativeDirection(), minimumActiveSeparationDeg() (+5 more)
...
Cohesion: 0.21
Nodes (18): build(), _extend_ticks(), main(), _mouse_samples(), WP-61 T2: regenerate the committed synthetic annotated export.  Why a syntheti, Pad the borrowed tick stream so it spans the synthetic events.      The base f, Return the columnar block plus the absolute start time of each synthetic gap., err() (+10 more)
...
Cohesion: 0.15
Nodes (20): ADR-4 時間源 (performance.now()), counterstrafe_ad_v1 drill config, WP-2 sim tick, WP-4 t_visible/命中事件, WP-5 fire/急停/首發 (即時狀態), WP-6 drill 控制 (DrillRunner/DrillLoader), 附錄 C 匯出 schema (meta/ticks[]/events[]), WP-7 資料記錄與匯出 (F1/F2) ★M3 (+12 more)
...
Cohesion: 0.22
Nodes (10): HistoryContainmentError, PracticeNotArchivableError, listAllFiles(), listRunJsonFiles(), makeTempRoot(), removeTempRoot(), buildStage10Fixtures(), computeRunId() (+2 more)
...
Cohesion: 0.26
Nodes (14): collectFiles(), load(), loadManifest(), main(), isInstructionClass(), baseName(), parseEntry(), readLiftManifest() (+6 more)
...
Cohesion: 0.26
Nodes (8): createMetricsDashboard(), collectImpacts(), collectTracers(), createCamera(), createTargetManagerStub(), makeTarget(), runProjectile(), runWeapon()
...
Cohesion: 0.24
Nodes (10): WP-9 整合 + 計時效度驗證, compute.ts (computeMetrics 純函式), MetricsDashboard, 純機械計算 (無主觀評分), ResultScreen (src/ui/ResultScreen.ts), 統計=匯出同一 snapshot 來源, WP-8 T1 — 指標計算 (§5 八指標純函式), WP-8 T2 — 結果頁 (DOM) (+2 more)
...
Cohesion: 0.25
Nodes (9): SharedState, SimLoop (src/loop/SimLoop.ts), DataRecorder (src/data/DataRecorder.ts), Ring buffer + 物件重用 (無 GC 卡頓), RingBuffer (src/data/RingBuffer.ts), WP-7 T1 — Ring buffer 每 tick 記錄, HUD (src/ui/HUD.ts), HUD 不污染量測 (rAF 讀值, 不每幀配置) (+1 more)
...
Cohesion: 0.4
Nodes (5): angularSizeToHitboxWidthU(), buildPeekClickTransferPilotConfig(), pilotDrillId(), buildPeekClickTransferPilotV2Config(), pilotV2DrillId()
...
- **Why does `bool()` connect `Community 71` to `Community 64`, `Community 161`, `Community 1`, `Community 35`, `Community 68`, `Community 69`, `Community 32`, `Community 7`, `Community 81`, `Community 150`, `Community 54`, `Community 62`?**
  _High betweenness centrality (0.290) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 1` to `Community 7`, `Community 141`, `Community 14`, `Community 143`, `Community 142`, `Community 149`, `Community 150`, `Community 31`, `Community 174`, `Community 54`, `Community 57`, `Community 60`, `Community 62`, `Community 192`, `Community 193`, `Community 71`, `Community 93`, `Community 120`, `Community 121`, `Community 123`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 35` to `Community 71`?**
