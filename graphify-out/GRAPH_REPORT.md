...
## Corpus Check
- 488 files · ~825,879 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3835 nodes · 9017 edges · 234 communities (197 shown, 37 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1145 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `19307e17`
...
Cohesion: 0.07
Nodes (52): createPointerLock(), activeWeaponConfig(), applyHistoryOverrides(), average(), beginNextProtocolCondition(), buildCurrentExportPayload(), buildSimLoop(), completeActiveProtocolCondition() (+44 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (40): createDrillRunner(), setup(), runCadenceTimeoutExport(), runTimeoutOnly(), runCadenceTimeoutExport(), runTimeoutOnly(), createSimLoop(), canonicalRun() (+32 more)
...
Cohesion: 0.09
Nodes (22): makeConfig(), reversalConfig(), run(), angularSizeToHitboxWidthU(), buildPeekClickTransferPilotConfig(), pilotDrillId(), aimAt(), fireFrom() (+14 more)
...
Cohesion: 0.08
Nodes (33): counter(), build_report(), _counts(), _drill_summary(), _epsilon_or_none(), _fitts_block(), _flag_counts(), _gap_text() (+25 more)
...
Cohesion: 0.13
Nodes (17): applyAimFixture(), canonicalMovingTargetFrames(), createCamera(), runMovingTarget(), collectImpacts(), collectTracers(), createCamera(), createTargetManagerStub() (+9 more)
...
Cohesion: 0.12
Nodes (17): deriveDetectionMetrics(), deriveSpiderShotMetrics(), isFiniteNumber(), percentile(), rhythmFor(), sortedVisible(), targetForFirstShot(), aimAt() (+9 more)
...
Cohesion: 0.16
Nodes (18): buildHitShotSeqs(), buildSpiderShotV2ConditionCell(), median(), projectSpiderShotV2(), qualityGateStatusForPayload(), roundTo(), validDurationMs(), buildCompatibilityKey() (+10 more)
...
Cohesion: 0.17
Nodes (18): ADR-2 三迴圈經 SharedState 溝通, ADR-3 精準度來源 = sub-tick 輸入時間戳, ADR-4 performance.now() / event.timeStamp 同源, ADR-5 coalesced events, getCoalescedEvents 次幀採樣 (高頻滑鼠不丟樣本), 依時序排序消費 + 排空 (決定性契約), sub-tick 輸入時間戳 (精準度真正來源), 時間戳同源 (event.timeStamp = performance.now() 基準) (+10 more)
...
Cohesion: 0.16
Nodes (16): _advanced_diagnostics(), _empty_stats(), _finite(), _number(), _phase_entries(), Run the three WP-31 P2 diagnostics and shape each into a verdict, not a bare num, SPARC has no ``blocked-by-data`` branch -- it always reaches the research block,, _rec_detect_consistency() (+8 more)
...
Cohesion: 0.6
Nodes (4): buildPeekClickTransferPilotEvidenceReport(), countByFlag(), countFlags(), rate()
...
- **Why does `counter()` connect `Community 29` to `Community 12`, `Community 21`?**
  _High betweenness centrality (0.361) - this node is a cross-community bridge._
- **Why does `_fixture_report()` connect `Community 12` to `Community 0`, `Community 29`, `Community 38`?**
  _High betweenness centrality (0.220) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 0` to `Community 135`, `Community 7`, `Community 9`, `Community 12`, `Community 16`, `Community 154`, `Community 155`, `Community 29`, `Community 34`, `Community 43`, `Community 62`, `Community 84`, `Community 85`, `Community 91`, `Community 108`, `Community 109`, `Community 111`, `Community 117`, `Community 118`, `Community 119`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Are the 38 inferred relationships involving `createSharedState()` (e.g. with `setup()` and `runTimeoutOnly()`) actually correct?**
  _`createSharedState()` has 38 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 31 inferred relationships involving `createDataRecorder()` (e.g. with `capacityForDrill()` and `createAimIntegrator()`) actually correct?**
  _`createDataRecorder()` has 31 INFERRED edges - model-reasoned connections that need verification._
