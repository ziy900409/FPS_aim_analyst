...
## Corpus Check
- 623 files · ~1,118,277 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4616 nodes · 11335 edges · 283 communities (245 shown, 38 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 1369 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `84483a61`
...
Cohesion: 0.05
Nodes (74): createDataRecorder(), capacityForDrill(), createDrillRunner(), runCadenceTimeoutExport(), runTimeoutOnly(), runCadenceTimeoutExport(), runTimeoutOnly(), assertPositiveFinite() (+66 more)
...
Cohesion: 0.06
Nodes (36): resolveTargetHitbox(), targetHitboxToConfig(), resolveSpiderShotWideV1(), requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor() (+28 more)
...
Cohesion: 0.07
Nodes (20): distanceForAngularHeight(), makeVariant(), speedForAngularRate(), variantId(), buildCounterstrafeReversalPilotConfigs(), buildHoldClickPilotConfigs(), buildHoldTrackPilotConfigs(), buildPeekClickTransferPilotConfigs() (+12 more)
...
Cohesion: 0.08
Nodes (42): assessmentProtocolVersionForDrill(), createPointerLock(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), beginNextProtocolCondition(), buildSimLoop(), completeActiveProtocolCondition() (+34 more)
...
Cohesion: 0.09
Nodes (22): consume(), createInputSampler(), isDrivenMotion(), motionOffset(), offsetAt(), triangleWave(), drainAll(), drainToArray() (+14 more)
...
Cohesion: 0.08
Nodes (31): createTargetManager(), activeTargets(), angularSeparationDeg(), collectReplacementTrace(), direction(), expectPopulationInvariant(), externalTarget(), fallbackTarget() (+23 more)
...
Cohesion: 0.08
Nodes (8): createPresentationCoordinator(), buildLargePayload(), ReplayEffectView, createReplayPresentationSession(), resolveWeapon(), ReplaySceneAdapter, ReplayTargetView, resolveReplayTargetHitbox()
...
Cohesion: 0.16
Nodes (37): collectMeta(), normalizeStartedAt(), requireAssessmentMeta(), requireBackend(), requireBoolean(), requireClutterTier(), requireDisplaySelfReport(), requireDisplayState() (+29 more)
...
Cohesion: 0.12
Nodes (23): spawnBullet(), stepBullet(), clipAxis(), sweptHitTest(), advanceProjectiles(), applyInput(), ballisticRaycast(), composeProjectileRay() (+15 more)
...
Cohesion: 0.12
Nodes (33): _advanced_diagnostics(), _empty_stats(), _epsilon_or_none(), _finite(), _fitts_block(), _gap_text(), _number(), _phase_entries() (+25 more)
...
Cohesion: 0.14
Nodes (26): measureAtEye(), expectedPos(), boundedSpeedScale(), buildSinusoidComponents(), clamp(), createBandLimited2dV1(), createReversal2dV1(), createTrackingTrajectory() (+18 more)
...
Cohesion: 0.19
Nodes (17): round(), simulatePurePunchPattern(), toPatternShot(), createRecoilState(), hybridDecay(), recoilOnFire(), recoilTick(), resetRecoilState() (+9 more)
...
Cohesion: 0.2
Nodes (14): firstBulletSuppression(), generateRecoilTable(), lerp(), requireFinite(), validateParams(), createRan1(), randomFloat(), requireNonNegativeFinite() (+6 more)
...
Cohesion: 0.14
Nodes (10): makeConfig(), reversalConfig(), run(), setup(), trackingGuardConfig(), spiderEyePolarPos(), angularSeparationDeg(), centerRelativeDirection() (+2 more)
...
Cohesion: 0.15
Nodes (11): resolveFamilyDrillId(), buildFrozenSessionPlan(), createSessionRunner(), requireFamilyOrder(), resolveFamilyDrillId(), resolveWarmupDrillId(), familyRestPhase(), frozen() (+3 more)
...
Cohesion: 0.12
Nodes (10): collect64HzSamples(), recordCueEvents(), recordProtocolViolationEvents(), recordScoredStartEvents(), recordTargetMotionChangeEvents(), recordTargetStopEvents(), recordVisibleEvents(), simStep() (+2 more)
...
Cohesion: 0.25
Nodes (6): SessionProgramCompileError, describeBoundary(), createSessionPlanSetup(), describeStep(), groupSchedulableDrills(), makeButton()

### Community 159 - "Community 159"
Cohesion: 0.29
Nodes (7): compileSessionProgram(), deriveProgramFamilyOrder(), requireRestSeconds(), resolveBoundary(), summarizeProgram(), metaForRun(), payloadFor()
...
Cohesion: 0.39
Nodes (7): measureDisplayHz(), measureDisplayRefresh(), nextAnimationFrame(), normalizeOverflow(), requireNonNegativeInteger(), buildCurrentExportPayload(), sessionPlanAuditFields()
...
- **Why does `counter()` connect `Community 54` to `Community 12`, `Community 22`?**
  _High betweenness centrality (0.317) - this node is a cross-community bridge._
- **Why does `_fixture_report()` connect `Community 12` to `Community 5`, `Community 61`, `Community 54`?**
  _High betweenness centrality (0.223) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 5` to `Community 131`, `Community 132`, `Community 3`, `Community 134`, `Community 135`, `Community 8`, `Community 12`, `Community 20`, `Community 162`, `Community 39`, `Community 44`, `Community 182`, `Community 183`, `Community 54`, `Community 68`, `Community 99`, `Community 100`, `Community 101`, `Community 108`, `Community 117`?**
