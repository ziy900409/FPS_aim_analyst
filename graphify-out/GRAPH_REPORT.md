...
## Corpus Check
- 658 files · ~1,259,208 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4870 nodes · 12055 edges · 278 communities (237 shown, 41 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 1485 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1f0d8bc2`
...
Cohesion: 0.05
Nodes (63): MouseSampleArena, mouseSampleCapacityForDrill(), deriveUnlockedIntervals(), overlapsAny(), segmentByTimeGap(), cmPerTurn(), countsPerTurn(), deriveMouseThrow() (+55 more)

### Community 1 - "Community 1"
Cohesion: 0.08
Nodes (73): fail(), isRecord(), parseAdsEvent(), parseAim(), parseAnnotationEvent(), parseArray(), parseAssessmentMeta(), parseBoolean() (+65 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (60): round(), simulatePurePunchPattern(), toPatternShot(), buttonCss(), createNumberInput(), drawGrid(), drawPattern(), maxSpreadRadiusDeg() (+52 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (43): resolveSpiderShotWideV1(), requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor(), enterResearcherDrillControls(), expectYawWindowMatchesResolver() (+35 more)
...
Cohesion: 0.07
Nodes (42): runTimeoutOnly(), measureAtEye(), drainSpawns(), timeoutHarness(), createMovementController(), run(), runBatches(), createTargetManager() (+34 more)
...
Cohesion: 0.06
Nodes (23): consume(), createInputSampler(), advanceUntilTracer(), createCamera(), createTarget(), fireOne(), runAtFrames(), runFrames() (+15 more)
...
Cohesion: 0.08
Nodes (30): createDrillRunner(), angularSizeToHitboxWidthU(), buildPeekClickTransferPilotConfig(), aimAt(), fireFrom(), runCadenceTimeoutExport(), buildPeekClickTransferPilotV2Config(), runCadenceTimeoutExport() (+22 more)
...
Cohesion: 0.08
Nodes (27): createDrillMetricRegistry(), createHistoryAnalysisService(), createSemaphore(), realRegistry(), closeHistoryApiState(), contentLengthExceeds(), createHistoryApiMiddleware(), createHistoryApiState() (+19 more)
...
Cohesion: 0.08
Nodes (34): buildConditionEvidence(), buildTrackingPilotEvidence(), renderTrackingPilotReportHtml(), anglesToWorld(), buildPayload(), perfectFollowerPayload(), collectFiles(), load() (+26 more)

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (39): targetHitboxToConfig(), createPointerLock(), buildRoundTripPayload(), applyHistoryOverrides(), average(), beginNextProtocolCondition(), buildCurrentExportPayload(), completeActiveProtocolCondition() (+31 more)
...
Cohesion: 0.11
Nodes (22): canonicalExportJSON(), canonicalizeValue(), buildEarlyReplayFixture(), buildFixture(), fixtureStartedAt(), buildFixture(), buildFixture(), buildIdentitySegment() (+14 more)
...
Cohesion: 0.08
Nodes (30): integratedDelta(), omegaDegPerSec(), radToDeg(), requireFiniteNumber(), deriveDetectionMetrics(), deriveSpiderShotMetrics(), isFiniteNumber(), percentile() (+22 more)
...
Cohesion: 0.14
Nodes (27): resolveTargetHitbox(), drillSourceFor(), researcherControlsDrills(), resolveAvailableDrill(), pushTarget(), activateDrill(), activeWeaponConfig(), buildSimLoop() (+19 more)
...
Cohesion: 0.1
Nodes (13): makeConfig(), reversalConfig(), run(), setup(), trackingGuardConfig(), angularSeparationDeg(), centerRelativeDirection(), minimumActiveSeparationDeg() (+5 more)
...
Cohesion: 0.13
Nodes (10): punchToThreeRad(), buildLargePayload(), ReplayEffectView, createReplayPresentationSession(), resolveWeapon(), buildReplayPunchTimeline(), lerp(), resolveReplayCameraVisualState() (+2 more)
...
Cohesion: 0.13
Nodes (16): compileSessionProgram(), deriveProgramFamilyOrder(), requireRestSeconds(), requireWeapon(), resolveBoundary(), SessionProgramCompileError, summarizeProgram(), actualWeaponIdFor() (+8 more)

### Community 55 - "Community 55"
Cohesion: 0.15
Nodes (14): resolveFamilyDrillId(), resolveWarmupDrillId(), buildFrozenSessionPlan(), createSessionRunner(), requireFamilyOrder(), resolveFamilyDrillId(), resolveWarmupDrillId(), familyRestPhase() (+6 more)
...
Cohesion: 0.2
Nodes (15): Pre-registered segmentation parameters; changes require a new version., Pre-registered segmentation parameters; changes require a new version., SegmentParams, candidate_params(), main(), _profile(), Deterministic T3 parameter sweep and optional real-data overlay generation., _same_numeric_params() (+7 more)
...
Cohesion: 0.44
Nodes (8): expectedPos(), createTrackingTrajectory(), projectTrackingAngles(), deliveredRms2d(), makeSample(), project(), sampleAt(), stationaryProfile()
...
- **Why does `bool()` connect `Community 0` to `Community 128`, `Community 64`, `Community 4`, `Community 8`, `Community 10`, `Community 106`, `Community 12`, `Community 47`, `Community 49`, `Community 57`, `Community 31`?**
  _High betweenness centrality (0.250) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 4` to `Community 0`, `Community 129`, `Community 130`, `Community 131`, `Community 132`, `Community 133`, `Community 8`, `Community 12`, `Community 18`, `Community 33`, `Community 34`, `Community 163`, `Community 161`, `Community 42`, `Community 43`, `Community 49`, `Community 184`, `Community 64`, `Community 78`, `Community 106`, `Community 107`, `Community 112`, `Community 127`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `counter()` connect `Community 49` to `Community 18`, `Community 23`?**
