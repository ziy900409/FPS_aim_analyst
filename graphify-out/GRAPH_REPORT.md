...
## Corpus Check
- 717 files · ~1,464,576 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5513 nodes · 13819 edges · 324 communities (278 shown, 46 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1773 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8cbb40be`
...
## Communities (324 total, 46 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (50): resolveTargetHitbox(), loadDrill(), createDrillRunner(), setupArmed(), aimAt(), fireFrom(), pushTarget(), runCadenceTimeoutExport() (+42 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (43): createSimLoop(), brInputs(), createCamera(), runBrVariant(), applyAimFixture(), canonicalMovingTargetFrames(), createCamera(), runMovingTarget() (+35 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (66): createRenderLoop(), lerp(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), attemptPlanForExport(), average(), beginNextProtocolCondition() (+58 more)

### Community 3 - "Community 3"
Cohesion: 0.07
Nodes (51): round(), simulatePurePunchPattern(), toPatternShot(), fixedClock(), v8SpawnTrace(), fixedClock(), v9SpawnTrace(), buttonCss() (+43 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (40): spawnBullet(), stepBullet(), clipAxis(), sweptHitTest(), collect64HzSamples(), advanceProjectiles(), applyInput(), ballisticRaycast() (+32 more)
...
Cohesion: 0.06
Nodes (25): consume(), createInputSampler(), ImpactView, drainAll(), drainToArray(), snapshot(), createBulletArena(), createImpactRing() (+17 more)
...
Cohesion: 0.08
Nodes (33): createDrillMetricRegistry(), createHistoryAnalysisService(), createSemaphore(), realRegistry(), closeHistoryApiState(), contentLengthExceeds(), createHistoryApiMiddleware(), createHistoryApiState() (+25 more)
...
Cohesion: 0.08
Nodes (31): resolveFamilyDrillId(), resolveWarmupDrillId(), findSessionPlanPreset(), compileSessionProgram(), deriveProgramFamilyOrder(), requireRestSeconds(), resolveBoundary(), actualWeaponIdFor() (+23 more)
...
Cohesion: 0.08
Nodes (33): buildConditionEvidence(), buildTrackingPilotEvidence(), renderTrackingPilotReportHtml(), collectFiles(), load(), main(), stimulusCheck(), formatTrackingDeliveredAngles() (+25 more)

### Community 16 - "Community 16"
Cohesion: 0.12
Nodes (9): resolveDrillTimeLimitMs(), resolveSpiderShotWideV1(), distanceForAngularHeight(), makeVariant(), speedForAngularRate(), variantId(), buildDeclaredWeaponByDrillId(), summarizeProgram() (+1 more)

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (25): toTrendCompatibilityKey(), createDrillOverview(), makeButton(), buildHistoryTrend(), cohortKeyId(), groupByCohort(), listCompatibilityCohorts(), selectCohort() (+17 more)
...
Cohesion: 0.08
Nodes (31): Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., render_html(), Contract tests for the one-command coach report v1 (WP-30 T-exit).  Covers the, C-D3 / GD-20: a metric without a construct gate must not appear as a number., C-D3 / GD-20: registered phase/curve constructs are labeled; SPARC/xcorr/Fitts n (+23 more)
...
Cohesion: 0.12
Nodes (38): buildEndConditionByDrillId(), angularRadiusDeg(), angularRadiusSource(), attributeShot(), cadenceWaitWithin(), candidatesAtKill(), candidatesForShot(), deriveDirection() (+30 more)
...
Cohesion: 0.08
Nodes (16): createHistoryScreen(), makeButton(), FakeDocument, FakeElement, flatten(), text(), createHistoryNavigator(), defaultWindow() (+8 more)
...
Cohesion: 0.11
Nodes (20): makeMeta(), normalizeReplayRecording(), toSceneDescriptor(), fixtureRecording(), fixtureRecording(), buildLargePayload(), buildSmallPayload(), timeFor() (+12 more)

### Community 31 - "Community 31"
Cohesion: 0.08
Nodes (22): createMovementController(), run(), runBatches(), centerRelativeAngularSeparationDeg(), copyPos(), fixedClock(), inspectV8Population(), observeCurrentV8() (+14 more)
...
Cohesion: 0.1
Nodes (37): _advanced_diagnostics(), _empty_stats(), _epsilon_or_none(), _finite(), _fitts_block(), _gap_text(), _number(), _phase_entries() (+29 more)
...
Cohesion: 0.11
Nodes (22): deriveUnlockedIntervals(), overlapsAny(), segmentByTimeGap(), annotationCountToleranceFor(), assessAnnotationChannel(), auditRun(), boolText(), countPeripheralTrials() (+14 more)
...
Cohesion: 0.1
Nodes (20): buildExportPayload(), serializeJSON(), targetHitboxToConfig(), degToRad(), makeRoundTripPayload(), tickTime(), yawDegAt(), aimAtPoint() (+12 more)
...
Cohesion: 0.14
Nodes (17): angularSizeToHitboxWidthU(), buildPeekClickTransferPilotConfig(), pilotDrillId(), buildPeekClickTransferPilotV2Config(), buildPeekClickTransferPilotV2MaskedConfig(), buildPeekClickTransferPilotV2RandomizedConfig(), peekClickTransferPilotV2CandidateLabel(), pilotV2DrillId() (+9 more)
...
Cohesion: 0.14
Nodes (8): createSceneLoadCoordinator(), SceneManager, buildLargePayload(), ReplaySceneAdapter, resolveEyeWorldBase(), nearlyEqual(), requireRoomEnvelope(), requireSpiderShotDeliveryGeometry()
...
Cohesion: 0.1
Nodes (16): SessionProgramCompileError, createSessionPlanSetup(), describeStep(), groupSchedulableDrills(), makeButton(), previewWeaponLabel(), addItem(), byAttribute() (+8 more)

### Community 59 - "Community 59"
Cohesion: 0.12
Nodes (14): deriveBrakingSamples(), baseMeta(), payload(), deriveCounterstrafeMetrics(), sidedStat(), deriveHoldClickMetrics(), derivePeekClickTransferMetrics(), buildPeekWindows() (+6 more)

### Community 60 - "Community 60"
Cohesion: 0.1
Nodes (14): makeConfig(), reversalConfig(), run(), setup(), trackingGuardConfig(), angularSeparationDeg(), centerRelativeDirection(), minimumActiveSeparationDeg() (+6 more)
...
Cohesion: 0.09
Nodes (13): createResultScreen(), makeResultActionButton(), runResultAction(), action(), diagnosisMetricIds(), FakeDocument, FakeElement, flatten() (+5 more)
...
Cohesion: 0.13
Nodes (26): check_construct_presence(), ConstructReport, ConstructRule, Session-level construct presence gate.  Complements the existing format-only g, A drill family's core construct declaration (frozen; changes require a version b, Session-level presence verdict. ``present is None`` iff the family is unregister, Resolve *drill_id* to a registered construct family.      Strips a leading ``s, Determine whether *export* contains the core construct its drill family declares (+18 more)

### Community 66 - "Community 66"
Cohesion: 0.1
Nodes (25): load_export(), Read and validate one schema v2 JSON export., Read and validate one schema v2 JSON export., Read and validate one schema v2 JSON export., Read and validate one schema v2 JSON export., D-29.2 boundary: the KI-004 defect only touches px/pz, which this WP never reads, WP-30 supersedes D-29.2: trajectory metrics consume px/pz only via strict eye ge, WP-30 supersedes D-29.2: trajectory metrics consume px/pz only via strict eye ge (+17 more)
...
Cohesion: 0.11
Nodes (11): armAndTakeRealLock(), enterResearcherDrillControls(), hudTimeValue(), loadMicroFlick(), loadMicroFlickVariantAndArm(), parseHudTimeMs(), readHudTimeMs(), armAndWaitRunning() (+3 more)
...
Cohesion: 0.17
Nodes (10): describeAttemptHold(), describeDiscardReason(), invalidAttemptBasename(), planFinalization(), snapshot(), ticksFrom(), createRunAttemptController(), createPausableTimeMapper() (+2 more)
...
Cohesion: 0.19
Nodes (15): buildCompatibilityKey(), buildSensitivityFovKey(), checkCompatibility(), checkQualityGate(), deriveSessionId(), requireBoolean(), requireNonNegativeFiniteNumber(), requireNonNegativeInteger() (+7 more)

### Community 92 - "Community 92"
Cohesion: 0.19
Nodes (20): Run the three frozen ``gate-v1`` criteria per session and return one verdict eac, reliability_gate(), _block_key(), _coupled_window(), _keys_from_state(), _noise_window(), A window whose |ω| is the key state shifted by ``lag`` ticks (key leads when ``l, Alternating A/D holds of *random* duration.      A fixed-period square wave wo (+12 more)
...
Cohesion: 0.2
Nodes (14): parseEvents(), parseExportPayload(), parseTicks(), walk(), collectFiles(), main(), buildLiftCohortReport(), isInstructionClass() (+6 more)
...
Cohesion: 0.22
Nodes (10): applyMode(), canonicalFrames(), counterstrafeFrames(), FakeRenderer, framesAt(), runCounterstrafeTrace(), runDetectionSpawnSequence(), runLegacySlotSpawnSequence() (+2 more)
...
Cohesion: 0.23
Nodes (8): canonicalExportJSON(), canonicalizeValue(), expectOk(), metaWith(), minimalMeta(), minimalPayload(), payloadWithEvents(), payloadWithTargets()
...
Cohesion: 0.23
Nodes (13): ADR-4 performance.now() 計時源, CameraController (yaw/pitch + pitch clamp + sensitivity/FOV), sensitivity counts→radians 線性係數 (OQ-1.1), clock.ts 注入式時間 (now(): performance.now(), OQ-2.3), prev/curr 雙快照 (內插用), RenderLoop alpha 內插 (lerp prev/curr, 唯讀), spiral of death 夾住 (Math.min(delta,0.25)), WP-2 T1 — SharedState (型別 + 單例) (+5 more)

### Community 166 - "Community 166"
Cohesion: 0.23
Nodes (13): ADR-2 雙迴圈解耦, ADR-3 128 Hz tick, WP-0 — 環境設置 (scaffold/createRenderer seam), WP-3 — 高頻輸入採集 (getCoalescedEvents 入緩衝), WP-5 — movement / 急停物理, WP-1 Progress Log, WP-1 — FPS 控制 + Pointer Lock (exec-plan), 決定性 (同輸入序列不同 render FPS → 逐 tick 一致) (+5 more)
...
Cohesion: 0.22
Nodes (4): createAttemptFinalizationGate(), createRetryRig(), protocolConfig(), startSession()
...
Cohesion: 0.36
Nodes (6): evaluateRecordingIntegrity(), pauseFenceClosed(), stampInsideFence(), reasonsOf(), snapshot(), ticksFrom()
...
- **Why does `bool()` connect `Community 81` to `Community 67`, `Community 38`, `Community 7`, `Community 167`, `Community 73`, `Community 107`, `Community 139`, `Community 44`, `Community 78`, `Community 54`, `Community 26`?**
  _High betweenness centrality (0.303) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 107` to `Community 129`, `Community 130`, `Community 7`, `Community 138`, `Community 13`, `Community 18`, `Community 22`, `Community 151`, `Community 152`, `Community 153`, `Community 154`, `Community 155`, `Community 156`, `Community 167`, `Community 53`, `Community 54`, `Community 188`, `Community 67`, `Community 73`, `Community 81`, `Community 88`, `Community 219`, `Community 116`, `Community 122`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 38` to `Community 81`?**
