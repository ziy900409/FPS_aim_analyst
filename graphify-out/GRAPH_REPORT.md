...
## Corpus Check
- 318 files · ~545,850 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2715 nodes · 6214 edges · 164 communities (136 shown, 28 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 945 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `38658f24`
...
Cohesion: 0.14
Nodes (3): targetHitboxToConfig(), loadDrill(), formatClearanceViolations()
...
Cohesion: 0.09
Nodes (26): key_state_signed(), _pearson(), Signed strafe key state per tick: ``D`` -> ``+1``, ``A`` -> ``-1``, both or neit, Signed Pearson r, or ``nan`` for too-few samples / a zero-variance input (PA ``_, Pre-registered ``xcorr-v1`` parameters (T0/D-31.5); changes require a new versio, XcorrParams, T2 DoD 3, proven from the source rather than by sampling inputs.      Two fact, Alternating A/D holds at a fixed period: a strafe pattern with real autocorrelat (+18 more)

### Community 25 - "Community 25"
Cohesion: 0.11
Nodes (28): _aligned(), _bootstrap_ci(), _checked_flags(), _correlogram(), _gate_verdict(), GateVerdict, _half_agreement(), key_velocity_xcorr() (+20 more)
...
Cohesion: 0.18
Nodes (20): resolveTargetHitbox(), activeSides(), assertFiniteEnvelope(), clipAxis(), collectClearanceViolations(), criticalYawDegrees(), deriveTargetEnvelopes(), envelopeForSide() (+12 more)
...
Cohesion: 0.13
Nodes (12): deriveDetectionMetrics(), buildPeekWindows(), firstTickIndexAtOrAfter(), hitTimesByShotSeq(), lastReleaseTransition(), releaseAnchor(), tickRangeForWindow(), computeCurveMetrics() (+4 more)
...
Cohesion: 0.18
Nodes (10): aimForward(), angularEccentricityDeg(), clamp(), eyeOriginForTick(), isFiniteNumber(), radToDeg(), resolveEyeOrigin(), deriveStopTransitions() (+2 more)
...
Cohesion: 0.15
Nodes (10): collect64HzSamples(), recordTargetStopEvents(), recordVisibleEvents(), simStep(), advanceUntilTracer(), createCamera(), createTarget(), fireOne() (+2 more)
...
Cohesion: 0.11
Nodes (17): generate(), Write exactly one self-contained HTML report and return its path., Write exactly one self-contained HTML report and return its path., Write exactly one self-contained HTML report and return its path., Write exactly one self-contained HTML report and return its path., Write exactly one self-contained HTML report and return its path., generate_all(), main() (+9 more)
...
Cohesion: 0.23
Nodes (9): createMovementController(), run(), runBatches(), collectImmediateSpawns(), killSequence(), motionConfig(), runDrill(), runPositions() (+1 more)
...
Cohesion: 0.36
Nodes (5): createRan1(), randomFloat(), baseClock(), holdFire(), run()
...
- **Why does `counter()` connect `Community 0` to `Community 4`, `Community 38`?**
  _High betweenness centrality (0.332) - this node is a cross-community bridge._
- **Why does `_fixture_report()` connect `Community 4` to `Community 0`, `Community 3`, `Community 31`?**
  _High betweenness centrality (0.202) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 3` to `Community 0`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 18`, `Community 29`, `Community 42`, `Community 57`, `Community 59`, `Community 62`, `Community 71`, `Community 72`, `Community 73`, `Community 74`, `Community 77`, `Community 85`, `Community 102`, `Community 103`, `Community 104`?**
