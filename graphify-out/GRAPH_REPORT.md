...
## Corpus Check
- 718 files · ~1,466,282 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5516 nodes · 13835 edges · 318 communities (274 shown, 44 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1777 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `42a910bb`
...
## Communities (318 total, 44 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (78): canonicalExportJSON(), canonicalizeValue(), fail(), isRecord(), parseAdsEvent(), parseAim(), parseAnnotationEvent(), parseArray() (+70 more)
...
Cohesion: 0.05
Nodes (44): createRig(), makeDrillConfig(), createDrillRunner(), makeConfig(), reversalConfig(), run(), setup(), setupArmed() (+36 more)
...
Cohesion: 0.05
Nodes (33): consume(), createInputSampler(), createPausableTimeMapper(), canonicalRun(), runFrames(), snap(), syntheticInputs(), ImpactView (+25 more)
...
Cohesion: 0.06
Nodes (31): createDataRecorder(), buildExportPayload(), capacityForDrill(), aimAtPoint(), aimAtTick(), makePayload(), makeVaryingHitboxPayload(), targetAtTick() (+23 more)

### Community 8 - "Community 8"
Cohesion: 0.09
Nodes (14): resolveDrillTimeLimitMs(), resolveHitFeedback(), diffFields(), flatten(), diffFields(), flatten(), payload(), tick() (+6 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (34): createSimLoop(), collectImpacts(), collectTracers(), createCamera(), createTargetManagerStub(), makeTarget(), runProjectile(), runWeapon() (+26 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (23): widePayload(), payloadWithEyeZ(), recordTicks(), recordTicks(), bearingDeg(), buildTicks(), payloadFor(), targetAt() (+15 more)
...
Cohesion: 0.08
Nodes (14): PROBE(), createSceneLoadCoordinator(), defaultLoader(), disposeScene(), loadScene(), createSceneManager(), createSceneManagerWithStatus(), SceneManager (+6 more)
...
Cohesion: 0.07
Nodes (11): realRegistry(), createHistoryClient(), HistoryClientError, isErrorBody(), isRecord(), isSuccessBody(), createHistoryLibraryController(), historyRunSummaryFromPayload() (+3 more)
...
Cohesion: 0.07
Nodes (20): SessionProgramCompileError, describeBoundary(), createRestOverlay(), FakeDocument, FakeElement, createSessionPlanSetup(), describeStep(), groupSchedulableDrills() (+12 more)
...
Cohesion: 0.13
Nodes (28): deriveTrackingMetrics(), adaptPayloadForScoredWindow(), applySmoothing(), applySmoothingToSeries(), clamp(), computeSignedBias(), computeSignedOmegaSeries(), deriveTrackingDynamics() (+20 more)
...
Cohesion: 0.13
Nodes (32): _advanced_diagnostics(), _empty_stats(), _epsilon_or_none(), _finite(), _fitts_block(), _flag_counts(), _gap_text(), _number() (+24 more)
...
Cohesion: 0.1
Nodes (13): FakeSettingsDocument, FakeSettingsElement, wireSettingsToRecorder(), applyResolutionMode(), readDevicePixelRatio(), readViewport(), requirePositiveInteger(), resolutionModeLabel() (+5 more)

### Community 60 - "Community 60"
Cohesion: 0.14
Nodes (25): annotation(), gap(), latencyCohort(), liftPayload(), liftRun(), move(), traceBlock(), annotationCountToleranceFor() (+17 more)
...
Cohesion: 0.12
Nodes (19): angularSeparationDeg(), centerRelativeDirection(), minimumActiveSeparationDeg(), centerRelativeAngularSeparationDeg(), copyPos(), fixedClock(), inspectV8Population(), observeCurrentV8() (+11 more)
...
Cohesion: 0.17
Nodes (18): collectFiles(), main(), collectFiles(), load(), loadManifest(), main(), isInstructionClass(), baseName() (+10 more)

### Community 70 - "Community 70"
Cohesion: 0.11
Nodes (9): armAndTakeRealLock(), openPlanSetup(), runLiveSessionPlan(), waitForHarness(), armAndWaitRunning(), armDrill(), installAutoArm(), pulsePointerLock() (+1 more)
...
Cohesion: 0.15
Nodes (17): integratedDelta(), omegaDegPerSec(), radToDeg(), requireFiniteNumber(), deriveDetectionMetrics(), deriveSpiderShotMetrics(), isFiniteNumber(), percentile() (+9 more)
...
Cohesion: 0.1
Nodes (21): counter(), build_report(), _counts(), _drill_summary(), generate(), main(), _parameters(), Write exactly one self-contained HTML report and return its path. (+13 more)
...
Cohesion: 0.18
Nodes (12): createHistoryScreen(), makeButton(), createHistoryNavigator(), defaultWindow(), decodeSegment(), formatHistoryHash(), historyRouteAncestors(), isHistoryHash() (+4 more)
...
Cohesion: 0.23
Nodes (10): resolveSpiderShotWideV1(), reparse(), requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor(), expectYawWindowMatchesResolver() (+2 more)
...
Cohesion: 0.14
Nodes (14): _ads_label(), _delta(), _group_key(), _groups(), _peek_row(), The three frozen ``compute-v1`` aggregates, each with n, flags and its tier., The three frozen ``compute-v1`` aggregates, each with n, flags and its tier., Partition the already-computed rows; never recompute with different parameters. (+6 more)
...
Cohesion: 0.23
Nodes (6): enterResearcherDrillControls(), hudTimeValue(), loadMicroFlick(), loadMicroFlickVariantAndArm(), parseHudTimeMs(), readHudTimeMs()
...
Cohesion: 0.5
Nodes (3): targetHitboxToConfig(), buildRoundTripPayload(), parseSpiderShot()
...
Cohesion: 0.5
Nodes (4): report_filename(), test_cli_defaults_to_the_synthetic_timeline_fixture(), test_every_fixture_produces_a_report(), test_group_by_runs_and_names_every_group()
...
- **Why does `bool()` connect `Community 76` to `Community 35`, `Community 163`, `Community 137`, `Community 75`, `Community 107`, `Community 177`, `Community 18`, `Community 51`, `Community 84`, `Community 82`, `Community 81`, `Community 52`, `Community 25`?**
  _High betweenness centrality (0.302) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 107` to `Community 130`, `Community 131`, `Community 14`, `Community 150`, `Community 151`, `Community 152`, `Community 153`, `Community 26`, `Community 27`, `Community 162`, `Community 163`, `Community 164`, `Community 39`, `Community 48`, `Community 51`, `Community 52`, `Community 76`, `Community 81`, `Community 211`, `Community 89`, `Community 117`, `Community 124`, `Community 125`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 35` to `Community 76`?**
