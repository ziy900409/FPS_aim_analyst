...
## Corpus Check
- 95 files · ~146,183 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 746 nodes · 1591 edges · 43 communities (28 shown, 15 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 114 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fe08690d`
...
Cohesion: 0.05
Nodes (57): createDataRecorder(), createDrillRunner(), setup(), consume(), createInputSampler(), applyInput(), ballisticRaycast(), createSimLoop() (+49 more)
...
Cohesion: 0.09
Nodes (39): runtime(), buttonCss(), createNumberInput(), drawGrid(), drawPattern(), maxSpreadRadiusDeg(), mountPatternViewer(), niceStep() (+31 more)
...
- **Why does `createSharedState()` connect `Community 0` to `Community 2`, `Community 19`, `Community 5`?**
