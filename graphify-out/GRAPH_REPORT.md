...
## Corpus Check
- 721 files · ~1,472,445 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5548 nodes · 13881 edges · 314 communities (272 shown, 42 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1778 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6f5a2a63`
...
## Communities (314 total, 42 thin omitted)
...
Cohesion: 0.05
Nodes (65): downloadJSON(), createRenderLoop(), lerp(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), attemptPlanForExport(), beginNextProtocolCondition() (+57 more)
...
Cohesion: 0.05
Nodes (39): collect64HzSamples(), createSimLoop(), canonicalRun(), runFrames(), snap(), syntheticInputs(), applyAimFixture(), canonicalMovingTargetFrames() (+31 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (42): createRig(), makeDrillConfig(), createDrillRunner(), makeConfig(), reversalConfig(), run(), setup(), setupArmed() (+34 more)

### Community 5 - "Community 5"
Cohesion: 0.08
Nodes (28): resolveTargetHitbox(), loadDrill(), aimAt(), fireFrom(), pushTarget(), canonicalLongrangeFrames(), createCamera(), runLongrangeTracking() (+20 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (31): createDataRecorder(), FakeSettingsDocument, wireSettingsToRecorder(), capacityForDrill(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), cameraLookingDownZ() (+23 more)
...
Cohesion: 0.06
Nodes (41): spawnBullet(), stepBullet(), clipAxis(), sweptHitTest(), advanceProjectiles(), applyInput(), ballisticRaycast(), composeProjectileRay() (+33 more)

### Community 9 - "Community 9"
Cohesion: 0.08
Nodes (52): deriveTrackingMetrics(), deriveTrackingSamples(), adaptPayloadForScoredWindow(), applySmoothing(), applySmoothingToSeries(), clamp(), computeSignedBias(), computeSignedOmegaSeries() (+44 more)

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (52): _axis_grid(), _better(), bootstrap_f1_interval(), confusion_matrix(), ConfusionMatrix, _duration_grid(), evaluate_layers(), F1Interval (+44 more)
...
Cohesion: 0.07
Nodes (25): createAttemptFinalizationGate(), buildTrackingCompatibilityKey(), checkTrackingCompatibility(), requireAscendingRange(), requirePositiveFiniteNumber(), requireTrackingTrajectorySummary(), requireTrimmedNonEmptyString(), createTrackingPilotSession() (+17 more)
...
Cohesion: 0.07
Nodes (24): createDrillBrowser(), createFakeController(), createFakeNavigator(), FakeDocument, FakeElement, findByTag(), flatten(), setup() (+16 more)
...
Cohesion: 0.09
Nodes (35): buildCompatibilityKey(), buildSensitivityFovKey(), checkCompatibility(), checkQualityGate(), deriveSessionId(), requireBoolean(), requireNonNegativeFiniteNumber(), requireNonNegativeInteger() (+27 more)
...
Cohesion: 0.1
Nodes (27): createHistoricalRunDetail(), makeButton(), FakeDocument, FakeElement, findByTag(), flatten(), readyValue(), setup() (+19 more)
...
Cohesion: 0.11
Nodes (14): consume(), drainAll(), drainToArray(), snapshot(), createBulletArena(), createImpactRing(), createInputRing(), createShotRayRing() (+6 more)
...
Cohesion: 0.16
Nodes (17): payloadWithEyeZ(), recordTicks(), makeMeta(), makePayload(), makeTick(), normalizeReplayRecording(), toSceneDescriptor(), fixtureRecording() (+9 more)
...
Cohesion: 0.14
Nodes (25): createRan1(), expectedPos(), boundedSpeedScale(), buildSinusoidComponents(), clamp(), createBandLimited2dV1(), createReversal2dV1(), createTrackingTrajectory() (+17 more)
...
Cohesion: 0.17
Nodes (21): _aim_forward(), _column(), epsilon_deg(), _finite_column(), _finite_scalar(), _geometry(), _hitbox(), OmegaResult (+13 more)
...
Cohesion: 0.2
Nodes (14): collectFiles(), main(), buildLiftCohortReport(), extractAnnotationIntervals(), isInstructionClass(), baseName(), parseEntry(), readLiftManifest() (+6 more)
...
Cohesion: 0.22
Nodes (9): resolveSpiderShotWideV1(), requirePositiveFinite(), resolveSpiderWideYawPitch(), SpiderWideResolveError, spiderWideResolveInput(), limitFor(), offAxisDeg(), windowCorners() (+1 more)
...
Cohesion: 0.24
Nodes (8): deriveUnlockedIntervals(), overlapsAny(), segmentByTimeGap(), deriveSamplingHealth(), countDetected(), readResolvedAspect(), readSamplingHealth(), summarizeRun()
...
Cohesion: 0.19
Nodes (11): widePayload(), collectFiles(), load(), loadManifest(), main(), assessDirectionality(), bool(), fmt() (+3 more)
...
Cohesion: 0.33
Nodes (7): punchToThreeRad(), createReplayPresentationSession(), resolveWeapon(), buildReplayPunchTimeline(), lerp(), resolveReplayCameraVisualState(), samplePunchDeg()
...
Cohesion: 0.39
Nodes (7): deriveProjectedFootprint(), footprintSpread(), nonNegativeFinite(), positiveFinite(), projectedSphereFootprint(), readResolvedFovDegVertical(), toRadians()
...
- **Why does `bool()` connect `Community 123` to `Community 64`, `Community 225`, `Community 2`, `Community 67`, `Community 40`, `Community 74`, `Community 11`, `Community 12`, `Community 77`, `Community 115`, `Community 57`, `Community 28`, `Community 159`?**
  _High betweenness centrality (0.299) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 2` to `Community 11`, `Community 12`, `Community 17`, `Community 150`, `Community 151`, `Community 152`, `Community 153`, `Community 154`, `Community 159`, `Community 160`, `Community 31`, `Community 162`, `Community 38`, `Community 57`, `Community 64`, `Community 73`, `Community 211`, `Community 212`, `Community 89`, `Community 122`, `Community 123`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 40` to `Community 123`?**
