...
## Corpus Check
- 679 files · ~1,352,299 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5241 nodes · 13021 edges · 297 communities (253 shown, 44 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1690 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cfe2e63e`
...
## Communities (297 total, 44 thin omitted)
...
Cohesion: 0.06
Nodes (51): createDrillRunner(), makeConfig(), reversalConfig(), run(), setup(), setupArmed(), trackingGuardConfig(), runCadenceTimeoutExport() (+43 more)
...
Cohesion: 0.06
Nodes (63): assess_sufficiency(), _axis_grid(), _better(), bootstrap_f1_interval(), confusion_matrix(), decide(), _duration_grid(), evaluate_layers() (+55 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (53): resolveHitFeedback(), createPointerLock(), activateDrill(), activeWeaponConfig(), applyHistoryOverrides(), average(), beginNextProtocolCondition(), buildCurrentExportPayload() (+45 more)
...
Cohesion: 0.08
Nodes (33): resolveTargetHitbox(), targetHitboxToConfig(), loadDrill(), aimAt(), fireFrom(), pushTarget(), measureAtEye(), buildRoundTripPayload() (+25 more)
...
Cohesion: 0.06
Nodes (29): consume(), createInputSampler(), canonicalRun(), runFrames(), snap(), syntheticInputs(), both(), moving() (+21 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (34): enumerateLandings(), sceneWithRoom(), resolveEyeWorldBase(), err(), requireColorNumber(), requireFiniteNumber(), requireNonEmptyString(), requireNonNegativeNumber() (+26 more)
...
Cohesion: 0.09
Nodes (23): createDataRecorder(), assertPositiveFinite(), createAimIntegrator(), resolveMouseGain(), cameraLookingDownZ(), driveRenderAndSim(), fireAt(), fixedClock() (+15 more)

### Community 23 - "Community 23"
Cohesion: 0.12
Nodes (7): resolveDrillTimeLimitMs(), distanceForAngularHeight(), makeVariant(), speedForAngularRate(), variantId(), createDrillMetricRegistry(), buildDeclaredWeaponByDrillId()
...
Cohesion: 0.08
Nodes (32): ⑩ One-line "why this metric is absent" notes for blocked-by-data P2 diagnostics., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., Render the model to one self-contained HTML document (no external resources)., _render_diagnostics_gaps(), render_html(), Contract tests for the one-command coach report v1 (WP-30 T-exit).  Covers the (+24 more)
...
Cohesion: 0.07
Nodes (10): realRegistry(), createHistoryClient(), isErrorBody(), isRecord(), isSuccessBody(), createHistoryPersistence(), makeAssessmentPayload(), createHistorySaveStatus() (+2 more)
...
Cohesion: 0.14
Nodes (14): widePayload(), recordTicks(), makeMeta(), makePayload(), makeTick(), normalizeReplayRecording(), toSceneDescriptor(), fixtureRecording() (+6 more)
...
Cohesion: 0.08
Nodes (26): _direction_change_variance(), hover_analogue(), _hover_window_samples(), The reference stage 3 rule: does the boundary look like a hovering, jittering ha, The hover window: the samples entering the gap, spanning the source's hover wind, Variance of the wrapped change in movement direction across a window (rad^2)., counts_value(), parameter() (+18 more)
...
Cohesion: 0.14
Nodes (16): deriveUnlockedIntervals(), overlapsAny(), segmentByTimeGap(), extractAnnotationIntervals(), buildLiftSegmentationGolden(), lastSampleMs(), segmentationAt(), verifyLiftSegmentationGolden() (+8 more)

### Community 57 - "Community 57"
Cohesion: 0.11
Nodes (25): _aligned(), _bootstrap_ci(), _checked_flags(), _correlogram(), _gate_verdict(), GateVerdict, _half_agreement(), _key_transitions() (+17 more)
...
Cohesion: 0.14
Nodes (22): key_event_crosscheck(), key_state_signed(), _pearson(), Signed strafe key state per tick: ``D`` -> ``+1``, ``A`` -> ``-1``, both or neit, Cross-check the tick-derived key state against the additive ``key`` event stream, Signed Pearson r, or ``nan`` for too-few samples / a zero-variance input (PA ``_, _key_events(), T2 DoD 3, proven from the source rather than by sampling inputs.      Two fact (+14 more)
...
Cohesion: 0.13
Nodes (13): parseEvents(), parseExportPayload(), parseTicks(), expectOk(), metaWith(), minimalMeta(), minimalPayload(), payloadWithEvents() (+5 more)
...
Cohesion: 0.13
Nodes (7): capacityForDrill(), keyMaskFromKeys(), keyMaskFromState(), keysFromMask(), TickArena, payloadWithEyeZ(), recordTicks()
...
Cohesion: 0.18
Nodes (14): punchToThreeRad(), createReplayPresentationSession(), resolveWeapon(), buildReplayPunchTimeline(), lerp(), resolveReplayCameraVisualState(), samplePunchDeg(), build() (+6 more)
...
Cohesion: 0.15
Nodes (18): Decide, from the parameters alone, whether either stage 2 branch can fire at thi, stage_2_reachability(), assert_block_matches_golden(), Return the byte-level mismatches between a block and the golden cut from it. Emp, load_lift_golden(), Read and validate one committed Stage 1 golden., Read and validate one committed Stage 1 golden., build_report() (+10 more)
...
Cohesion: 0.12
Nodes (3): buildLargePayload(), ReplayEffectView, ReplaySceneAdapter
...
Cohesion: 0.23
Nodes (12): buildTrackingContactCoverageReport(), buildTrackingContactReport(), renderTrackingContactReportHtml(), serializeTrackingContactReport(), aimAt(), onTargetPayload(), tick(), collectFiles() (+4 more)
...
Cohesion: 0.3
Nodes (12): collectFiles(), load(), loadManifest(), main(), isInstructionClass(), baseName(), parseEntry(), readLiftManifest() (+4 more)
...
Cohesion: 0.23
Nodes (12): ADR-4 時間源 (performance.now()), counterstrafe_ad_v1 drill config, WP-2 sim tick, WP-5 fire/急停/首發 (即時狀態), WP-6 drill 控制 (DrillRunner/DrillLoader), WP-7 資料記錄與匯出 (F1/F2) ★M3, M3 — 完整 drill 能端到端匯出資料 (可開始 pilot), 時間源同源 (performance.now() 基準) (+4 more)
...
Cohesion: 0.27
Nodes (11): SimLoop (src/loop/SimLoop.ts), 附錄 C 匯出 schema (meta/ticks[]/events[]), DataRecorder (src/data/DataRecorder.ts), export.ts (downloadJSON/downloadCSV), RingBuffer (src/data/RingBuffer.ts), WP-7 T1 — Ring buffer 每 tick 記錄, WP-7 T2 — 事件記錄 (t_visible/命中/首發/急停), WP-7 T4 — JSON/CSV 匯出 (+3 more)
...
Cohesion: 0.24
Nodes (10): WP-9 整合 + 計時效度驗證, compute.ts (computeMetrics 純函式), 規格 §5 八項指標, MetricsDashboard, 純機械計算 (無主觀評分), ResultScreen (src/ui/ResultScreen.ts), WP-8 T1 — 指標計算 (§5 八指標純函式), WP-8 T2 — 結果頁 (DOM) (+2 more)
...
Cohesion: 0.53
Nodes (8): conditionAggregates(), durationOfSamples(), identityForArtifact(), metric(), projectBrCompanion(), projectPresentation(), projectPureSummary(), projectRun()
...
Cohesion: 0.36
Nodes (8): ADR-1 backend metadata, WP-0 createRenderer backend seam, WP-1 sensitivity, WP-4 t_visible/命中事件, metadata.ts (collectMeta), 環境 metadata 完整性 (研究效度前提), WP-7 T0 — Entry gate, WP-7 T3 — 環境 metadata
...
- **Why does `bool()` connect `Community 82` to `Community 67`, `Community 101`, `Community 73`, `Community 45`, `Community 14`, `Community 15`, `Community 148`, `Community 55`, `Community 56`, `Community 57`, `Community 60`, `Community 29`?**
  _High betweenness centrality (0.288) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 101` to `Community 139`, `Community 140`, `Community 141`, `Community 14`, `Community 142`, `Community 15`, `Community 146`, `Community 19`, `Community 148`, `Community 29`, `Community 30`, `Community 41`, `Community 55`, `Community 58`, `Community 190`, `Community 191`, `Community 67`, `Community 80`, `Community 82`, `Community 111`, `Community 116`, `Community 117`, `Community 118`, `Community 123`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `test_a_lift_run_labels_matched_gaps_lift_and_leaves_the_rest_as_background()` connect `Community 45` to `Community 82`?**
