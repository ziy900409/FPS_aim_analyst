...
## Corpus Check
- 348 files · ~577,020 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2866 nodes · 6609 edges · 190 communities (160 shown, 30 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 971 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c8a86d66`
...
Cohesion: 0.07
Nodes (41): appendCurveBand(), appendCurveLine(), appendGuideLine(), appendPath(), classifyResidualSpeed(), countFlags(), createDiagnosisSummary(), createPromotedSummary() (+33 more)
...
Cohesion: 0.08
Nodes (29): createDrillRunner(), makeConfig(), reversalConfig(), run(), setup(), brInputs(), createCamera(), runBrVariant() (+21 more)
...
Cohesion: 0.12
Nodes (20): createDataRecorder(), capacityForDrill(), keyMaskFromKeys(), keyMaskFromState(), keysFromMask(), TickArena, assertPositiveFinite(), createAimIntegrator() (+12 more)
...
Cohesion: 0.19
Nodes (30): collectMeta(), normalizeOverflow(), normalizeStartedAt(), requireAssessmentMeta(), requireBackend(), requireBoolean(), requireClutterTier(), requireDisplaySelfReport() (+22 more)

### Community 19 - "Community 19"
Cohesion: 0.12
Nodes (25): createPointerLock(), isOutsideCorridor(), average(), beginNextProtocolCondition(), buildCurrentExportPayload(), completeActiveProtocolCondition(), diagnosisForPayload(), diagnosisInputsForPayload() (+17 more)
...
Cohesion: 0.15
Nodes (11): aimForward(), angularDistanceDeg(), angularEccentricityDeg(), clamp(), eyeOriginForTick(), radToDeg(), deriveStopTransitions(), fireAngleError() (+3 more)

### Community 36 - "Community 36"
Cohesion: 0.11
Nodes (22): DetectSample, One presentation's detection derivation. Mirrors TS ``DetectionPresentationDeriv, PeekWindow, One ``[visible, next visible)`` presentation window in measurement time., One ``[visible, next visible)`` presentation window in measurement time., _can_smooth(), _finalize(), _is_locally_uniform() (+14 more)
...
Cohesion: 0.15
Nodes (19): resolveTargetHitbox(), activeSides(), assertFiniteEnvelope(), clipAxis(), collectClearanceViolations(), criticalYawDegrees(), deriveTargetEnvelopes(), envelopeForSide() (+11 more)
...
Cohesion: 0.14
Nodes (12): buildExportPayload(), degToRad(), makeRoundTripPayload(), tickTime(), yawDegAt(), aimAtPoint(), aimAtTick(), makePayload() (+4 more)
...
Cohesion: 0.2
Nodes (7): payload(), tick(), buildCounterstrafeReversalPilotConfigs(), buildHoldClickPilotConfigs(), buildHoldTrackPilotConfigs(), buildSpiderShotPilotConfigs(), allConfigs()

### Community 51 - "Community 51"
Cohesion: 0.17
Nodes (12): createRan1(), randomFloat(), applyAimFixture(), canonicalSprayFrames(), collectImpacts(), createCamera(), round(), runSpray() (+4 more)
...
Cohesion: 0.13
Nodes (9): deriveDetectionMetrics(), createMetricsDashboard(), computeCurveMetrics(), computePhaseMetrics(), computePromotedMetrics(), sortedTicks(), loadExport(), loadJson() (+1 more)
...
Cohesion: 0.26
Nodes (14): activeWeaponConfig(), buildSimLoop(), currentMouseGain(), findSceneOption(), installSceneLoad(), loadDrillById(), loadSceneById(), resetRunPresentation() (+6 more)
...
- **Why does `counter()` connect `Community 20` to `Community 56`, `Community 2`?**
  _High betweenness centrality (0.337) - this node is a cross-community bridge._
- **Why does `_fixture_report()` connect `Community 2` to `Community 1`, `Community 11`, `Community 20`?**
  _High betweenness centrality (0.204) - this node is a cross-community bridge._
- **Why does `build_peek_windows()` connect `Community 1` to `Community 0`, `Community 2`, `Community 4`, `Community 20`, `Community 23`, `Community 29`, `Community 36`, `Community 41`, `Community 47`, `Community 68`, `Community 74`, `Community 86`, `Community 88`, `Community 93`, `Community 94`, `Community 95`, `Community 107`, `Community 120`, `Community 121`?**
