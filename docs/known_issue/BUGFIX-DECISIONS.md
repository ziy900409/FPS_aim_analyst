...
| [KI-005](KI-005-omega-render-sim-aliasing.md) | ω(t) 受 render(240Hz)/sim(128Hz)**zero-order-hold aliasing** 汙染:每 8 tick 一個假凹口 → `merged_adjacent_peaks` 15/19,有效產率僅 4/19。**推翻 KI-004「①③④⑤⑥ 不受影響」的豁免,M14 ③④⑤ 撤回** | BD-005(§2,**A1 已落地**:選項 A + 感度由 meta 重建 + 不做過渡期 C;**A2-T1/T2 已完成**,FM-1 關閉)· 計畫 [KI-005-A/](KI-005-A/README.md) | 🟡 A1+A2-T1/T2 已完成,A2-T3(`seg-v2`)待辦 |
...
| **狀態** | ✅ **A1 已落地(2026-08-06),A2-T1/A2-T2 已完成(2026-08-07)**。根因經測試 A 證實,修法依 2026-08-06 拍板(A / meta 重建 / 不做 C)落地;真實硬體資料複驗支持修法有效,FM-1 關閉。**下一步:[A2-T3](KI-005-A/A2-blocked-plan.md#a2-t3--seg-v2-重掃與凍結) `seg-v2` 重掃與凍結**,其後 A2-T4 M14 ③④⑤ 重新宣告。A1 交付的是量測儀器的正確性,**M14 ③④⑤ 於 A2-T4 完成前仍維持撤回**。 |
