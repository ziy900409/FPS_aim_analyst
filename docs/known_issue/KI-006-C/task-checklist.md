...
- [x] [KI-006](../KI-006-m14-sample-no-counterstrafe.md) 狀態改為「🟡 C 已落地;B(重新採樣)待 A2」+ §4 選項 C 標「已落地」+ §6 **OQ-KI6-2 關閉**
- [x] [BUGFIX-DECISIONS.md](../BUGFIX-DECISIONS.md) §1 索引 + BD-006 條目補「C 落地」段(含四份 fixture 判定與凍結門檻)
- [x] [KI-005-A / A2-blocked-plan.md](../KI-005-A/A2-blocked-plan.md) 前置條件清單改為引用 [README §6](README.md) 的 B-1~B-5
- [x] [CONTEXT.md](../../../CONTEXT.md) 新增 **construct presence gate** 詞條,與既有 **reliability gate** 互相指路
- [x] [analysis-segments.md](../../operational/analysis-segments.md) flag 表 + “Real-export validation” 段加註 · [research/README.md](../../../research/README.md) fixture 表 · [MAP.md](../../MAP.md) / [exec-plan/README.md](../../exec-plan/README.md) 的 KI-006 敘述

**T-exit(2026-08-07)**:八道硬閘(G-1~G-8)、14 個 FR、6 個 NFR 全數 ✅,證據見 [T-exit-gate.md](T-exit-gate.md)。C 階段交付完成;C 不解除任何 M14 撤回(見 T-exit §4 明文聲明)。
