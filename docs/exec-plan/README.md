...
| **WP-57** | [`active/stage12/wp-57-spider-shot-wide-flick/`](active/stage12/wp-57-spider-shot-wide-flick/README.md) | `spider-shot-wide-v1`：eye-frame 球面 yaw/pitch spawn + arm-time FOV/aspect 解析 + 寬場 arena + 抬滑鼠疑慮標註 | —（exit gate 即交付） | 無硬相依（參照 WP-56 的 `playerControl.translation` seam） | 9.5–16 | 🟡 **T0／T1／T2／T3／T4 ✅（2026-09-07）+ T6 ✅（2026-09-08）**；**只剩 T5（抬滑鼠標註）與 T-exit** —— OQ-57.7 已由 KI-026／BD-026／[GD-32](DECISIONS.md) 拍板為選項 (b) 並落地（匯出角度統一 eye-frame）；T6 已交付 arm-time 接線 + 4 個 Edge E2E + FOV 60／75／120 實機截圖（T3 步驟 8 結案），並收斂 OQ-57.3、部分收斂 OQ-57.4（`timeLimitMs` → 60000） |
