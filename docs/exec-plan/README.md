...
> **M14 🟡**：①⑥ 維持,②於 KI-004 S1 落地後重新宣告(2026-08-06),③④⑤ 因 KI-005/KI-006 於 2026-08-06 撤回(詳見 §3 M14 列)。**WP-30/31 entry blocker 因 KI-005/KI-006 兩條獨立、尚未落地的理由仍維持**。效度範圍仍限單一 counter-strafe 樣本。

| WP | 子資料夾 | 目標 | 里程碑 | 相依 | 估時 | 狀態 |
|---|---|---|---|---|---|---|
| **WP-28** | [`active/stage4/wp-28-research-foundation/`](active/stage4/wp-28-research-foundation/README.md) | research 地基：四目錄制 + schema v2 ingest + ω(t)/ε(t)（**含 ε 雙向 parity 閘**）+ submovement 分段（參數凍結）+ quality flags + 一鍵 pipeline | **M14 🟡** | M4 ✅ + WP-16 ✅ + M11/M12 ✅ | 3.5–4.5 | ✅ **task 全數完成(2026-08-05);M14 ①⑥維持/②已重新宣告(2026-08-06)/③④⑤ 撤回(KI-005/KI-006)** |
...
| **M14 🟡**<br>(①⑥ 維持;②於 [KI-004](../known_issue/KI-004-sim-world-unit-domain-mismatch.md) S1 落地後重新宣告 2026-08-06;③④⑤ 因 [KI-005](../known_issue/KI-005-omega-render-sim-aliasing.md)/[KI-006](../known_issue/KI-006-m14-sample-no-counterstrafe.md) 撤回) | ① 真實匯出 3,507 ticks / dt 7.8125ms / gap 0(維持)⑥ `uv run pytest` 74→183 passed(維持)。**②** 原六項全綠宣告(2026-08-05)因 ε(t) 量測原點錯誤(D2a/D2b,實測偏差 12.52°/67.11°)撤回;**KI-004 S1 落地後以新證據重新宣告**(閘 ① `fire.offsetDeg` oracle ≤0.5°、閘 ② 閉式幾何 ≤1e-9、parity fixture 重產綠、`test:ci` 88 files/694 tests + 19 e2e、`uv run pytest` 183 passed;詳見 [WP-28 progress.md](active/stage4/wp-28-research-foundation/progress.md)「M14 ② 重新宣告」段)。**③④⑤ 另因 KI-005(ω(t) render/sim aliasing)+ KI-006(真實樣本無 counter-strafe 構念)於 2026-08-06 撤回,兩者尚未落地** | WP-28 | research ingest/parity 機制 + ε 地基(僅 KI-004 原因)已修正;**WP-30/31 entry blocker 因 KI-005/KI-006 兩條獨立、尚未落地的理由仍維持**,尚不得展開。效度聲稱限單一匿名 counter-strafe 樣本 |
