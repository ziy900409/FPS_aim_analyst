...
|---|---|---|---|---|---|---|
| **WP-0** | [`active/wp-0-environment-setup/`](active/wp-0-environment-setup/README.md) | 空場景 + cross-origin isolation + backend 偵測 | → M1 | — | 3–5 | 🟡 規劃完成 |
| **WP-1** | [`active/wp-1-fps-pointerlock/`](active/wp-1-fps-pointerlock/README.md) | FPS 控制 + Pointer Lock + 原始輸入 | → M1 | WP-0 | 2–3 | 🟡 規劃完成 |
