...
| ✅ | **T2** protocol 執行器 + 解析度 × 偵測受試者內 E2E(auto + 真 fullscreen 實機證據) | [T2-resolution-protocol-e2e.md](T2-resolution-protocol-e2e.md) | T0 | High |
| ✅ | **T3** 決定性回歸擴充 + 驗收清單 C(全 10 項)+ pilot protocol | [T3-determinism-acceptance-c.md](T3-determinism-acceptance-c.md) | T1, T2 | Med |
| ✅ | **T-exit** M10 宣告(stage3 交付;2026-07-10) | [T-exit-gate.md](T-exit-gate.md) | T1–T3 | — |
