...
⚠️ **T6 接手的兩筆未結項**：(a) ✅ **FR-70.7 的橫幅文案已補為 run 級**（2026-09-15，T6 第一個切片；T3 於此才真正達成 DoD，見 [progress.md §T3.4](progress.md#t34-補結-fr-707-的文案2026-09-15t6-第一個切片)）；(b) **FM-70.4 的實機手動驗證清單**（L1 ⇒ e2e 永遠測不到它）落在 T6 的文件切片。
