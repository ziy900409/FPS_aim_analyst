...
| **WP-46**(暫用) | [`wp-46-spider-shot-v2-aimlab-parity/`](wp-46-spider-shot-v2-aimlab-parity/README.md) | `spider-shot-v2` 對齊 Aim Lab Spidershot:球體目標(真碰撞,擴充 GD-7)、中心免逾時、60 秒時限、視角直徑換算 hitbox | ⬜ 規劃完成,尚未開跑 T0 |
