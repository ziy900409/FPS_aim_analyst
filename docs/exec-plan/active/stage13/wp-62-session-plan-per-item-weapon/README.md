...
| **Status** | 🟡 **T0 ✅ / T1 ✅ / T2 ✅ / T3 ✅（2026-09-10）**，T4 未開工。基線見 [progress.md §T0.1](progress.md)，T1 的 8-vs-4 修正見 [§T1](progress.md)，T2 的逐位回歸 sha256 見 [§T2](progress.md)，T3 的跨 FPS 逐位一致與四道突變見 [§T3](progress.md) |
