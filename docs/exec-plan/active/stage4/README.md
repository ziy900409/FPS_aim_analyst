...
| **狀態** | 🟡 **已採納,WP-28 展開中**;WP-28 ⬜ · WP-29 ⬜ · WP-30 ⬜ · WP-31 ⬜ · WP-32 ⬜。**已知阻塞項**:真實 drill 匯出樣本未取得(使用者後補)→ M14 不得宣告(§4);演算法開發以合成匯出產生器解鎖(WP-28 T1) |
...
|---|---|---|---|---|---|---|---|
| **WP-28** | [wp-28-research-foundation/](wp-28-research-foundation/README.md) | research 地基:scaffold + ingest + 角運動學(**含 ε parity**)+ submovement 分段 + quality flags | P0-2 | **M14** | M4 ✅ + WP-16 ✅ + M11/M12 ✅ | 3.5–4.5 | ⬜ |
...
- [ ] [CLAUDE.md](../../../../CLAUDE.md) §4 硬約束追加 C-D1~C-D4(落 WP-28 T0)。
...
- [ ] `docs/operational/analysis-segments.md`(新,WP-28 T-exit:分段參數 registry + 限制)。
