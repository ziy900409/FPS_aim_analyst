...
### 判定:M14 ✅ —— 六項全數維持/重新宣告(②於 2026-08-06、③④⑤於 2026-08-07)

原判定(六項全綠、WP-30/31 解除 blocker)曾分兩次撤銷(② 於 2026-08-05,③④⑤ 於 2026-08-06),**兩者現已依序重新宣告,M14 六項全數恢復**:
...
- **③④⑤ 撤回(2026-08-06,[KI-005](../../../../known_issue/KI-005-omega-render-sim-aliasing.md) + [KI-006](../../../../known_issue/KI-006-m14-sample-no-counterstrafe.md))→ 重新宣告(2026-08-07)** —— 見下方「豁免撤銷」。KI-005-A / A2(T1–T4)全數完成:新採樣(A2-T1)、四項複驗(A2-T2,FM-1 以機器精度關閉)、`seg-v2` 重掃凍結(A2-T3)、逐項重新宣告 + KI-006 解除判定(A2-T4)。KI-006 §6 B-1~B-5 驗收清單全數滿足,**KI-006 CLOSED**。詳見 [KI-005-A/A2-blocked-plan.md § A2-T4](../../../../known_issue/KI-005-A/A2-blocked-plan.md#a2-t4--m14-③④⑤-重新宣告-✅-已完成2026-08-07)。
- **① 維持** —— ingest/dt 屬 schema 與取樣層檢核,與 aim 差分及行為內容皆無關;3,507 ticks / gap 0 / uniform 仍有效。
- **⑥ 維持** —— `uv run pytest` 74→228 passed / exit 0,與上述缺陷無關。
- **WP-30/31 entry blocker 已解除(2026-08-07)**,原有**三條相互獨立**的理由:KI-004(ε 原點,2026-08-06 解除)、KI-005(ω 汙染)、KI-006(樣本無構念)——KI-005/KI-006 兩條已於 A2-T4 全數解除,entry blocker 整體解除,WP-30/WP-31 可展開。
- **WP-29 不受影響**(只吃 `events` 與 `ticks[].keys`),已於 2026-08-05 完成交付。
- OQ-S4-8 維持關閉(fixture 政策與此無關)。

> **效度聲稱不擴大**:M14 ③④⑤ 重新宣告僅恢復儀器/分段地基的正確性,措辭沿用既有限制——仍限單一匿名受試者、n=3 session(A2-T1)、非母體層級證據。
