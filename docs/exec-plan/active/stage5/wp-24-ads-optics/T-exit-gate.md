...
- [ ] `npm run test:ci` exit 0(證據記 progress)。
- [ ] 交付證據記 progress(Outcomes):
  ...
  - **手動**:開鏡體感(FOV/感度/overlay/準心置中)四項實機確認。
- [ ] OQ ledger 收斂:OQ-S5-1(GD-16)/OQ-S5-6/OQ-24.1 回填。
- [ ] CONTEXT.md 回寫:ADS/heldAds/zoom 感度換算 術語入 §A/§G(與本 task 同 commit)。
- [ ] 索引翻牌:本資料夾 README 狀態 → ✅;[上層 README §3](../README.md) WP-24 列。
