...
- [x] `npm run test:ci` exit 0(tsc clean;Vitest 67 files/527 tests;Playwright 15 tests;2026-07-10,progress 記錄)。
- [x] M11 四項證據記 progress(Outcomes):
...
- [x] OQ ledger 收斂:OQ-S5-4 / OQ-23.1 / OQ-23.2 回填;帶著走的項移交
  (OQ-23.2 場景尺度 → WP-26 T0)。
- [x] CONTEXT.md 候選回寫確認(hitbox 參數化語意——H1 單一 hitbox 不變、尺寸成為資料)。
- [x] 索引翻牌:本資料夾 README 狀態 → ✅;[上層 README §3](../README.md) WP-23 列 + M11;
