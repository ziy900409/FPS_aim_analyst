...
- [ ] OQ ledger 收斂:OQ-S5-2(GD-17)/OQ-S5-5/OQ-25.1~25.3 回填。
- [ ] CONTEXT.md 回寫確認(tracer/shotRays、projectile/彈道模型 gate、
  time-of-flight、lead 誤差 術語)。
- [ ] 索引翻牌:本資料夾 README → ✅;[上層 README §3](../README.md) WP-25 列 + M12;
