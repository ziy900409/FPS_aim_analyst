...
| **T6** | E2E 整合 + 決定性/回歸對帳 | T3 + T4 + T5 | Med | 1–1.5d | `session-orchestrator.spec.ts` 更新後全綠；一條真實瀏覽器 E2E 跑完「3 drill × 2 reps」縮小版 program 並驗證休息時長與匯出份數；既有決定性回歸零修改全綠 |
