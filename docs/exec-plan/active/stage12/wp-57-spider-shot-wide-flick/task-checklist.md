...
| ⬜ | **T4** 匯出 provenance 與 `side` 欄位 | [T4-export-and-conditions.md](T4-export-and-conditions.md) | T2 | Med |
...
T1 完成後 **T2 與 T3 可並行**（T3 只需要 resolver，不需要 sim 分支）。T4 需要 T2 產出的真實匯出。
