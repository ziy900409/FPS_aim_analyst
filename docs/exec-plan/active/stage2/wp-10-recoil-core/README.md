...
| **估時** | 2–3 dev-days |
| **狀態** | 🟡 進行中(T0 ✅, T1 ✅, T2 ✅, T3 ✅, T4 ✅ 2026-07-05;下一步 T-exit) |
...
| **T2** | [T2-punch-dynamics.md](T2-punch-dynamics.md) | `RecoilState`/`recoilTick`/`recoilOnFire` + 10 發 golden 向量 | T1 | ✅ |
| **T3** | [T3-spread-inaccuracy.md](T3-spread-inaccuracy.md) | `sampleSpread` 三成分 + seeded RNG | T1 | ✅ |
