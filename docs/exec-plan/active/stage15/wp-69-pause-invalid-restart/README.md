...
| | |
|---|---|
| **狀態** | ✅ **已交付**（2026-09-15，T-exit）。T0–T6 + T-exit 全數完成；FR-69.1～69.12／NFR-69.1～69.8 逐條有具名證據（[progress.md §T-exit](progress.md)） |
...
| **決策** | [GD-46](../../../DECISIONS.md#gd-46--wp-69-暫停後永久失去實驗效力時間戳不可信即丟棄只有整場-restart-可恢復資格2026-09-15-t-exit) ✅（規劃期採納產品規則，T-exit 已補實作證據並落帳） |
| **估時** | 12.5–18 dev-days |
