...
**影片**:`python .Codex/skills/scene-from-reference/scripts/extract_frames.py <video> -o <scratchpad>/frames`
...
2. 體檢:`python .Codex/skills/scene-from-reference/scripts/check_props.py <draft.json>`
